...
public class ValidDestinationController {
    ...
    public String create(@Valid ValidDestination validDestination, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        String existsMsg = "";
    	...
    	List<ValidDestination> validDestinationList = ValidDestination.findValidDestinationForGivenStopAndDestination(validDestination.getStop(), validDestination.getDestination());
    ...
    public String update(@Valid ValidDestination validDestination, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            uiModel.addAttribute("validDestination", validDestination);
