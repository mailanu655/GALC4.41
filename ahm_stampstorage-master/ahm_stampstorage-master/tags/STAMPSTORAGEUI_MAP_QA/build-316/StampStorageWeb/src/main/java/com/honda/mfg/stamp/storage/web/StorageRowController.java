...
public class StorageRowController {
    ...
    public String create(@Valid StorageRow storageRow, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(StorageRow storageRow, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            uiModel.addAttribute("storageRow", storageRow);
