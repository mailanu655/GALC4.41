...
public class StopController {
    ...
    public String create(@Valid Stop stop, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid Stop stop, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            uiModel.addAttribute("stop", stop);
            return "stops/update";
        }
