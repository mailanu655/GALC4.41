...
import com.honda.mfg.connection.processor.StreamConnectionProcessorPair;
 ...
 * Date: 4/11/11
 */
public class StreamConnectionProcessorPairTest {
    ...
    public void successfullyStartResponseProcessorOnNewThread() {
        ...
        StreamConnectionProcessorPair pair =
                new StreamConnectionProcessorPair(streamPair);
    ...
    public void successfullyRunResponseProcessor() {
        ...
        StreamConnectionProcessorPair pair =
                new StreamConnectionProcessorPair(streamPair, RUN_ONCE);
