...
// PRE-CONDITIONS
        ...
        try {
            when(socketFactory.createSocket())
                    .thenThrow(new IllegalArgumentException("Unknown host!"));
        } catch (IOException e) {
            e.printStackTrace();  //To change body of catch statement use File | Settings | File Templates.
        }
...
// PRE-CONDITIONS
        ...
        try {
            when(socketFactory.createSocket())
                    .thenThrow(new SocketTimeoutException("Unknown host!"));
        } catch (IOException e) {
            e.printStackTrace();  //To change body of catch statement use File | Settings | File Templates.
        }
...
// PRE-CONDITIONS
        ...
        try {
            when(socketFactory.createSocket())
                    .thenThrow(new IllegalBlockingModeException());
        } catch (IOException e) {
            e.printStackTrace();  //To change body of catch statement use File | Settings | File Templates.
        }
...
// PRE-CONDITIONS
        ...
        try {
            when(socketFactory.createSocket())
                    .thenThrow(new SecurityException("Unknown host!"));
        } catch (IOException e) {
            e.printStackTrace();  //To change body of catch statement use File | Settings | File Templates.
        }
...
// PRE-CONDITIONS
        ...
        try {
            when(socketFactory.createSocket())
                    .thenThrow(new IOException("Unknown host!"));
        } catch (IOException e) {
            e.printStackTrace();  //To change body of catch statement use File | Settings | File Templates.
        }
