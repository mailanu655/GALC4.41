...
public class FulfillmentProcessorTest extends AbstractTestBase {
    ...
    public void successfullyPublishFulfillmentProcessorCarrierShippable() {
        ...
        //2013-06-14:VB:following line will be removed because when a carrier is QUEUED,
        //a carrier update is not published by the fulfillment processor anymore for delivery destination.
