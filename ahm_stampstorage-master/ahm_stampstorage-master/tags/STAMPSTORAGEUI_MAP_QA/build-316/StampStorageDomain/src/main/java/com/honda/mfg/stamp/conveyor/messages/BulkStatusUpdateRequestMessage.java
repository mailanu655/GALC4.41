 ...
 *
 */
public class BulkStatusUpdateRequestMessage extends ServiceRequest implements
	 ...
	 * @param newStatus
	 */
	public BulkStatusUpdateRequestMessage(List<Integer> carrierNumberList,
			CarrierStatus newStatus, String user,
