...
//        setStopAvailability(obj,index);
	...
	public void setName(Stop obj, int index) {
        String name = "name_" + index;
        obj.setName(name);
    }

	public void setStopArea(Stop obj, int index) {
        StopArea stopArea = StopArea.class.getEnumConstants()[0];
        obj.setStopArea(stopArea);
    }

	public void setStopType(Stop obj, int index) {
        StopType stopType = StopType.class.getEnumConstants()[0];
        obj.setStopType(stopType);
    }

	public void setId(Stop obj, int index) {
...
//    }
    ...
    public Stop getSpecificStop(int index) {
        init();
        if (index < 0) index = 0;
	...
	public boolean modifyStop(Stop obj) {
        return false;
    }
