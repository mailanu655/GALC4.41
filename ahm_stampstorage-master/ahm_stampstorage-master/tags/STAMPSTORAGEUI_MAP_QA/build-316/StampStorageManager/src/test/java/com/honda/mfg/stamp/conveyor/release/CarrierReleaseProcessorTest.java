...
public class CarrierReleaseProcessorTest extends AbstractTestBase{
    ...
    public void successfullyReceiveCarrierStatusMessageForRelease() {
        ...
        Carrier carrier = new Carrier(1, new Timestamp(System.currentTimeMillis()), 114, stop, stop, CarrierStatus.ON_HOLD, 101, new Die());
        carrier.setBuffer(1);
...
//        assertNull(released2);
    ...
    public void successfullyReceiveCarrierStatusMessageForRelease1() {
        ...
        Carrier carrier2 = new Carrier(1, new Timestamp(System.currentTimeMillis()), 114, stop2, stop2, CarrierStatus.ON_HOLD, 105, new Die());
...
//        assertNull(released1);
    ...
    public void successfullyReceiveCarrierStatusMessageForRelease3() {
        ...
        Carrier carrier3 = new Carrier(1, new Timestamp(System.currentTimeMillis()), 114, stop5, stop5, CarrierStatus.ON_HOLD, 107, new Die());
...
//        assertNull(released1);
    ...
    public void successfullyReceiveCarrierStatusMessageForRelease4() {
        ...
        Carrier carrier4 = new Carrier(1, new Timestamp(System.currentTimeMillis()), 114, stop2, stop2, CarrierStatus.ON_HOLD, 109, new Die());
...
//        assertNull(released1);
    ...
    public void successfullyReceiveCarrierStatusMessageForRelease5() {
        ...
        Carrier carrier5 = new Carrier(1, new Timestamp(System.currentTimeMillis()), 114, stop6, stop6, CarrierStatus.ON_HOLD, 110, new Die());
...
//        assertNull(released1);
    ...
    public void sucessfullyReceiveCarrierStatusForReleaseCheckProcessing() {
        ...
        CarrierStatusMessage carrierMessage3 = new CarrierStatusMessage();
        Carrier carrier3 = new Carrier(1, new Timestamp(System.currentTimeMillis()), 114, stop7, stop4, CarrierStatus.SHIPPABLE, 105, new Die());
        carrier3.setBuffer(1);
        carrierMessage3.setBuffer("1");
...
//
    ...
    public void sucessfullyReceiveCarrierStatusForReleaseCheckProcessing2() {
        ...
        CarrierStatusMessage carrierMessage4 = new CarrierStatusMessage();
        Carrier carrier4 = new Carrier(1, new Timestamp(System.currentTimeMillis()), 111, stop13, stop9, CarrierStatus.SHIPPABLE, 105, new Die());
        carrier4.setBuffer(1);
        carrierMessage4.setBuffer("1");
...
//        }
    ...
    public void sucessfullyReceiveCarrierStatusForReleaseCheckProcessing3() {
        ...
        CarrierStatusMessage carrierMessage5 = new CarrierStatusMessage();
        Carrier carrier5 = new Carrier(1, new Timestamp(System.currentTimeMillis()), 112, stop12, stop8, CarrierStatus.SHIPPABLE, 105, new Die());
        carrier5.setBuffer(1);
        carrierMessage5.setBuffer("1");
