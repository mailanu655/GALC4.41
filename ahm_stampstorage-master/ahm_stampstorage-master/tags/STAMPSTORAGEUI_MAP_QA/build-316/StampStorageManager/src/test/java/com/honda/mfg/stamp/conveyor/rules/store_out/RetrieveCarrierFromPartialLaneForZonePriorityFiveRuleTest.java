 ...
 * Date: 3/11/11
 */
public class RetrieveCarrierFromPartialLaneForZonePriorityFiveRuleTest {
    ...
    public void successfullyRetrieveCarriersWithHighVolumeParts() {
        ...
        StorageStateContext context = getContext();
                StoreOutRule storeOutRule =
                        new RetrieveCarrierFromRowOfZonePriorityAndRowCondition(context, null, LaneCondition.PARTIAL, StoragePriority.Priority.FIVE);
        Die die = new Die(OM.PART_A, PartProductionVolume.HIGH_VOLUME);

        // Perform test
        StorageRow StorageRow = storeOutRule.processRule(die);
    ...
    public void successfullyRetrieveCarriersWithMediumVolumeParts() {
        ...
        Die die = new Die(OM.PART_B, PartProductionVolume.MEDIUM_VOLUME);
        StorageRow StorageRow = storeOutRule.processRule(die);
    ...
    public void successfullyRetrieveCarriersWithLowVolumeParts() {
        ...
        Die die = new Die(OM.PART_C, PartProductionVolume.LOW_VOLUME);
        StorageRow StorageRow = storeOutRule.processRule(die);
    ...
    private List<StorageRow> getLanes() {
        ...
        //low volume capacity
        for (int i = 0; i < aAreaLane1.getCapacity().intValue()-2; i++) {
        ...
        for (int i = 0; i < sAreaLane1.getCapacity().intValue()-2; i++) {
        ...
        for (int i = 0; i < sAreaLane2.getCapacity().intValue()-2; i++) {
