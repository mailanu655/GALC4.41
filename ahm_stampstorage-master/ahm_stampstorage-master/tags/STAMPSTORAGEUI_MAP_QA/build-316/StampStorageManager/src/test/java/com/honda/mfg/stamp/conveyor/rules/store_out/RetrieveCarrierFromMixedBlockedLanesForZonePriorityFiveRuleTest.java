 ...
 * Date: 3/11/11
 */
public class RetrieveCarrierFromMixedBlockedLanesForZonePriorityFiveRuleTest {
    ...
    public void successfullyRetrieveCarriersWithHighVolumeParts() {
       ...
       StoreOutRule storeOutRule =
                new RetrieveCarrierFromRowOfZonePriorityAndRowCondition(context, null, LaneCondition.MIXED_BLOCK, StoragePriority.Priority.FIVE);
...
//    }
    ...
    List<StorageRow> getMixedFrontLanes() {
        ...
        //low volume capacity
        for (int i = 0; i < aAreaLane1.getCapacity().intValue(); i++) {
        ...
        for (int i = 0; i < sAreaLane1.getCapacity().intValue()-1; i++) {
          ...
          sAreaLane1.store(getLowVolumeCarrier(OM.PART_C, OM.OLD_PRODUCTION_RUN_NUMBER, OM.OLD_PRODUCTION_RUN_TIMESTAMP, sAreaLane1.getStop(), sAreaLane1.getStop()));
        for (int i = 0; i < sAreaLane2.getCapacity().intValue()-1; i++) {
         ...
         sAreaLane2.store(getMediumVolumeCarrier(OM.PART_B, OM.OLD_PRODUCTION_RUN_NUMBER, OM.OLD_PRODUCTION_RUN_TIMESTAMP, sAreaLane1.getStop(), sAreaLane1.getStop()));
