 ...
 * Date: 3/11/11
 */
public class RetrieveCarrierFromMixedBlockedLanesForZonePriorityFourRuleTest {
    ...
    public void successfullyRetrieveCarriersWithHighVolumeParts() {
        ...
        StoreOutRule storeOutRule =
                        new RetrieveCarrierFromRowOfZonePriorityAndRowCondition(context, null, LaneCondition.MIXED_BLOCK, StoragePriority.Priority.FOUR);
...
//    }
    ...
    List<StorageRow> getMixedFrontLanes() {
        ...
        for (int i = 0; i < aAreaLane4.getCapacity()-1; i++) {
            ...
            aAreaLane4.store(getMediumVolumeCarrier(OM.PART_B, OM.OLD_PRODUCTION_RUN_NUMBER, OM.OLD_PRODUCTION_RUN_TIMESTAMP,aAreaLane4.getStop(),aAreaLane4.getStop()));
        ...
        for (int i = 0; i < cHighLane2.getCapacity()-1; i++) {
