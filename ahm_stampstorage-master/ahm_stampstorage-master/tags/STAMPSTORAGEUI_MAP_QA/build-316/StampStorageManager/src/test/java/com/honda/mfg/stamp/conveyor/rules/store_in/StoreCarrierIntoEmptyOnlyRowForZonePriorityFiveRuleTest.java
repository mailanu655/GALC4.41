 ...
 * Date: Sept 12, 2013
 */
public class StoreCarrierIntoEmptyOnlyRowForZonePriorityFiveRuleTest {
    @Test
    public void successfullyStoreHighVolumeCarrier() {
        ...
        StoreInRule storeInRule =
                new StoreCarrierIntoRowOfZonePriorityAndRowCondition(
                        ...
                        null, LaneCondition.EMPTY, StoragePriority.Priority.FIVE);
    ...
    public void successfullyStoreMediumVolumeCarrier() {
        ...
        StorageRow expectedLaneImpl = OM.lane_S_AREA_Empty();
         StorageRow ignored3LaneImpl = OM.lane_B_AREA_Empty();
        StorageRow ignored4LaneImpl = OM.lane_A_AREA_Empty();
...
@Test(expected = NoApplicableRuleFoundException.class)
    public void successfullyStoreEmptyCarrier() {
        ...
        ignored3LaneImpl.store(emptyCarrier1);  // first in StorageRow
        ignored3LaneImpl.store(emptyCarrier2);  // last in StorageRow
