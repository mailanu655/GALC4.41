...
public class StoreInManagerImpl implements StoreInManager {
    ...
    private StoreInRule getStoreInFirstRule1(StorageStateContext storageStateContext) {
    	...
    	StoreInRule storeCarrierIntoPartialRowOfOtherDieForZonePriorityFiveRule = new StoreCarrierIntoRowOfZonePriorityAndRowCondition(storageStateContext,storeCarrierIntoMixedRowForZonePriorityOneRule,LaneCondition.PARTIAL_DIFFERENT_DIE, StoragePriority.Priority.FIVE);
    	StoreInRule storeCarrierIntoPartialRowOfOtherDieForZonePriorityFourRule = new StoreCarrierIntoRowOfZonePriorityAndRowCondition(storageStateContext,storeCarrierIntoPartialRowOfOtherDieForZonePriorityFiveRule,LaneCondition.PARTIAL_DIFFERENT_DIE, StoragePriority.Priority.FOUR);
    	StoreInRule storeCarrierIntoPartialRowOfOtherDieForZonePriorityThreeRule = new StoreCarrierIntoRowOfZonePriorityAndRowCondition(storageStateContext,storeCarrierIntoPartialRowOfOtherDieForZonePriorityFourRule,LaneCondition.PARTIAL_DIFFERENT_DIE, StoragePriority.Priority.THREE);
    	StoreInRule storeCarrierIntoPartialRowOfOtherDieForZonePriorityTwoRule = new StoreCarrierIntoRowOfZonePriorityAndRowCondition(storageStateContext,storeCarrierIntoPartialRowOfOtherDieForZonePriorityThreeRule,LaneCondition.PARTIAL_DIFFERENT_DIE, StoragePriority.Priority.TWO);
    	StoreInRule storeCarrierIntoPartialRowOfOtherDieForZonePriorityOneRule = new StoreCarrierIntoRowOfZonePriorityAndRowCondition(storageStateContext,storeCarrierIntoPartialRowOfOtherDieForZonePriorityTwoRule,LaneCondition.PARTIAL_DIFFERENT_DIE, StoragePriority.Priority.ONE);
    	

        StoreInRule storeCarrierIntoMixedSameRowForZonePriorityFiveRule = new StoreCarrierIntoRowOfZonePriorityAndRowCondition(storageStateContext, storeCarrierIntoPartialRowOfOtherDieForZonePriorityOneRule,LaneCondition.MIXED_BACK, StoragePriority.Priority.FIVE);
