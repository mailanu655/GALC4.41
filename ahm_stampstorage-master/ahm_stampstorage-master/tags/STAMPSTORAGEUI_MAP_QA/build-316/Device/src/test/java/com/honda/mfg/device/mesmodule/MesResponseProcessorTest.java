 ...
 * Date: 3/24/11
 */
public class MesResponseProcessorTest {
    ...
    public void successfullyStartResponseProcessorInAutoMode() {
        // Pre-conditions
        MesResponseReader reader = mock(MesResponseReader.class);

        MesResponseProcessor processor = new MesResponseProcessor(reader);
    ...
    public void successfullyStartResponseProcessorAndThenStopProcessing() {
        ...
        // Perform test
        MesResponseProcessor processor = new MesResponseProcessor(reader, true);
    ...
    public void throwsExceptionAttemptingToGetResponse() {
        MesResponseReader responseReader = mock(MesResponseReader.class);
        ...
        // Perform test
        MesResponseProcessor processor =
                new MesResponseProcessor(responseReader, false, true);
    ...
    public void incrementCounter(MesMessage message) {
        publishedEvents++;
    }
