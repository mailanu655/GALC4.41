 ...
 * Time: 6:19 PM
 */
public class StreamFinsProcessorPairTest {
    ...
    public void successfullyStartResponseProcessorOnNewThread() {
        ...
        StreamFinsProcessorPair pair =
                new StreamFinsProcessorPair(streamPair);
    ...
    public void successfullyRunResponseProcessor() {
        ...
        StreamFinsProcessorPair pair =
                new StreamFinsProcessorPair(streamPair, RUN_ONCE);
