...
public class JSONBeanUtil {
    ...
    private final static JSONBeanUtil defaultUtil = new JSONBeanUtil();
    ...
    public Set<String> getBeanPropertyNames(Object bean) {
        return TypeAnalyzer.getClassInfo(objectSupport, bean.getClass()).getPropertyNames();
    }
    ...
    public Object getProperty(Object bean, String name)
        ...
        } else if ((propertyInfo = TypeAnalyzer.getClassInfo(objectSupport, bean.getClass()).getPropertyInfo(name)) != null && propertyInfo.isReadable()) {
    ...
    public void setProperty(Object bean, String name, Object value)
        ...
        } else if ((propertyInfo = TypeAnalyzer.getClassInfo(objectSupport, bean.getClass()).getPropertyInfo(name)) != null && propertyInfo.isWriteable()) {
