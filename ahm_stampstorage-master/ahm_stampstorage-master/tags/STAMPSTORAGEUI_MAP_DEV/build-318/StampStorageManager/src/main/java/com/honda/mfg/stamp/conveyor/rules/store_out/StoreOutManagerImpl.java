...
public class StoreOutManagerImpl implements StoreOutManager {
    ...
    public StoreOutRule getStoreOutFirstRule(StorageStateContext storageStateContext) {
        //RulesConfig rulesConfig = new RulesConfig(null, StorageConfig.A_AREA_OVER_FILL_THRESHOLD_PERCENT);

        StoreOutRule retrieveCarrierFromMixedBlockRowsForZonePriorityOneRule = new RetrieveCarrierFromRowOfZonePriorityAndRowCondition(storageStateContext, null, LaneCondition.MIXED_BLOCK, StoragePriority.Priority.ONE);
        StoreOutRule retrieveCarrierFromMixedBlockRowsForZonePriorityTwoRule = new RetrieveCarrierFromRowOfZonePriorityAndRowCondition(storageStateContext, retrieveCarrierFromMixedBlockRowsForZonePriorityOneRule, LaneCondition.MIXED_BLOCK, StoragePriority.Priority.TWO);
        StoreOutRule retrieveCarrierFromMixedBlockRowsForZonePriorityThreeRule = new RetrieveCarrierFromRowOfZonePriorityAndRowCondition(storageStateContext, retrieveCarrierFromMixedBlockRowsForZonePriorityTwoRule, LaneCondition.MIXED_BLOCK, StoragePriority.Priority.THREE);
        StoreOutRule retrieveCarrierFromMixedBlockRowsForZonePriorityFourRule = new RetrieveCarrierFromRowOfZonePriorityAndRowCondition(storageStateContext, retrieveCarrierFromMixedBlockRowsForZonePriorityThreeRule, LaneCondition.MIXED_BLOCK, StoragePriority.Priority.FOUR);
        StoreOutRule retrieveCarrierFromMixedBlockRowsForZonePriorityFiveRule = new RetrieveCarrierFromRowOfZonePriorityAndRowCondition(storageStateContext, retrieveCarrierFromMixedBlockRowsForZonePriorityFourRule, LaneCondition.MIXED_BLOCK, StoragePriority.Priority.FIVE);

        StoreOutRule retrieveCarrierFromFullRowsForZonePriorityOneRule = new RetrieveCarrierFromRowOfZonePriorityAndRowCondition(storageStateContext, retrieveCarrierFromMixedBlockRowsForZonePriorityFiveRule, LaneCondition.FULL, StoragePriority.Priority.ONE);
        ...
        StoreOutRule retrieveCarrierFromFullRowsForZonePriorityFiveRule = new RetrieveCarrierFromRowOfZonePriorityAndRowCondition(storageStateContext, retrieveCarrierFromFullRowsForZonePriorityFourRule, LaneCondition.FULL, StoragePriority.Priority.FIVE);

        StoreOutRule retrieveCarrierFromPartialRowsForZonePriorityOneRule = new RetrieveCarrierFromRowOfZonePriorityAndRowCondition(storageStateContext, retrieveCarrierFromFullRowsForZonePriorityFiveRule, LaneCondition.PARTIAL, StoragePriority.Priority.ONE);
        ...
        StoreOutRule retrieveCarrierFromPartialRowsForZonePriorityFiveRule = new RetrieveCarrierFromRowOfZonePriorityAndRowCondition(storageStateContext, retrieveCarrierFromPartialRowsForZonePriorityFourRule, LaneCondition.PARTIAL, StoragePriority.Priority.FIVE);

        StoreOutRule retrieveCarrierFromMixedFrontRowsForZonePriorityOneRule = new RetrieveCarrierFromRowOfZonePriorityAndRowCondition(storageStateContext, retrieveCarrierFromPartialRowsForZonePriorityFiveRule, LaneCondition.MIXED_FRONT, StoragePriority.Priority.ONE);
        ...
        StoreOutRule retrieveCarrierFromMixedFrontRowsForZonePriorityFiveRule = new RetrieveCarrierFromRowOfZonePriorityAndRowCondition(storageStateContext, retrieveCarrierFromMixedFrontRowsForZonePriorityFourRule, LaneCondition.MIXED_FRONT, StoragePriority.Priority.FIVE);
