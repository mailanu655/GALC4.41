...
public class RetrieveCarrierFromMixedBlockedLanesForZonePriorityTwoRuleTest {
    ...
    public void successfullyRetrieveCarriersWithHighVolumeParts() {
        ...
        StoreOutRule storeOutRule =
                        new RetrieveCarrierFromRowOfZonePriorityAndRowCondition(context, null, LaneCondition.MIXED_BLOCK, StoragePriority.Priority.TWO);
...
//    }
    ...
    List<StorageRow> getMixedFrontLanes() {
        ...
        lane4: Single low volume new followed by high volume old till the end
        ...
        lane4: high volume, full lane, new production run
       ...
       */
        ...
        bAreaLane2.store(getLowVolumeCarrier(OM.PART_C, OM.PRODUCTION_RUN_NUMBER, OM.NEW_PRODUCTION_RUN_TIMESTAMP, bAreaLane2.getStop(), bAreaLane2.getStop()));
        ...
        for (int i = 0; i < bAreaLane4.getCapacity().intValue() - 1; i++) {
            bAreaLane4.store(getHighVolumeCarrier(OM.PART_A, OM.OTHER_PRODUCTION_RUN_NUMBER, OM.NEW_PRODUCTION_RUN_TIMESTAMP, bAreaLane4.getStop(), bAreaLane4.getStop()));
        }
