...
public class StorageStateImplIntegrationTest {
    ...
    public void testRemoveAndAddCarrierToLane() {
        ...
        Carrier carrier115 = new Carrier(10, new Timestamp(System.currentTimeMillis()), new Integer(100), new Stop(1229L), new Stop(1229L), CarrierStatus.SHIPPABLE, new Integer(115), die);
        Carrier carrier116 = new Carrier(10, new Timestamp(System.currentTimeMillis()), new Integer(100), new Stop(1229L), new Stop(1229L), CarrierStatus.SHIPPABLE, new Integer(116), die);
        Carrier carrier117 = new Carrier(10, new Timestamp(System.currentTimeMillis()), new Integer(100), new Stop(513L), new Stop(1229L), CarrierStatus.SHIPPABLE, new Integer(117), die);
        Carrier carrier118 = new Carrier(10, new Timestamp(System.currentTimeMillis()), new Integer(100), new Stop(805L), new Stop(1229L), CarrierStatus.SHIPPABLE, new Integer(118), die);
        ...
        Carrier carrier119 = new Carrier(10, new Timestamp(System.currentTimeMillis()), new Integer(100), new Stop("ST12-01"), new Stop("ST12-01"), CarrierStatus.SHIPPABLE, new Integer(115), die);
    ...
    public void initStorage() {
        ...
        Carrier carrier1 = new Carrier(3, twoDaysOld, new Integer(90), new Stop("ST12-10"), null, CarrierStatus.SHIPPABLE, new Integer(696), leftDie);
        Carrier carrier11 = new Carrier(4, twoDaysOld, new Integer(99), new Stop("ST12-11"), null, CarrierStatus.SHIPPABLE, new Integer(130), rightDie);
        Carrier carrier12 = new Carrier(5, twoDaysOld, new Integer(90), new Stop("ST12-12"), null, CarrierStatus.SHIPPABLE, new Integer(720), leftDie);
        ...
        Carrier carrier42 = new Carrier(8, twoDaysOld, new Integer(90), new Stop("ST12-34"), null, CarrierStatus.SHIPPABLE, new Integer(35), leftDie);
        Carrier carrier43 = new Carrier(9, twoDaysOld, new Integer(90), new Stop("ST12-34"), null, CarrierStatus.SHIPPABLE, new Integer(425), leftDie);
        ...
        Carrier carrier111 = new Carrier(10, today, new Integer(100), new Stop("ST12-01"), new Stop("ST12-01"), CarrierStatus.SHIPPABLE, new Integer(111), die);
        Carrier carrier112 = new Carrier(10, today, new Integer(100), new Stop("ST12-01"), new Stop("ST12-01"), CarrierStatus.SHIPPABLE, new Integer(112), die);
        Carrier carrier113 = new Carrier(10, today, new Integer(100), new Stop("ST5-13"), new Stop("ST12-01"), CarrierStatus.SHIPPABLE, new Integer(113), die);
        Carrier carrier114 = new Carrier(10, today, new Integer(100), new Stop("ST8-5"), new Stop("ST12-01"), CarrierStatus.SHIPPABLE, new Integer(114), die);
