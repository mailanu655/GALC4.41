...
public class RowMatchersTest {
    ...
    public void ignoreLaneHavingCarriersWithManyPartTypesAndFindSecondLaneHavingOnlySinglePartType() {
        ...
        StorageRow actualLaneImpl = queryForRow(RowMatchers.isLaneWithOnlySingleDieNumberOf(new Long(LaneOM.PART_A)), laneImpls);
        assertNotSame("Unexpectedly found first StorageRow that should have been ignored.", ignoredLaneImpl, actualLaneImpl);
    ...
    public void ignoreLaneHavingCarriersWithSinglePartTypeAndFindSecondLaneHavingManyPartTypes() {
        ...
        List<StorageRow> laneImpls = LaneOM.getLanes(ignoredLaneImpl, expectedLaneImpl);
        StorageRow actualLaneImpl = queryForRow(RowMatchers.hasMixedDieNumbersIncluding(new Long(LaneOM.PART_A)), laneImpls);
        assertNotSame("Unexpectedly found first StorageRow that should have been ignored.", ignoredLaneImpl, actualLaneImpl);
        assertEquals(expectedLaneImpl, actualLaneImpl);
    }
    ...
    public void successfullyFindLaneHavingCarriersWithPartTypeAtTheEnd() {
        ...
        laneImpls.add(LaneOM.mixedWithSamePartCarrierEndLaneImpl);
        laneImpls.add(LaneOM.mixedWithDifferentPartCarrierEndLaneImpl);
        StorageRow actualLaneImpl = queryForRow(RowMatchers.hasCarrierAtTheLaneInWithDieNumber(new Long(LaneOM.PART_B)), laneImpls);
    ...
    public void successfullyFindLaneHavingCarriersWithPartTypeAtTheStart() {
        ...
        laneImpls.add(LaneOM.mixedWithSamePartCarrierEndLaneImpl);
        laneImpls.add(LaneOM.mixedWithDifferentPartCarrierEndLaneImpl);
        StorageRow actualLaneImpl = queryForRow(RowMatchers.hasCarrierAtTheLaneOutWithDieNumber(new Long(LaneOM.PART_B)), laneImpls);
    ...
    private List<StorageRow> queryForRows(Matcher<StorageRow> matcher, List<StorageRow> lanesImpls) {
        ...
        Iterable<StorageRow> filteredLanes = matcher == null ? lanesImpls : Iterables.filter(lanesImpls, new PredicateWrapper<StorageRow>(matcher));
