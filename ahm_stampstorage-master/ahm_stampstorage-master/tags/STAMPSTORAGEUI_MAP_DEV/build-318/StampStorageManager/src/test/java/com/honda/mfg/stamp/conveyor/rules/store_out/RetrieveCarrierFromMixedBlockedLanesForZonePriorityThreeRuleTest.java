...
public class RetrieveCarrierFromMixedBlockedLanesForZonePriorityThreeRuleTest {
    ...
    public void successfullyRetrieveCarriersWithHighVolumeParts() {
        ...
        StoreOutRule storeOutRule =
                        new RetrieveCarrierFromRowOfZonePriorityAndRowCondition(context, null, LaneCondition.MIXED_BLOCK, StoragePriority.Priority.THREE);
...
//    }
    ...
    List<StorageRow> getMixedFrontLanes() {
        ...
        for (int i = 0; i < bAreaLane1.getCapacity().intValue(); i++) {
            bAreaLane1.store(getLowVolumeCarrier(OM.PART_C, OM.PRODUCTION_RUN_NUMBER, OM.NEW_PRODUCTION_RUN_TIMESTAMP, bAreaLane1.getStop(), bAreaLane1.getStop()));
        }
