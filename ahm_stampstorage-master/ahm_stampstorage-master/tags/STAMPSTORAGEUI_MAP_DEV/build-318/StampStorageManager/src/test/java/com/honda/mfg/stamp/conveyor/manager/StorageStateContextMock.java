...
public class StorageStateContextMock implements StorageStateContext, StorageLifeCycle {
    ...
    public void reload() {
        ...
        carrier2 = new Carrier(1, today, 103, new Stop("ST12-32"), null, CarrierStatus.SHIPPABLE, new Integer(200), someDie);
        carrier3 = new Carrier(2, today, 103, new Stop("ST12-33"), null, CarrierStatus.SHIPPABLE, new Integer(202), someDie);

        carrier1 = new Carrier(3, twoDaysOld, 90, new Stop("ST12-10"), null, CarrierStatus.SHIPPABLE, new Integer(696), leftDie);
        carrier11 = new Carrier(4, twoDaysOld, new Integer(99), new Stop("ST12-11"), null, CarrierStatus.SHIPPABLE, new Integer(130), rightDie);
        carrier12 = new Carrier(5, twoDaysOld, 90, new Stop("ST12-12"), null, CarrierStatus.SHIPPABLE, new Integer(720), leftDie);


        carrier4 = new Carrier(6, today, new Integer(100), new Stop("ST12-35"), null, CarrierStatus.SHIPPABLE, new Integer(728), leftDie);
        carrier41 = new Carrier(7, today, new Integer(100), new Stop("ST12-35"), null, CarrierStatus.SHIPPABLE, new Integer(743), leftDie);
        carrier42 = new Carrier(8, twoDaysOld, 90, new Stop("ST12-34"), null, CarrierStatus.SHIPPABLE, new Integer(35), leftDie);
        carrier43 = new Carrier(9, twoDaysOld, 90, new Stop("ST12-34"), null, CarrierStatus.SHIPPABLE, new Integer(425), leftDie);

        carrier5 = new Carrier(10, today, new Integer(101), new Stop("ST12-31"), null, CarrierStatus.SHIPPABLE, new Integer(131), rightDie);
        carrier51 = new Carrier(11, today, new Integer(101), new Stop("ST12-31"), null, CarrierStatus.SHIPPABLE, new Integer(203), rightDie);
        carrier52 = new Carrier(12, twoDaysOld, new Integer(99), new Stop("ST12-30"), null, CarrierStatus.SHIPPABLE, new Integer(126), rightDie);
        carrier53 = new Carrier(13, twoDaysOld, new Integer(99), new Stop("ST12-30"), null, CarrierStatus.SHIPPABLE, new Integer(465), rightDie);
        carrier54 = new Carrier(14, twoDaysOld, new Integer(99), new Stop("ST12-30"), null, CarrierStatus.SHIPPABLE, new Integer(605), rightDie);
   ...
   @Override
    ...
    public StorageRow getRow(Die die) {
        return lastUsedRowMap.get(die.getId());  //To change body of implemented methods use File | Settings | File Templates.
    }
    ...
    public Die getEmptyDie() {
        return new Die(999l,PartProductionVolume.EMPTY);  //To change body of implemented methods use File | Settings | File Templates.
    }
