...
public class RetrieveCarrierFromFullLanesForZonePriorityThreeRuleTest {
    ...
    public void successfullyRetrieveCarriersWithHighVolumeParts() {
        ...
        StoreOutRule storeOutRule =
                new RetrieveCarrierFromRowOfZonePriorityAndRowCondition(context, null, LaneCondition.FULL, StoragePriority.Priority.THREE);
    ...
    private List<StorageRow> getLanes() {
        ...
        B Area
        ------
        lane1: low volume, full lane, old production run
        lane2: high volume, full lane, old production run
