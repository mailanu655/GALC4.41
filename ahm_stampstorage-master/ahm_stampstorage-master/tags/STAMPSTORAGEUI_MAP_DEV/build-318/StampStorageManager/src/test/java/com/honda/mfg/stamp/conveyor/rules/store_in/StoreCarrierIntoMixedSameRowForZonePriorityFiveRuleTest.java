 ...
 * Date: Sept 12, 2013
 */
public class StoreCarrierIntoMixedSameRowForZonePriorityFiveRuleTest {
    @Test
            ...
            StoreInRule storeInRule =
                     new StoreCarrierIntoRowOfZonePriorityAndRowCondition(
                            OM.storageState(lanes, null),
                             null, LaneCondition.MIXED_BACK, StoragePriority.Priority.FIVE);
        ...
        public void successfullyStoreLowVolume() {
            ...
            StorageRow expectedLaneImpl = OM.lane_S_AREA_Empty();OM.lane_B_AREA_Empty();
