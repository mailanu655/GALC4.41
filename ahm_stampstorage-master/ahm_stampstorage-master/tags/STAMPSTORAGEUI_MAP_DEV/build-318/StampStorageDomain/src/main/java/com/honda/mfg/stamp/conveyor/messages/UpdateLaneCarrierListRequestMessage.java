...
public class UpdateLaneCarrierListRequestMessage implements
	 ...
	 * @param targetOp
	 */
	public UpdateLaneCarrierListRequestMessage( List<Integer> carrierNumberList, Long laneStopId, CarrierUpdateOperations targetOp) {
		super();
	...
	public Long getLaneStopId()  {
        ...
        if(!isEmptyString(laneStop)) {laneStopId = Long.valueOf(laneStop);}
        return laneStopId;
	}
