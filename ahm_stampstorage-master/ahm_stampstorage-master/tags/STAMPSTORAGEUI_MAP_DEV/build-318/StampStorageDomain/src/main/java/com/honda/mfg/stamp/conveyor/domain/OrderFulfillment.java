...
public class OrderFulfillment {
   ...
   // private Integer releaseCycle;
	...
	public static Integer getMinCycleCountForOrderForFulfillmentStatus(WeldOrder order, CarrierFulfillmentStatus retrieved) {
        Query query = null;
	...
	public static Integer countFulfillmentsByOrderWithCarrierFulfillmentStatusAndDie(WeldOrder order, Die die, CarrierFulfillmentStatus carrierFulfillmentStatus) {
        Query query = null;
        Long nRows = 0L;
	...
	public static List<OrderFulfillment>findAllOrderFulfillmentsByOrderWithCarrierFulfillmentStatus(WeldOrder order, CarrierFulfillmentStatus carrierFulfillmentStatus) {
        Query query = null;
        List<OrderFulfillment> fulfillments = findAllOrderFulfillmentsByOrder(order);
        if (fulfillments != null && fulfillments.size() > 0) {
	...
	@Transactional
    public static void deleteAllOrderFulfillmentsByOrderWithCarrierFulfillmentStatus(WeldOrder order, CarrierFulfillmentStatus carrierFulfillmentStatus) {
...
//            int result = query.executeUpdate();
	...
	public static List<OrderFulfillment>findAllOrderFulfillmentsByCarrierWithCarrierFulfillmentStatus(Integer carrierNumber, CarrierFulfillmentStatus carrierFulfillmentStatus) {
        Query query = null;
	...
	public static WeldOrder findOrderByCarrierInRows(Integer carrier) {
        ...
        List<OrderFulfillment> fulfillments = new ArrayList<OrderFulfillment>();
        fulfillments.addAll(findAllOrderFulfillmentsByCarrierWithCarrierFulfillmentStatus(carrier, CarrierFulfillmentStatus.RETRIEVED));
        fulfillments.addAll(findAllOrderFulfillmentsByCarrierWithCarrierFulfillmentStatus(carrier, CarrierFulfillmentStatus.SELECTED));
