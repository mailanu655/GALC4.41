...
//    }
	...
	public static List<AlarmDefinition> findAlarmEntriesByActiveStatus(int firstResult, int maxResults, Boolean active) {
	...
	public static AlarmDefinition findNotificationRequiredAlarmsByAlarmNumberAndLocation(Integer number, Integer location) {
