...
//DAO stuff
	...
	public static long countAllCarriersInLane(Long stopNumber) {
        Query q = entityManager().createQuery("SELECT COUNT(o) FROM CarrierMes o WHERE o.currentLocation = :stopNumber OR destination = :stopNumber ", Long.class);
	...
	public static List<CarrierMes> findAllCarriersWithCurrentLocationAndDestinationLocationAndDie(Long stopNumber, Integer die) {
	...
	public static List<CarrierMes> findAllCarriersWithProductionRunNumber(Integer productionRunNumber, Integer page, Integer sizeNo) {
	...
	public static List<CarrierMes> findCarriersByCarrierNumberAndDieAndCurrentLocationAndCarrierStatusAndPressAndProductionRunNo(CarrierFinderCriteria finderCriteria, Integer page, Integer sizeNo) {
	...
	public static List<CarrierMes> findCarriersByRowAndProductionRunNoAndRobotAndProdRunDate(GroupHoldFinderCriteria finderCriteria, Integer page, Integer sizeNo) {
        EntityManager em = CarrierMes.entityManager();
        TypedQuery<CarrierMes> q = null;
        String sql = "SELECT o FROM CarrierMes AS o ";
        List<String> criteriaList = new ArrayList<String>();
	...
	private static void addBitInfoToCriteriaList(List<String> criteriaList, BitInfo bi){
		if(bi!=null){
	        if(bi.getMaintRequired()!=null){
	        	criteriaList.add("bitwise_and(o.maintenanceBits,1)" + ((bi.getMaintRequired())?" = ":" <> ") + "1 ");
	        }
	        if(bi.isShowBit1()!=null)criteriaList.add("bitwise_and(o.maintenanceBits,2)" + ((bi.isShowBit1())?" = ":" <> ")+ "2 ");
	        if(bi.isShowBit2()!=null)criteriaList.add("bitwise_and(o.maintenanceBits,4)" + ((bi.isShowBit2())?" = ":" <> ")+ "4 ");
	        if(bi.isShowBit3()!=null)criteriaList.add("bitwise_and(o.maintenanceBits,8)" + ((bi.isShowBit3())?" = ":" <> ")+ "8 ");
	        if(bi.isShowBit4()!=null)criteriaList.add("bitwise_and(o.maintenanceBits,16)" + ((bi.isShowBit4())?" = ":" <> ")+ "16 ");
	        if(bi.isShowBit5()!=null)criteriaList.add("bitwise_and(o.maintenanceBits,32)" + ((bi.isShowBit5())?" = ":" <> ")+ "32 ");
	        if(bi.isShowBit6()!=null)criteriaList.add("bitwise_and(o.maintenanceBits,64)" + ((bi.isShowBit6())?" = ":" <> ")+ "64 ");
	        if(bi.isShowBit7()!=null)criteriaList.add("bitwise_and(o.maintenanceBits,128)" + ((bi.isShowBit7())?" = ":" <> ")+ "128 ");
	        if(bi.isShowBit8()!=null)criteriaList.add("bitwise_and(o.maintenanceBits,256)" + ((bi.isShowBit8())?" = ":" <> ")+ "256 ");
	        if(bi.isShowBit9()!=null)criteriaList.add("bitwise_and(o.maintenanceBits,512)" + ((bi.isShowBit9())?" = ":" <> ")+ "512 ");
	        if(bi.isShowBit10()!=null)criteriaList.add("bitwise_and(o.maintenanceBits,1024)" + ((bi.isShowBit10())?" = ":" <> ")+ "1024 ");
	        if(bi.isShowBit11()!=null)criteriaList.add("bitwise_and(o.maintenanceBits,2048)" + ((bi.isShowBit11())?" = ":" <> ")+ "2048 ");
	        if(bi.isShowBit12()!=null)criteriaList.add("bitwise_and(o.maintenanceBits,4096)" + ((bi.isShowBit12())?" = ":" <> ")+ "4096 ");
	        if(bi.isShowBit13()!=null)criteriaList.add("bitwise_and(o.maintenanceBits,8192)" + ((bi.isShowBit13())?" = ":" <> ")+ "8192 ");
	        if(bi.isShowBit14()!=null)criteriaList.add("bitwise_and(o.maintenanceBits,16384)" + ((bi.isShowBit14())?" = ":" <> ")+ "16384 ");
	        if(bi.isShowBit15()!=null)criteriaList.add("bitwise_and(o.maintenanceBits,32768)" + ((bi.isShowBit15())?" = ":" <> ")+ "32768 ");
