...
public class StorageRowIntegrationTest {
    ...
    public void testCountStorageRows() {
        org.junit.Assert.assertNotNull("Data on demand for 'StorageRow' failed to initialize correctly", dod.getRandomStorageRow());
    ...
    public void testFindStorageRow() {
        ...
        org.junit.Assert.assertEquals("Find method for 'StorageRow' returned the incorrect identifier", id, obj.getId());
    }
    ...
    public void testFindAllStorageRows() {
        org.junit.Assert.assertNotNull("Data on demand for 'StorageRow' failed to initialize correctly", dod.getRandomStorageRow());
        long count = com.honda.mfg.stamp.conveyor.domain.StorageRow.countStorageRows();
        org.junit.Assert.assertTrue("Too expensive to perform a find all test for 'StorageRow', as there are " + count + " entries; set the findAllMaximum to exceed this value or set findAll=false on the integration test annotation to disable the test", count < 250);
        java.util.List<com.honda.mfg.stamp.conveyor.domain.StorageRow> result = com.honda.mfg.stamp.conveyor.domain.StorageRow.findAllStorageRows();
    ...
    public void testFindStorageRowEntries() {
        ...
        java.util.List<com.honda.mfg.stamp.conveyor.domain.StorageRow> result = com.honda.mfg.stamp.conveyor.domain.StorageRow.findStorageRowEntries(0, (int) count);
        org.junit.Assert.assertNotNull("Find entries method for 'StorageRow' illegally returned null", result);
        org.junit.Assert.assertEquals("Find entries method for 'StorageRow' returned an incorrect number of entries", count, result.size());
    }
    ...
    public void testFlush() {
        ...
        obj.flush();
        org.junit.Assert.assertTrue("Version for 'StorageRow' failed to increment on flush directive", (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
    ...
    public void testMerge() {
        ...
        boolean modified =  dod.modifyStorageRow(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        com.honda.mfg.stamp.conveyor.domain.StorageRow merged = (com.honda.mfg.stamp.conveyor.domain.StorageRow) obj.merge();
        obj.flush();
        org.junit.Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getId(), id);
        org.junit.Assert.assertTrue("Version for 'StorageRow' failed to increment on merge and flush directive", (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
    ...
    public void testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'StorageRow' with identifier '" + id + "'", com.honda.mfg.stamp.conveyor.domain.StorageRow.findStorageRow(id));
    }
}
