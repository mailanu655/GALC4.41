...
public class DefectIntegrationTest {
    ...
    public void testCountDefects() {
        org.junit.Assert.assertNotNull("Data on demand for 'Defect' failed to initialize correctly", dod.getRandomDefect());
    ...
    public void testFindAllDefects() {
        org.junit.Assert.assertNotNull("Data on demand for 'Defect' failed to initialize correctly", dod.getRandomDefect());
        long count = com.honda.mfg.stamp.conveyor.domain.Defect.countDefects();
        org.junit.Assert.assertTrue("Too expensive to perform a find all test for 'Defect', as there are " + count + " entries; set the findAllMaximum to exceed this value or set findAll=false on the integration test annotation to disable the test", count < 250);
        java.util.List<com.honda.mfg.stamp.conveyor.domain.Defect> result = com.honda.mfg.stamp.conveyor.domain.Defect.findAllDefects();
    ...
    public void testFindDefectEntries() {
        ...
        java.util.List<com.honda.mfg.stamp.conveyor.domain.Defect> result = com.honda.mfg.stamp.conveyor.domain.Defect.findDefectEntries(0, (int) count);
        org.junit.Assert.assertNotNull("Find entries method for 'Defect' illegally returned null", result);
        org.junit.Assert.assertEquals("Find entries method for 'Defect' returned an incorrect number of entries", count, result.size());
    }
    ...
    public void testFlush() {
        ...
        obj.flush();
        org.junit.Assert.assertTrue("Version for 'Defect' failed to increment on flush directive", (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    ...
    public void testMerge() {
        ...
        org.junit.Assert.assertTrue("Version for 'Defect' failed to increment on merge and flush directive", (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
    ...
    public void testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Defect' with identifier '" + id + "'", com.honda.mfg.stamp.conveyor.domain.Defect.findDefect(id));
    }
}
