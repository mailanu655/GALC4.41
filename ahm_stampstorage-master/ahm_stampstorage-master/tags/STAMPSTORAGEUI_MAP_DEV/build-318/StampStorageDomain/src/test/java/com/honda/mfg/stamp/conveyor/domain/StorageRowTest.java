   ...
   @Test
      ...
      @Test
       public void inequalityCheckForMaxCapacitiesTest() {
          ...
          // assertFalse("How can two lanes of different max capacities be the same?", lane1.isLoadedLike(lane2));
       }
       ...
       private Carrier buildCarrier(long id, Long dieNumber, Timestamp productionRunTimestamp, Integer productionRunNumber) {
           Carrier c = new Carrier(id, new Die(dieNumber, PartProductionVolume.HIGH_VOLUME), 1, productionRunTimestamp, productionRunNumber);
           c.setCarrierStatus(CarrierStatus.SHIPPABLE);
           return c;
       }
       ...
       public void successfullyReturnsIfLaneHasCarriersOfProdRunNo() {
           ...
           StorageRow l = new StorageRow(1, "test_lane", 3,1);
           Carrier carrier_1 = new Carrier(100, new Die(10L, PartProductionVolume.HIGH_VOLUME), 1, timestamp1, new Integer(101));
           Carrier carrier_2 = new Carrier(101, new Die(10L, PartProductionVolume.HIGH_VOLUME), 1, timestamp2, new Integer(102));
           Carrier carrier_3 = new Carrier(102, new Die(10L, PartProductionVolume.HIGH_VOLUME), 1, timestamp3, new Integer(101));
           l.store(carrier_1);
           l.store(carrier_2);
           l.store(carrier_3);
       ...
       public void attemptingToFindIfLaneHasCarriersOfProdRunNoForUnknownProdRunNo() {
           ...
           Carrier carrier_1 = new Carrier(100, new Die(10L, PartProductionVolume.HIGH_VOLUME), 1, timestamp1, new Integer(101));
           Carrier carrier_2 = new Carrier(101, new Die(10L, PartProductionVolume.HIGH_VOLUME), 1, timestamp2, new Integer(102));
           Carrier carrier_3 = new Carrier(102, new Die(20L, PartProductionVolume.HIGH_VOLUME), 1, timestamp3, new Integer(101));
           ...
           assertEquals(LaneCondition.MIXED_BLOCK, l.getLaneConditionByDie(new Die(20L, PartProductionVolume.HIGH_VOLUME)));
           assertEquals(LaneCondition.MIXED_FRONT, l.getLaneConditionByDie(new Die(10L, PartProductionVolume.HIGH_VOLUME)));
       ...
       public void testEquals() {
           ...
           carrier = new Carrier(id++, productionRunTimestamp, prodRunNo, currentLocation, destination, carrierStatus, carrierNumber, new Die(3L, PartProductionVolume.HIGH_VOLUME));
           carrier.setQuantity(10);

           Carrier carrier1 = new Carrier(id++, productionRunTimestamp, prodRunNo, currentLocation, destination, carrierStatus, carrierNumber, new Die(3L, PartProductionVolume.HIGH_VOLUME));
