...
public class ContactIntegrationTest {
    ...
    public void testFindAllContacts() {
        ...
        java.util.List<com.honda.mfg.stamp.conveyor.domain.Contact> result = com.honda.mfg.stamp.conveyor.domain.Contact.findAllContacts();
    ...
    public void testFindContactEntries() {
        ...
        java.util.List<com.honda.mfg.stamp.conveyor.domain.Contact> result = com.honda.mfg.stamp.conveyor.domain.Contact.findContactEntries(0, (int) count);
    ...
    public void testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Contact' with identifier '" + id + "'", com.honda.mfg.stamp.conveyor.domain.Contact.findContact(id));
    }
}
