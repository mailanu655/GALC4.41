...
public class CarrierMesFinderTest {
    ...
    public void successfullyGetCarriersForHoldCriteria() {
        ...
        List<CarrierMes> carriers = CarrierMes.findCarriersByRowAndProductionRunNoAndRobotAndProdRunDate(criteria, 1, 10);
    ...
    public void successfullyGetCarriersForCarrierCriteria() {
        ...
        List<CarrierMes> carriers = CarrierMes.findCarriersByCarrierNumberAndDieAndCurrentLocationAndCarrierStatusAndPressAndProductionRunNo(criteria, 1, 10);
