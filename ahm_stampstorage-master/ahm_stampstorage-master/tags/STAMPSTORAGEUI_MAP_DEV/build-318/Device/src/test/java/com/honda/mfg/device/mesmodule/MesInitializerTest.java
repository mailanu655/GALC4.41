 ...
 * Date: 4/12/11
 */
public class MesInitializerTest {
    ...
    @EventSubscriber(eventClass = MesDeviceInitialized.class, referenceStrength = ReferenceStrength.STRONG)
    public void catchEvent(MesDeviceInitialized deviceInitialized) {
        this.count++;
    }

    @EventSubscriber(eventClass = MesDeviceUninitialized.class, referenceStrength = ReferenceStrength.STRONG)
    public void catchEvent(MesDeviceUninitialized deviceUninitialized) {
    ...
    public void successfullyInitializeDeviceInNewThread() {
        // Pre-conditions
        MesProcessorPair pair = mock(MesProcessorPair.class);
        ...
        MesInitializer initializer = new MesInitializer(pair, 1);
    ...
    public void successfullyReceiveAsyncInitializedMessage() {
        ...
        MesInitializer initializer = new MesInitializer(pair);
