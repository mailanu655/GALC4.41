...
public class OrderFulfillmentControllerTest {
    ...
    Die die = null, emptyDie = null;

    @Test
    public void successfullyTestOrderFulfillmentController() {
        loadTestData();
        ConversionService conversionService = new OrderfulfillmentConversionService();
        OrderFulfillmentController controller = new OrderFulfillmentController(conversionService);
        assertNotNull(controller.populateOrderFulfillments());
    }
    ...
    class OrderfulfillmentConversionService implements ConversionService {
