...
public class DefectController {
    ...
    public String create(@Valid Defect defect, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String createDefectFormForInspection(@PathVariable("carriernumber") Integer carriernumber, @PathVariable("detailedinventory") boolean detailedinventory, Model uiModel) {
        Defect defect = new Defect();
    ...
    public String update(@Valid Defect defect, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            uiModel.addAttribute("defect", defect);
            addDateTimeFormatPatterns(uiModel);
...
//        }
    ...
    public String updateForm(@PathVariable("id") Long id, @PathVariable("detailedinventory") boolean detailedinventory, Model uiModel) {
        uiModel.addAttribute("defect", Defect.findDefect(id));
        uiModel.addAttribute("detailedinventory", detailedinventory);
        addDateTimeFormatPatterns(uiModel);
        return "defects/update";
    ...
    public String delete(@PathVariable("id") Long id, @PathVariable("detailedinventory") Boolean detailedInventory, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel, HttpServletRequest httpServletRequest) {
