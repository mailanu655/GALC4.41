...
public class CarrierController {
	...
	//	public String create(@Valid Carrier carrier, BindingResult bindingResult, Model uiModel,
	...
	public String list(@RequestParam(value = "page", required = false) Integer page,
		...
		if (page != null || size != null) {
			...
			if (finderCriteria == null) {
				...
				carrierMeslist = CarrierMes.findCarriersByCarrierNumberAndDieAndCurrentLocationAndCarrierStatusAndPressAndProductionRunNo(finderCriteria, page, sizeNo);
	...
	public String update(@Valid Carrier carrier,
	...
	public String updateFormForCurrentLocationModify(@PathVariable("id") Long id, @PathVariable("currentlocation") Long location,
			HttpServletRequest httpServletRequest,
			Model uiModel) {
		CarrierMes carrierMes = CarrierMes.findCarrier(id);
		Carrier carrier = null;
	...
	public String inspectionUpdate(Carrier carrier,
			BindingResult bindingResult,
			@RequestParam("workStationName") String workStationName,
			Model uiModel, HttpServletRequest httpServletRequest) {
		uiModel.asMap().clear();
	...
	public String pressActivityForm(@RequestParam("press") String press, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size,
			Model uiModel) {
	...
	public String findCarrierByCriteria(
			...
			@RequestParam("die") Die die,
			@RequestParam("productionRunNumber") Integer productionRunNumber,
			@RequestParam("currentLocation") Stop currentLocation,
			@RequestParam("carrierStatus") CarrierStatus carrierStatus,
			@RequestParam("press") Press press,
			@RequestParam("destination") Stop destination,
			@RequestParam("maintRequired") Integer maintRequired,
		...
		BitInfo finderBits = new BitInfo(
				(maintRequired==null||maintRequired==3)?null:(maintRequired!=0),
	...
	private boolean allMaintBitsNull (BitInfo bitInfo){
		if(bitInfo==null) return true;
		if(bitInfo.getShowBit1()!=null) return false;
		if(bitInfo.getShowBit2()!=null) return false;
		if(bitInfo.getShowBit3()!=null) return false;
		if(bitInfo.getShowBit4()!=null) return false;
		if(bitInfo.getShowBit5()!=null) return false;
		if(bitInfo.getShowBit6()!=null) return false;
		if(bitInfo.getShowBit7()!=null) return false;
		if(bitInfo.getShowBit8()!=null) return false;
		if(bitInfo.getShowBit9()!=null) return false;
		if(bitInfo.getShowBit10()!=null) return false;
		if(bitInfo.getShowBit11()!=null) return false;
		if(bitInfo.getShowBit12()!=null) return false;
		if(bitInfo.getShowBit13()!=null) return false;
		if(bitInfo.getShowBit14()!=null) return false;
		if(bitInfo.getShowBit15()!=null) return false;
		if(bitInfo.getMaintRequired()!=null) return false;
		return true;

	}
	private void saveCarrierFinderCriteria(CarrierFinderCriteria finderCriteria, HttpServletResponse httpServletResponse) {
