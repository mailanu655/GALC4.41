...
public class AlarmDefinitionController {
    ...
    public String create(@Valid AlarmDefinition alarmDefinition, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(AlarmDefinitionWrapper alarmDefinitionWrapper, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
//        if (bindingResult.hasErrors()) {
...
//uiModel.addAttribute("alarmcontacts", populateAlarmContacts(alarmDefinition));
    ...
    public String showInactiveAlarms(org.springframework.ui.Model uiModel, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
        uiModel.asMap().clear();
    ...
    public String showActiveAlarms(org.springframework.ui.Model uiModel, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
        uiModel.asMap().clear();
