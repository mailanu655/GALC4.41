...
/**
 * Generic queue which stores Object instances.  On arrival of a new Object,
 * all interested Observers are notified and the events are dequeued.
 */
public class ObjectQueue extends Observable implements Runnable, Observer
{
	...
	/**
	 * Wakes up when new Object is enqueued.  This Object is sent to interested listeners.
	 */
	...
	/**
	 * Process new Object by informing all interested Observer
	 * objects.  This runs on a thread separate from postObject().
	 */
