...
public class OrderEmptyCarriersToOldWeldLineServiceImplTest {
    ...
    public void runOrderEmptyCarrierService() {
        ...
        when(storage.retrieveEmptyCarrierForOldWeldLine()).thenReturn(lane).thenThrow(new NoApplicableRuleFoundException("no applicable rule found"));
        ...
        when(helper.getCarrierCountForOldWeldLineEmptyArea()).thenReturn(5).thenReturn(10).thenReturn(7).thenThrow(new RuntimeException("some exception"));
        ...
        OrderEmptyCarriersService emptyCarriersService = new OrderEmptyCarriersToOldWeldLineServiceImpl(helper, storage, releaseManager, "oldWeldLineEmptyUnderFilledQuantity", "carrierCount");
    ...
    public void runOrderEmptyCarrierServiceOLdWeldLIneNotUnderFilled() {
        ...
        when(helper.getCarrierCountForOldWeldLineEmptyArea()).thenReturn(10)
        ...
        OrderEmptyCarriersService emptyCarriersService = new OrderEmptyCarriersToOldWeldLineServiceImpl(helper, storage, releaseManager, "10", "6");
         emptyCarriersService.setServiceRoleWrapper(serviceRoleWrap);
