...
public class StoreOutManagerImplTest {
    ...
    public void initStorage() {
        ...
        Carrier carrier2 = new Carrier(1, today, new Integer(103), new Stop("ST12-32"), null, CarrierStatus.SHIPPABLE, new Integer(200), someDie);

        Carrier carrier3 = new Carrier(2, today, new Integer(103), new Stop("ST12-33"), null, CarrierStatus.SHIPPABLE, new Integer(202), someDie);

        Carrier carrier1 = new Carrier(3, today, new Integer(90), new Stop("ST12-10"), null, CarrierStatus.SHIPPABLE, new Integer(696), leftDie);
        Carrier carrier11 = new Carrier(4, today, new Integer(99), new Stop("ST12-11"), null, CarrierStatus.SHIPPABLE, new Integer(130), rightDie);
        Carrier carrier12 = new Carrier(5, today, new Integer(90), new Stop("ST12-12"), null, CarrierStatus.SHIPPABLE, new Integer(720), leftDie);


        Carrier carrier4 = new Carrier(6, today, new Integer(100), new Stop("ST12-35"), null, CarrierStatus.SHIPPABLE, new Integer(109), leftDie);
        Carrier carrier41 = new Carrier(7, today, new Integer(100), new Stop("ST12-35"), null, CarrierStatus.SHIPPABLE, new Integer(596), leftDie);
        Carrier carrier44 = new Carrier(17, today, new Integer(100), new Stop("ST12-35"), null, CarrierStatus.SHIPPABLE, new Integer(505), leftDie);
        Carrier carrier42 = new Carrier(8, twoDaysOld, new Integer(190), new Stop("ST12-34"), null, CarrierStatus.SHIPPABLE, new Integer(35), leftDie);
        Carrier carrier43 = new Carrier(9, twoDaysOld, new Integer(190), new Stop("ST12-34"), null, CarrierStatus.SHIPPABLE, new Integer(425), leftDie);

        Carrier carrier5 = new Carrier(10, today, new Integer(101), new Stop("ST12-31"), null, CarrierStatus.SHIPPABLE, new Integer(131), rightDie);
        Carrier carrier51 = new Carrier(11, today, new Integer(101), new Stop("ST12-31"), null, CarrierStatus.SHIPPABLE, new Integer(203), rightDie);
        Carrier carrier52 = new Carrier(12, twoDaysOld, new Integer(99), new Stop("ST12-30"), null, CarrierStatus.SHIPPABLE, new Integer(126), rightDie);
        Carrier carrier53 = new Carrier(13, twoDaysOld, new Integer(99), new Stop("ST12-30"), null, CarrierStatus.SHIPPABLE, new Integer(465), rightDie);
        Carrier carrier54 = new Carrier(14, twoDaysOld, new Integer(99), new Stop("ST12-30"), null, CarrierStatus.SHIPPABLE, new Integer(605), rightDie);
    ...
    public void initStorage2() {
        ...
        Carrier carrier2 = new Carrier(1, today, new Integer(103), new Stop("ST12-32"), null, CarrierStatus.ON_HOLD, new Integer(200), leftDie);

        Carrier carrier3 = new Carrier(2, today, new Integer(103), new Stop("ST12-33"), null, CarrierStatus.ON_HOLD, new Integer(202), leftDie);

        Carrier carrier1 = new Carrier(3, today, new Integer(90), new Stop("ST12-10"), null, CarrierStatus.SHIPPABLE, new Integer(696), leftDie);
        Carrier carrier11 = new Carrier(4, today, new Integer(99), new Stop("ST12-11"), null, CarrierStatus.SHIPPABLE, new Integer(130), leftDie);
        Carrier carrier12 = new Carrier(5, today, new Integer(90), new Stop("ST12-12"), null, CarrierStatus.SHIPPABLE, new Integer(720), leftDie);


        Carrier carrier4 = new Carrier(6, today, new Integer(100), new Stop("ST12-35"), null, CarrierStatus.ON_HOLD, new Integer(109), leftDie);
        Carrier carrier41 = new Carrier(7, today, new Integer(100), new Stop("ST12-35"), null, CarrierStatus.ON_HOLD, new Integer(596), leftDie);
        Carrier carrier44 = new Carrier(17, today, new Integer(100), new Stop("ST12-35"), null, CarrierStatus.ON_HOLD, new Integer(505), leftDie);
        Carrier carrier42 = new Carrier(8, twoDaysOld, new Integer(190), new Stop("ST12-34"), null, CarrierStatus.SHIPPABLE, new Integer(35), leftDie);
        Carrier carrier43 = new Carrier(9, twoDaysOld, new Integer(190), new Stop("ST12-34"), null, CarrierStatus.SHIPPABLE, new Integer(425), leftDie);

        Carrier carrier5 = new Carrier(10, today, new Integer(101), new Stop("ST12-31"), null, CarrierStatus.ON_HOLD, new Integer(131), leftDie);
        Carrier carrier51 = new Carrier(11, today, new Integer(101), new Stop("ST12-31"), null, CarrierStatus.ON_HOLD, new Integer(203), leftDie);
        Carrier carrier52 = new Carrier(12, twoDaysOld, new Integer(99), new Stop("ST12-30"), null, CarrierStatus.ON_HOLD, new Integer(126), leftDie);
        Carrier carrier53 = new Carrier(13, twoDaysOld, new Integer(99), new Stop("ST12-30"), null, CarrierStatus.SHIPPABLE, new Integer(465), leftDie);
        Carrier carrier54 = new Carrier(14, twoDaysOld, new Integer(99), new Stop("ST12-30"), null, CarrierStatus.SHIPPABLE, new Integer(605), leftDie);

        Carrier carrier6 = new Carrier(15, twoDaysOld, new Integer(99), new Stop("ST12-34"), null, CarrierStatus.ON_HOLD, new Integer(135), leftDie);
        Carrier carrier61 = new Carrier(16, twoDaysOld, new Integer(99), new Stop("ST12-34"), null, CarrierStatus.SHIPPABLE, new Integer(136), leftDie);
        Carrier carrier62 = new Carrier(16, twoDaysOld, new Integer(99), new Stop("ST12-34"), null, CarrierStatus.SHIPPABLE, new Integer(137), emptyDie);
        Carrier carrier63 = new Carrier(16, twoDaysOld, new Integer(99), new Stop("ST12-34"), null, CarrierStatus.SHIPPABLE, new Integer(138), emptyDie);
        List<StorageRow> storageLanes = getStorageRows();
    ...
    public void retrieveMediumVolumeDieTest2() {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (i == 1) {
                ...
                c.add(Calendar.DATE, -2);
                Timestamp twoDaysOld = new Timestamp(c.getTimeInMillis());
                Carrier carrier6 = new Carrier(15, twoDaysOld, new Integer(99), new Stop("ST12-34"), new Stop("ST12-34"), CarrierStatus.SHIPPABLE, new Integer(135), leftDie);
