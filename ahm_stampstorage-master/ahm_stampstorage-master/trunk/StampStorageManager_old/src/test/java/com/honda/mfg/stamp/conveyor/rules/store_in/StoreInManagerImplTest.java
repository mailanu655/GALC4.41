...
public class StoreInManagerImplTest {
    ...
    public void initStorage() {
        ...
        Carrier carrier2 = new Carrier(1, today, new Integer(103), stop1, null, CarrierStatus.SHIPPABLE, new Integer(200), someDie);
        ...
        Set<Long> parts = new HashSet<Long>();
        parts.add(rightDie.getId());
        storageState.setBackOrderedParts(parts);
