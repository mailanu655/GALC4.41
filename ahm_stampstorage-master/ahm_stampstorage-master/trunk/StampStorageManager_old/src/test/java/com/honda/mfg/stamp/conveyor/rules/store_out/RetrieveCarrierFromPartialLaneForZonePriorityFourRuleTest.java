 ...
 * Date: 3/11/11
 */
public class RetrieveCarrierFromPartialLaneForZonePriorityFourRuleTest {
    ...
    public void successfullyRetrieveCarriersWithHighVolumeParts() {
        ...
        StorageStateContext context = getContext();
                        ...
                        new RetrieveCarrierFromRowOfZonePriorityAndRowCondition(context, null, LaneCondition.PARTIAL, StoragePriority.Priority.FOUR);
    ...
    private List<StorageRow> getLanes() {
       ...
       // aAreaLane3.store(getMediumVolumeCarrier(OM.PART_A, OM.PRODUCTION_RUN_NUMBER, OM.NEW_PRODUCTION_RUN_TIMESTAMP,aAreaLane3.getStop(),aAreaLane3.getStop()));
        for (int i = 0; i < aAreaLane4.getCapacity()-2; i++) {
