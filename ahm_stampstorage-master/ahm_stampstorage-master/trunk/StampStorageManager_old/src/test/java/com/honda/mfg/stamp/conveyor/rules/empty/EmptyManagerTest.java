...
public class EmptyManagerTest {
    ...
    public void retrieveTest() {
        ...
        Carrier carrier55 = new Carrier(14, new Timestamp(Calendar.getInstance().getTimeInMillis()), null, new Stop("ST5-13"), null, CarrierStatus.SHIPPABLE, new Integer(605), emptyDie);
        carrier55.setQuantity(new Integer(0));

        emptyManager.storeEmptyCarrier(carrier55);

        Carrier carrier56 = new Carrier(15, new Timestamp(Calendar.getInstance().getTimeInMillis()), null, new Stop("ST5-13"), null, CarrierStatus.SHIPPABLE, new Integer(650), emptyDie);
    ...
    public void initStorage() {
        ...
        Carrier carrier2 = new Carrier(1, today, new Integer(103), new Stop(1232L), new Stop(1232L), CarrierStatus.SHIPPABLE, new Integer(200), someDie);
        Carrier carrier3 = new Carrier(2, today, new Integer(103), new Stop(1233L), new Stop(1233L), CarrierStatus.SHIPPABLE, new Integer(202), someDie);

        Carrier carrier1 = new Carrier(3, twoDaysOld, new Integer(90), new Stop(1210L), new Stop(1210L), CarrierStatus.SHIPPABLE, new Integer(696), emptyDie);
        Carrier carrier11 = new Carrier(4, twoDaysOld, new Integer(99), new Stop(1211L), new Stop(1211L), CarrierStatus.SHIPPABLE, new Integer(130), emptyDie);
        Carrier carrier12 = new Carrier(5, twoDaysOld, new Integer(90), new Stop(1212L), new Stop(1212L), CarrierStatus.SHIPPABLE, new Integer(720), emptyDie);

        Carrier carrier111 = new Carrier(15, twoDaysOld, new Integer(90), new Stop(1208L), new Stop(1208L), CarrierStatus.SHIPPABLE, new Integer(696), emptyDie);
        Carrier carrier112 = new Carrier(16, twoDaysOld, new Integer(99), new Stop(1207L), new Stop(1207L), CarrierStatus.SHIPPABLE, new Integer(130), emptyDie);
        Carrier carrier113 = new Carrier(17, twoDaysOld, new Integer(90), new Stop(1207L), new Stop(1207L), CarrierStatus.SHIPPABLE, new Integer(720), emptyDie);

        Carrier carrier4 = new Carrier(6, today, null, new Stop(1235L), new Stop(1235L), CarrierStatus.SHIPPABLE, new Integer(109), emptyDie);
        Carrier carrier41 = new Carrier(7, today, null, new Stop(1235L), new Stop(1235L), CarrierStatus.SHIPPABLE, new Integer(596), emptyDie);
        Carrier carrier42 = new Carrier(8, twoDaysOld, null, new Stop(1234L), new Stop(1234L), CarrierStatus.SHIPPABLE, new Integer(35), emptyDie);
        Carrier carrier43 = new Carrier(9, twoDaysOld, null, new Stop(1234L), new Stop(1234L), CarrierStatus.SHIPPABLE, new Integer(425), emptyDie);

        Carrier carrier5 = new Carrier(10, today, new Integer(101), new Stop(1231L), new Stop(1231L), CarrierStatus.SHIPPABLE, new Integer(131), rightDie);
        Carrier carrier51 = new Carrier(11, today, new Integer(101), new Stop(1231L), new Stop(1231L), CarrierStatus.SHIPPABLE, new Integer(203), rightDie);
        Carrier carrier52 = new Carrier(12, twoDaysOld, new Integer(99), new Stop(1230L), new Stop(1230L), CarrierStatus.SHIPPABLE, new Integer(126), rightDie);
        Carrier carrier53 = new Carrier(13, twoDaysOld, new Integer(99), new Stop(1230L), new Stop(1230L), CarrierStatus.SHIPPABLE, new Integer(465), rightDie);
        Carrier carrier54 = new Carrier(14, twoDaysOld, new Integer(99), new Stop(1230L), new Stop(1230L), CarrierStatus.SHIPPABLE, new Integer(605), rightDie);

        Carrier carrier121 = new Carrier(18, twoDaysOld, new Integer(90), new Stop(1221L), new Stop(1221L), CarrierStatus.SHIPPABLE, new Integer(696), emptyDie);
        Carrier carrier122 = new Carrier(19, twoDaysOld, new Integer(99), new Stop(1221L), new Stop(1221L), CarrierStatus.SHIPPABLE, new Integer(130), emptyDie);
        Carrier carrier123 = new Carrier(20, twoDaysOld, new Integer(90), new Stop(1221L), new Stop(1221L), CarrierStatus.SHIPPABLE, new Integer(720), emptyDie);

        Carrier carrier131 = new Carrier(18, twoDaysOld, new Integer(90), new Stop(1240L), new Stop(1240L), CarrierStatus.SHIPPABLE, new Integer(700), emptyDie);
        Carrier carrier132 = new Carrier(19, twoDaysOld, new Integer(99), new Stop(1240L), new Stop(1240L), CarrierStatus.SHIPPABLE, new Integer(701), emptyDie);
        Carrier carrier133 = new Carrier(20, twoDaysOld, new Integer(90), new Stop(1240L), new Stop(1240L), CarrierStatus.SHIPPABLE, new Integer(721), emptyDie);
