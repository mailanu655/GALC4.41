 ...
 * Date: 3/11/11
 */
public class RetrieveCarrierFromFullLanesForZonePriorityFiveRuleTest {
    ...
    public void successfullyRetrieveCarriersWithHighVolumeParts() {
        ...
        StoreOutRule storeOutRule =
                new RetrieveCarrierFromRowOfZonePriorityAndRowCondition(context, null, LaneCondition.FULL, StoragePriority.Priority.FIVE);
        ...
        assertEquals(StorageRow.getStorageArea(), StorageArea.A_AREA);
        assertEquals(OM.A_AREA_CAPACITY.intValue(), StorageRow.getCapacity().intValue());
    ...
    public void successfullyRetrieveCarriersWithMediumVolumeParts() {
        ...
        // Post condition / assertions
        assertNotNull(StorageRow);
         assertEquals(StorageRow.getStorageArea(), StorageArea.S_AREA);
    ...
    public void successfullyRetrieveCarriersWithLowVolumeParts() {
        ...
        // Post condition / assertions
        assertNotNull(StorageRow);
        assertEquals(OM.S_AREA_CAPACITY.intValue(), StorageRow.getCurrentCarrierCount());
        Carrier carrier = StorageRow.release();
    ...
    private List<StorageRow> getLanes() {
        ...
        for (int i = 0; i < aAreaLane1.getCapacity().intValue(); i++) {
            aAreaLane1.store(getHighVolumeCarrier(OM.PART_A, OM.OLD_PRODUCTION_RUN_NUMBER, OM.NEW_PRODUCTION_RUN_TIMESTAMP, aAreaLane1.getStop(), aAreaLane1.getStop()));
        }
