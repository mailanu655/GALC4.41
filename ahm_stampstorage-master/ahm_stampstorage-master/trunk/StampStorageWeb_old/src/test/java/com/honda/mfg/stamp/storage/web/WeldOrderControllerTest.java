...
public class WeldOrderControllerTest {
    ...
    enum OrderType  {L_ONLY, R_ONLY, LR};
    ...
    public WeldOrder createOrder(OrderStatus orderStatus, OrderStatus deliveryStatus, OrderType oType)  {
        ...
        if(oType == OrderType.L_ONLY)  wo.setRightQuantity(0);
        else wo.setRightQuantity(100);
        if(oType == OrderType.R_ONLY)  wo.setLeftQuantity(0);
        else wo.setLeftQuantity(100);
