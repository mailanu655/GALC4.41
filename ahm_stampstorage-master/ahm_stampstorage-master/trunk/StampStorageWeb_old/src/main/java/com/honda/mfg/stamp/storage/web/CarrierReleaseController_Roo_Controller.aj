...
privileged aspect CarrierReleaseController_Roo_Controller {

    @RequestMapping(method = RequestMethod.POST)
    public String CarrierReleaseController.create(@Valid CarrierRelease carrierRelease, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String CarrierReleaseController.createForm(Model uiModel) {
    ...
    public String CarrierReleaseController.show(@PathVariable("id") Long id, Model uiModel) {
    ...
    public String CarrierReleaseController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    public String CarrierReleaseController.update(@Valid CarrierRelease carrierRelease, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            uiModel.addAttribute("carrierRelease", carrierRelease);
    ...
    public String CarrierReleaseController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("carrierRelease", CarrierRelease.findCarrierRelease(id));
        return "carrierreleases/update";
    }

    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE)
    public String CarrierReleaseController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    public Collection<CarrierRelease> CarrierReleaseController.populateCarrierReleases() {
        return CarrierRelease.findAllCarrierReleases();
    }

    @ModelAttribute("stops")
    public Collection<Stop> CarrierReleaseController.populateStops() {
        return Stop.findAllStops();
    }

    String CarrierReleaseController.encodeUrlPathSegment(String pathSegment, HttpServletRequest httpServletRequest) {
