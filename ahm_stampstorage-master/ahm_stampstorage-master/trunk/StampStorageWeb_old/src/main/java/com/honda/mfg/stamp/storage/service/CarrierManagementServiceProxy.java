...
public interface CarrierManagementServiceProxy {
    ...
    void addCarrierToRow(Integer carrierNumber, Integer position,
                         Stop laneStop);

    void saveCarriersInToRow(List<Integer> carrierNumberList, Stop laneStop);

    void releaseEmptyCarriersFromRows(StorageArea area,
                                      boolean releaseMgr, String source);

    void releaseCarriers(StorageRow lane, Integer releaseCount,
                         Stop destination, String source);
