...
privileged aspect GroupHoldController_Roo_Controller {


    @RequestMapping(params = "ByRowAndProductionRunNoAndProductionRunDate", method = RequestMethod.GET)
    public String GroupHoldController.findCarrierByCriteriaform(Model uiModel, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
    ...
    public String GroupHoldController.findCarrierByCriteriaform(@PathVariable("carriernumber") Integer carrierNumber, Model uiModel, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
    ...
    public String GroupHoldController.carrierlist(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
    ...
    public String GroupHoldController.findCarrierByCriteria(@RequestParam("row") Long row, @RequestParam("radio1") String radio, @RequestParam(value = "productionRunNumber", required = true) Integer productionRunNumber, @RequestParam("robot") Press robot, @RequestParam("productionRunDate") String productionRunDate, @RequestParam("numberAfterRunDate") Integer numberAfterRunDate, @RequestParam("numberBeforeRunDate") Integer numberBeforeRunDate, @RequestParam("carrierStatus") CarrierStatus status, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Model uiModel) {
    ...
    public String GroupHoldController.createDefectForm(Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String GroupHoldController.create(Defect defect, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
    ...
    public String GroupHoldController.updateDefectForm(@PathVariable("id") Long id, Model uiModel, HttpServletRequest httpServletRequest) {
        String imgUrl = "";
        String imageName = "";
    ...
    public String GroupHoldController.update(Defect defect, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
    ...
    public String GroupHoldController.delete(@PathVariable("id") Long id, Model uiModel, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
    ...
    public String GroupHoldController.submitGroupHold(Model uiModel, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
        GroupHoldFinderCriteria finderCriteria = getGroupHoldFinderCriteria(httpServletRequest);
        List<Defect> defectList = getDefectList(httpServletRequest);
    ...
    public Collection<DEFECT_TYPE>GroupHoldController.populateDEFECT_TYPEs() {
        return Arrays.asList(DEFECT_TYPE.class.getEnumConstants());
    }

    @ModelAttribute("rework_methods")
    public Collection<REWORK_METHOD>GroupHoldController.populateREWORK_METHODs() {
        return Arrays.asList(REWORK_METHOD.class.getEnumConstants());
    }

    private void GroupHoldController.saveDefect(Defect defect, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
    ...
    private void GroupHoldController.updateDefect(Defect defect, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
        try {
    ...
    private void GroupHoldController.deleteDefect(Long id, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
        Cookie cookies[] = httpServletRequest.getCookies();
        String name = "";
    ...
    private GroupHoldFinderCriteria GroupHoldController.getGroupHoldFinderCriteria(HttpServletRequest httpServletRequest) {
        Cookie cookies[] = httpServletRequest.getCookies();
        String name = "";
        String value = "";
    ...
    private void GroupHoldController.saveFinderCriteria(GroupHoldFinderCriteria finderCriteria, HttpServletResponse httpServletResponse) {
    ...
    private List<Defect>GroupHoldController.getDefectList(HttpServletRequest httpServletRequest) {
...
//            LOG.debug("Cookies found-" + name + "-" + value);
    ...
    private Timestamp GroupHoldController.getRunDate(String runDate) {
    ...
    private void GroupHoldController.clearAllDefects(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
    ...
    private Defect GroupHoldController.getDefect(Long id, HttpServletRequest httpServletRequest) {
...
//            LOG.debug("Defect String-" + defectString);
    ...
    private List<CarrierStatus>GroupHoldController.getCarrierStatuses() {
...
//    }
    ...
    private StorageRow GroupHoldController.getRow(String name) {
        List<StorageRow> rows = StorageRow.findAllStorageRows();
    ...
    private List<Press>GroupHoldController.getPressRobotList() {
        List<Press> pressList = new ArrayList<Press>();
    ...
    private String GroupHoldController.getCarriersInWeld(List<Carrier> carrierList) {
        String msg = "";
