...
privileged aspect WeldOrderController_Roo_Controller {

    @RequestMapping(method = RequestMethod.POST)
    public String WeldOrderController.create(@Valid WeldOrder weldOrder, BindingResult bindingResult, org.springframework.ui.Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String WeldOrderController.createForm(org.springframework.ui.Model uiModel) {
    ...
    public String WeldOrderController.show(@PathVariable("id") Long id, org.springframework.ui.Model uiModel) {
    ...
    public String WeldOrderController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, org.springframework.ui.Model uiModel) {
    ...
    private List<WeldOrder> WeldOrderController.getWeldorders() {
    ...
    private List<WeldOrder> WeldOrderController.getWeldordersDelivering() {
        List<WeldOrder> weldOrders = new ArrayList<WeldOrder>();
        SecurityContext context = SecurityContextHolder.getContext();
        Authentication authentication = context.getAuthentication();
        Collection<GrantedAuthority> authorities = authentication.getAuthorities();
    ...
    private List<WeldOrder> WeldOrderController.getWeldordersPending() {
        List<WeldOrder> weldOrders = new ArrayList<WeldOrder>();
        SecurityContext context = SecurityContextHolder.getContext();
        Authentication authentication = context.getAuthentication();
        Collection<GrantedAuthority> authorities = authentication.getAuthorities();
    ...
    private Collection<OrderMgr> WeldOrderController.getOrderMgrs() {
    ...
    public String WeldOrderController.update(@Valid WeldOrder weldOrder, BindingResult bindingResult, org.springframework.ui.Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            uiModel.addAttribute("weldOrder", weldOrder);
            uiModel.addAttribute("ordermgrs", getOrderMgrs());
    ...
    public String WeldOrderController.updateForm(@PathVariable("id") Long id, org.springframework.ui.Model uiModel) {
    ...
    public String  WeldOrderController.updateOrderFulfillment(@RequestParam("itemId") Long id, @RequestParam("carrierNumber") Integer carrierNumber,@RequestParam("cycle") Integer releaseCycle,org.springframework.ui.Model uiModel) {
        uiModel.asMap().clear();
    ...
    public String WeldOrderController.findWeldOrdersByOrderMgrAndOrderStatusForm(org.springframework.ui.Model uiModel) {
        uiModel.addAttribute("ordermgrs", getOrderMgrs());
        uiModel.addAttribute("filterorderstatuses", populateOrderStatuses());
        return "weldorders/list";
    }
    @RequestMapping(params = "find=ByOrderMgrAndByOrderStatus", method = RequestMethod.GET)
    public String WeldOrderController.findWeldOrdersByOrderMgrAndOrderStatus(@RequestParam("orderMgr") OrderMgr orderMgr, @RequestParam("orderStatus") OrderStatus orderStatus, org.springframework.ui.Model uiModel) {
        uiModel.addAttribute("weldOrder", new WeldOrder());
    ...
    public String WeldOrderController.findWeldOrdersByOrderMgrAndOrderStatusAndDeliveryStatus(@RequestParam("orderMgr") OrderMgr orderMgr, @RequestParam("orderStatus") OrderStatus orderStatus, @RequestParam("deliveryStatus") OrderStatus deliveryStatus, org.springframework.ui.Model uiModel) {
    ...
    public String WeldOrderController.findWeldOrderForm(org.springframework.ui.Model uiModel) {
    ...
    public String WeldOrderController.findWeldOrder(@RequestParam("orderMgr") OrderMgr orderMgr, org.springframework.ui.Model uiModel) {
    ...
    public String WeldOrderController.manuallyCompleteWeldOrderForm(org.springframework.ui.Model uiModel) {
        return "weldorders/manual";
    }
    @RequestMapping(params = "find=ByManualComplete", method = RequestMethod.GET)
    public String WeldOrderController.manuallyCompleteWeldOrder(@RequestParam("id") Long id, org.springframework.ui.Model uiModel) {
    ...
    public String WeldOrderController.cancelWeldOrder(@RequestParam("id") Long id, org.springframework.ui.Model uiModel) {
    ...
    public String WeldOrderController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, org.springframework.ui.Model uiModel) {
    ...
    public Collection<OrderMgr> WeldOrderController.populateOrderMgrs() {
        return OrderMgr.findAllOrderMgrs();
    }

    @ModelAttribute("orderstatuses")
    public Collection<OrderStatus> WeldOrderController.populateOrderStatuses() {
    ...
    public Collection<WeldOrder> WeldOrderController.populateWeldOrders() {
        return WeldOrder.findAllWeldOrders();
    }

    @ModelAttribute("carrierfulfillmentstatuses")
    public Collection<CarrierFulfillmentStatus>WeldOrderController.populateCarrierFulfillmentStatuses() {
        return Arrays.asList(CarrierFulfillmentStatus.class.getEnumConstants());
    }
    @ModelAttribute("stops")
    public Collection<Stop>WeldOrderController.populateStops() {
        return Stop.findAllStops();
    }
    String WeldOrderController.encodeUrlPathSegment(String pathSegment, HttpServletRequest httpServletRequest) {
    ...
    List<OrderStatus> WeldOrderController.getOrderStatusList(WeldOrder weldOrder, boolean create) {
    ...
    List<OrderStatus> WeldOrderController.getDeliveryStatusList(WeldOrder weldOrder, boolean create) {
        ...
        if (create) {
            ...
            if (weldOrder.getDeliveryStatus().equals(OrderStatus.Initialized)) {
            	//if(isNextForDelivery(weldOrder))  {
    ...
    boolean WeldOrderController.canUpdateOrderStatus(WeldOrder weldOrder) {
     ...
     boolean WeldOrderController.canUpdateDeliveryStatus(WeldOrder weldOrder) {
        boolean canUpdateOrderStatus = false;
        ...
        if (inprocessWeldOrders == null  && deliveringWeldOrders == null) {
            canUpdateOrderStatus = true;
    ...
    boolean WeldOrderController.isNextForDelivery(WeldOrder order)  {
