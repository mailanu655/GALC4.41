...
privileged aspect CarrierHistoryController_Roo_Controller {

    @RequestMapping(method = RequestMethod.POST)
    public String CarrierHistoryController.create(@Valid CarrierHistory carrierHistory, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String CarrierHistoryController.createForm(Model uiModel) {
        uiModel.addAttribute("carrierHistory", new CarrierHistory());
        return "carrierhistories/create";
    }

    @RequestMapping(value = "/{id}", method = RequestMethod.GET)
    public String CarrierHistoryController.show(@PathVariable("id") Long id, Model uiModel) {
    ...
    public String CarrierHistoryController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Model uiModel) {
    ...
    public String CarrierHistoryController.update(@Valid CarrierHistory carrierHistory, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            uiModel.addAttribute("carrierHistory", carrierHistory);
    ...
    public String CarrierHistoryController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("carrierHistory", CarrierHistory.findCarrierHistory(id));
        return "carrierhistories/update";
    }

    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE)
    public String CarrierHistoryController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    public String CarrierHistoryController.findCarrierHistoryByCriteriaForm(Model uiModel) {
    ...
    public String CarrierHistoryController.findCarrierHistoryByCriteria(
    ...
    private CarrierHistoryFinderCriteria CarrierHistoryController.getSavedCarrierHistoryFinderCriteria(HttpServletRequest httpServletRequest) {
    ...
    private void CarrierHistoryController.saveCarrierHistoryFinderCriteria(CarrierHistoryFinderCriteria finderCriteria, HttpServletResponse httpServletResponse) {
    ...
    String CarrierHistoryController.encodeUrlPathSegment(String pathSegment, HttpServletRequest httpServletRequest) {
