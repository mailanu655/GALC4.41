...
privileged aspect AuditErrorLogController_Roo_Controller {
   ...
   // private AuditErrorLogFinderCriteria finderCriteria;
    ...
    public String AuditErrorLogController.create(@Valid AuditErrorLog auditErrorLog, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String AuditErrorLogController.createForm(Model uiModel) {
        uiModel.addAttribute("auditErrorLog", new AuditErrorLog());
        return "auditerrorlogs/create";
    }

    @RequestMapping(value = "/{id}", method = RequestMethod.GET)
    public String AuditErrorLogController.show(@PathVariable("id") Long id, Model uiModel) {
    ...
    public String AuditErrorLogController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Model uiModel) {
    ...
    public String AuditErrorLogController.update(@Valid AuditErrorLog auditErrorLog,
    ...
    public String AuditErrorLogController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("auditErrorLog", AuditErrorLog.findAuditErrorLog(id));
        return "auditerrorlogs/update";
    }

    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE)
    public String AuditErrorLogController.delete(@PathVariable("id") Long id,
    ...
    public String AuditErrorLogController.findAuditErrorLogByCriteriaForm(Model uiModel) {
    ...
    public String AuditErrorLogController.findAuditErrorLogByCriteria(
    ...
    private AuditErrorLogFinderCriteria AuditErrorLogController.getSavedAuditErrorLogFinderCriteria(HttpServletRequest httpServletRequest) {
    ...
    private void AuditErrorLogController.saveAuditErrorLogFinderCriteria(AuditErrorLogFinderCriteria finderCriteria, HttpServletResponse httpServletResponse) {
    ...
    String AuditErrorLogController.encodeUrlPathSegment(String pathSegment, HttpServletRequest httpServletRequest) {
