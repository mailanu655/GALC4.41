...
privileged aspect OrderMgrIntegrationTest_Roo_IntegrationTest {

    declare @type: OrderMgrIntegrationTest:@RunWith(SpringJUnit4ClassRunner.class);

    declare @type: OrderMgrIntegrationTest:@ContextConfiguration(locations = "classpath:/META-INF/spring/applicationContext.xml");

    declare @type: OrderMgrIntegrationTest:@Transactional;

    @Autowired
    private OrderMgrDataOnDemand OrderMgrIntegrationTest.dod;

    @Test
    public void OrderMgrIntegrationTest.testCountOrderMgrs() {
    ...
    @Test
    public void OrderMgrIntegrationTest.testFindOrderMgr() {
    ...
    @Test
    public void OrderMgrIntegrationTest.testFindAllOrderMgrs() {
        org.junit.Assert.assertNotNull("Data on demand for 'OrderMgr' failed to initialize correctly", dod.getRandomOrderMgr());
        long count = OrderMgr.countOrderMgrs();
    ...
    @Test
    public void OrderMgrIntegrationTest.testFindOrderMgrEntries() {
        org.junit.Assert.assertNotNull("Data on demand for 'OrderMgr' failed to initialize correctly", dod.getRandomOrderMgr());
        long count = OrderMgr.countOrderMgrs();
    ...
    @Test
    public void OrderMgrIntegrationTest.testFlush() {
        OrderMgr obj = dod.getRandomOrderMgr();
        org.junit.Assert.assertNotNull("Data on demand for 'OrderMgr' failed to initialize correctly", obj);
        Long id = obj.getId();
        org.junit.Assert.assertNotNull("Data on demand for 'OrderMgr' failed to provide an identifier", id);
    ...
    @Test
    public void OrderMgrIntegrationTest.testMerge() {
        OrderMgr obj = dod.getRandomOrderMgr();
        org.junit.Assert.assertNotNull("Data on demand for 'OrderMgr' failed to initialize correctly", obj);
        Long id = obj.getId();
        org.junit.Assert.assertNotNull("Data on demand for 'OrderMgr' failed to provide an identifier", id);
    ...
    @Test
    public void OrderMgrIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'OrderMgr' failed to initialize correctly", dod.getRandomOrderMgr());
    ...
    @Test
    public void OrderMgrIntegrationTest.testRemove() {
        OrderMgr obj = dod.getRandomOrderMgr();
        org.junit.Assert.assertNotNull("Data on demand for 'OrderMgr' failed to initialize correctly", obj);
        Long id = obj.getId();
        org.junit.Assert.assertNotNull("Data on demand for 'OrderMgr' failed to provide an identifier", id);
