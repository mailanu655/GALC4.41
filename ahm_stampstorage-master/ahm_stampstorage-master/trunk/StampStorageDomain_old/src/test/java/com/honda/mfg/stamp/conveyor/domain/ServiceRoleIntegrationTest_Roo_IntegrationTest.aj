...
import com.honda.mfg.stamp.conveyor.domain.ServiceRoleDataOnDemand;
...
privileged aspect ServiceRoleIntegrationTest_Roo_IntegrationTest {
    
    declare @type: ServiceRoleIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: ServiceRoleIntegrationTest: @ContextConfiguration(locations = "classpath:/META-INF/spring/applicationContext.xml");
    
    declare @type: ServiceRoleIntegrationTest: @Transactional;
    
    @Autowired
    private ServiceRoleDataOnDemand ServiceRoleIntegrationTest.dod;
    
    @Test
    public void ServiceRoleIntegrationTest.testCountServiceRoles() {
    ...
    @Test
    public void ServiceRoleIntegrationTest.testFindServiceRole() {
    ...
    @Test
    public void ServiceRoleIntegrationTest.testFindAllServiceRoles() {
        org.junit.Assert.assertNotNull("Data on demand for 'ServiceRole' failed to initialize correctly", dod.getRandomServiceRole());
        long count = com.honda.mfg.stamp.conveyor.domain.ServiceRole.countServiceRoles();
    ...
    @Test
    public void ServiceRoleIntegrationTest.testFindServiceRoleEntries() {
        org.junit.Assert.assertNotNull("Data on demand for 'ServiceRole' failed to initialize correctly", dod.getRandomServiceRole());
        long count = com.honda.mfg.stamp.conveyor.domain.ServiceRole.countServiceRoles();
    ...
    @Test
    public void ServiceRoleIntegrationTest.testFlush() {
        com.honda.mfg.stamp.conveyor.domain.ServiceRole obj = dod.getRandomServiceRole();
        org.junit.Assert.assertNotNull("Data on demand for 'ServiceRole' failed to initialize correctly", obj);
        java.lang.Long id = obj.getId();
        org.junit.Assert.assertNotNull("Data on demand for 'ServiceRole' failed to provide an identifier", id);
    ...
    @Test
    public void ServiceRoleIntegrationTest.testMerge() {
        com.honda.mfg.stamp.conveyor.domain.ServiceRole obj = dod.getRandomServiceRole();
        org.junit.Assert.assertNotNull("Data on demand for 'ServiceRole' failed to initialize correctly", obj);
        java.lang.Long id = obj.getId();
        org.junit.Assert.assertNotNull("Data on demand for 'ServiceRole' failed to provide an identifier", id);
    ...
    @Test
    public void ServiceRoleIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'ServiceRole' failed to initialize correctly", dod.getRandomServiceRole());
    ...
    @Test
    public void ServiceRoleIntegrationTest.testRemove() {
        com.honda.mfg.stamp.conveyor.domain.ServiceRole obj = dod.getRandomServiceRole();
        org.junit.Assert.assertNotNull("Data on demand for 'ServiceRole' failed to initialize correctly", obj);
        java.lang.Long id = obj.getId();
        org.junit.Assert.assertNotNull("Data on demand for 'ServiceRole' failed to provide an identifier", id);
