...
public class CarrierTest {
    ...
    public void testEquals() {
        ...
        carrier = new Carrier(id, productionRunTimestamp, prodRunNo, currentLocation, destination, carrierStatus, carrierNumber, new Die(1L, PartProductionVolume.HIGH_VOLUME));
        carrier.setQuantity(10);

        Carrier carrier1 = new Carrier(id, productionRunTimestamp, prodRunNo, currentLocation, destination, carrierStatus, carrierNumber, new Die(1L, PartProductionVolume.HIGH_VOLUME));
