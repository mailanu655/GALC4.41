...
privileged aspect CarrierIntegrationTest_Roo_IntegrationTest {

    declare @type: CarrierIntegrationTest:@RunWith(SpringJUnit4ClassRunner.class);

    declare @type: CarrierIntegrationTest:@ContextConfiguration(locations = "classpath:/META-INF/spring/applicationContext.xml");

    declare @type: CarrierIntegrationTest:@Transactional;

    @Autowired
    private CarrierDataOnDemand CarrierIntegrationTest.dod;

    @Test
    public void CarrierIntegrationTest.testCountCarriers() {
    ...
    @Test
    public void CarrierIntegrationTest.testFindCarrier() {
    ...
    @Test
    public void CarrierIntegrationTest.testFindAllCarriers() {
        org.junit.Assert.assertNotNull("Data on demand for 'Carrier' failed to initialize correctly", dod.getRandomCarrier());
        long count = com.honda.mfg.stamp.conveyor.domain.Carrier.countCarriers();
    ...
    @Test
    public void CarrierIntegrationTest.testFindCarrierEntries() {
        org.junit.Assert.assertNotNull("Data on demand for 'Carrier' failed to initialize correctly", dod.getRandomCarrier());
        long count = com.honda.mfg.stamp.conveyor.domain.Carrier.countCarriers();
    ...
    @Test
    public void CarrierIntegrationTest.testFlush() {
        com.honda.mfg.stamp.conveyor.domain.Carrier obj = dod.getRandomCarrier();
        org.junit.Assert.assertNotNull("Data on demand for 'Carrier' failed to initialize correctly", obj);
        Long id = obj.getId();
        org.junit.Assert.assertNotNull("Data on demand for 'Carrier' failed to provide an identifier", id);
    ...
    @Test
    public void CarrierIntegrationTest.testMerge() {
        com.honda.mfg.stamp.conveyor.domain.Carrier obj = dod.getRandomCarrier();
        org.junit.Assert.assertNotNull("Data on demand for 'Carrier' failed to initialize correctly", obj);
        Long id = obj.getId();
        org.junit.Assert.assertNotNull("Data on demand for 'Carrier' failed to provide an identifier", id);
    ...
    @Test
    public void CarrierIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Carrier' failed to initialize correctly", dod.getRandomCarrier());
    ...
    @Test
    public void CarrierIntegrationTest.testRemove() {
        com.honda.mfg.stamp.conveyor.domain.Carrier obj = dod.getRandomCarrier();
        org.junit.Assert.assertNotNull("Data on demand for 'Carrier' failed to initialize correctly", obj);
        Long id = obj.getId();
        org.junit.Assert.assertNotNull("Data on demand for 'Carrier' failed to provide an identifier", id);
