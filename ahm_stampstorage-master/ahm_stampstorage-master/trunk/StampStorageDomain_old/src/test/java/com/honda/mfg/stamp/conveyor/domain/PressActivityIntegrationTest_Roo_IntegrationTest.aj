...
import com.honda.mfg.stamp.conveyor.domain.PressActivityDataOnDemand;
...
privileged aspect PressActivityIntegrationTest_Roo_IntegrationTest {
    
    declare @type: PressActivityIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: PressActivityIntegrationTest: @ContextConfiguration(locations = "classpath:/META-INF/spring/applicationContext.xml");
    
    declare @type: PressActivityIntegrationTest: @Transactional;
    
    @Autowired
    private PressActivityDataOnDemand PressActivityIntegrationTest.dod;
    
    @Test
    public void PressActivityIntegrationTest.testCountPressActivitys() {
    ...
    @Test
    public void PressActivityIntegrationTest.testFindPressActivity() {
    ...
    @Test
    public void PressActivityIntegrationTest.testFindAllPressActivitys() {
        org.junit.Assert.assertNotNull("Data on demand for 'PressActivity' failed to initialize correctly", dod.getRandomPressActivity());
        long count = com.honda.mfg.stamp.conveyor.domain.PressActivity.countPressActivitys();
    ...
    @Test
    public void PressActivityIntegrationTest.testFindPressActivityEntries() {
        org.junit.Assert.assertNotNull("Data on demand for 'PressActivity' failed to initialize correctly", dod.getRandomPressActivity());
        long count = com.honda.mfg.stamp.conveyor.domain.PressActivity.countPressActivitys();
    ...
    @Test
    public void PressActivityIntegrationTest.testFlush() {
        com.honda.mfg.stamp.conveyor.domain.PressActivity obj = dod.getRandomPressActivity();
        org.junit.Assert.assertNotNull("Data on demand for 'PressActivity' failed to initialize correctly", obj);
        java.lang.Long id = obj.getId();
        org.junit.Assert.assertNotNull("Data on demand for 'PressActivity' failed to provide an identifier", id);
    ...
    @Test
    public void PressActivityIntegrationTest.testMerge() {
        com.honda.mfg.stamp.conveyor.domain.PressActivity obj = dod.getRandomPressActivity();
        org.junit.Assert.assertNotNull("Data on demand for 'PressActivity' failed to initialize correctly", obj);
        java.lang.Long id = obj.getId();
        org.junit.Assert.assertNotNull("Data on demand for 'PressActivity' failed to provide an identifier", id);
    ...
    @Test
    public void PressActivityIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'PressActivity' failed to initialize correctly", dod.getRandomPressActivity());
    ...
    @Test
    public void PressActivityIntegrationTest.testRemove() {
        com.honda.mfg.stamp.conveyor.domain.PressActivity obj = dod.getRandomPressActivity();
        org.junit.Assert.assertNotNull("Data on demand for 'PressActivity' failed to initialize correctly", obj);
        java.lang.Long id = obj.getId();
        org.junit.Assert.assertNotNull("Data on demand for 'PressActivity' failed to provide an identifier", id);
