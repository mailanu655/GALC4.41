...
privileged aspect CarrierMesIntegrationTest_Roo_IntegrationTest {

    declare @type: CarrierMesIntegrationTest:@RunWith(SpringJUnit4ClassRunner.class);

    declare @type: CarrierMesIntegrationTest:@ContextConfiguration(locations = "classpath:/META-INF/spring/applicationContext.xml");

    declare @type: CarrierMesIntegrationTest:@Transactional;

    @Autowired
    private CarrierMesDataOnDemand CarrierMesIntegrationTest.dod;

    @Test
    public void CarrierMesIntegrationTest.testUpdateDateIssue() {
...
//        org.junit.Assert.assertEquals(afterMS, fndAfter.getUpdateDate().getTime());
    ...
    @Test
    public void CarrierMesIntegrationTest.testCountCarriers() {
    ...
    @Test
    public void CarrierMesIntegrationTest.testFindCarrier() {
    ...
    @Test
    public void CarrierMesIntegrationTest.testFindAllCarriers() {
        org.junit.Assert.assertNotNull("Data on demand for 'Carrier' failed to initialize correctly", dod.getRandomCarrier());
        long count = CarrierMes.countCarriers();
    ...
    @Test
    public void CarrierMesIntegrationTest.testFindCarrierEntries() {
        org.junit.Assert.assertNotNull("Data on demand for 'Carrier' failed to initialize correctly", dod.getRandomCarrier());
        long count = CarrierMes.countCarriers();
    ...
    @Test
    public void CarrierMesIntegrationTest.testFindCarrierByCarrierNumber() {
        org.junit.Assert.assertNotNull("Data on demand for 'Carrier' failed to initialize correctly", dod.getRandomCarrier());
        long count = CarrierMes.countCarriers();
        if (count > 20) count = 20;
        java.util.List<CarrierMes> result = CarrierMes.findCarrierEntries(0, (int) count);
    ...
    @Test
    public void CarrierMesIntegrationTest.testFlush() {
        CarrierMes obj = dod.getRandomCarrier();
        org.junit.Assert.assertNotNull("Data on demand for 'Carrier' failed to initialize correctly", obj);
        Long id = obj.getId();
        org.junit.Assert.assertNotNull("Data on demand for 'Carrier' failed to provide an identifier", id);
    ...
    @Test
    public void CarrierMesIntegrationTest.testMerge() {
        CarrierMes obj = dod.getRandomCarrier();
        org.junit.Assert.assertNotNull("Data on demand for 'Carrier' failed to initialize correctly", obj);
        Long id = obj.getId();
        org.junit.Assert.assertNotNull("Data on demand for 'Carrier' failed to provide an identifier", id);
    ...
    @Test
    public void CarrierMesIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Carrier' failed to initialize correctly", dod.getRandomCarrier());
    ...
    @Test
    public void CarrierMesIntegrationTest.testRemove() {
        CarrierMes obj = dod.getRandomCarrier();
        org.junit.Assert.assertNotNull("Data on demand for 'Carrier' failed to initialize correctly", obj);
        Long id = obj.getId();
        org.junit.Assert.assertNotNull("Data on demand for 'Carrier' failed to provide an identifier", id);
