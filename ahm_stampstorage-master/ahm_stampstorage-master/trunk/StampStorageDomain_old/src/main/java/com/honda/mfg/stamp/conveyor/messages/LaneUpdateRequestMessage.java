...
public class LaneUpdateRequestMessage implements ServiceRequestMessage {
	 ...
	 * @param carrierNumber
	 */
	public LaneUpdateRequestMessage(Integer carrierNumber,
	 ...
	 * @param laneStop
	 */
	public LaneUpdateRequestMessage(Integer carrierNumber, Integer position,
			Long laneStop, CarrierUpdateOperations targetOp) {
		super();
		this.targetOp = targetOp;
		setCarrierNumber(carrierNumber);
