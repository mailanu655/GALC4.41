...
public interface NewFulfillmentHelper extends Helper {
    ...
    void saveWeldOrderComments(WeldOrder order, String comments);

    void saveWeldOrderStatusAndComments(WeldOrder order, OrderStatus orderStatus, String comments);
    ...
    void saveWeldDeliveryStatusAndComments(WeldOrder order, OrderStatus deliveringCarriers, String s);
