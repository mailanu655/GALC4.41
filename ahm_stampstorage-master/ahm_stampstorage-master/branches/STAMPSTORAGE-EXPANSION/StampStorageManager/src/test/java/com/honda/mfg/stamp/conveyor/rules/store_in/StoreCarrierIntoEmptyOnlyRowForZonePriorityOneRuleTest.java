 ...
 */
public class StoreCarrierIntoEmptyOnlyRowForZonePriorityOneRuleTest {
	@Test
	public void successfullyStoreHighVolumeCarrier() {
		...
		expectedLaneImpl.store(emptyCarrier1); // first in lane
		expectedLaneImpl.store(emptyCarrier2); // last in lane
		...
		StoreInRule storeInRule = new StoreCarrierIntoRowOfZonePriorityAndRowCondition(OM.storageState(lanes, null),
				null, LaneCondition.EMPTY, StoragePriority.Priority.ONE);
