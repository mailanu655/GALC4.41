...
public class SubStoreCarrierIntoLaneRuleTest {
	...
	public void successfullyStoreCarriersIntoLowCapacityPartialLane() {
		...
		StoreInRule storeInRule = new SubStoreCarrierIntoLaneRule(context, null, StorageArea.A_AREA);

		Carrier carrier = new Carrier(101, new Die(OM.PART_A, PartProductionVolume.HIGH_VOLUME), 10,
