...
/**
 * User: Adam S. Kendell Date: Mar 10, 2011
 */
public class StoreCarrierIntoMixedRowForZonePriorityThreeRuleTest {
	...
	public void successfullyStoreHighVolumeCarrier() {
		...
		StoreInRule storeInRule = new StoreCarrierIntoRowOfZonePriorityAndRowCondition(OM.storageState(lanes, null),
				null, LaneCondition.MIXED, StoragePriority.Priority.THREE);
