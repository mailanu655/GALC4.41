...
/**
 * User: Jeffrey M Lutz Date: 3/7/11
 */
public class StoreCarrierIntoMixedSameRowForZonePriorityOneRuleTest {
	@Test
	public void successfullyStoreHighVolumeCarrier() {
		...
		StoreInRule storeInRule = new StoreCarrierIntoRowOfZonePriorityAndRowCondition(OM.storageState(lanes, null),
				null, LaneCondition.MIXED_BACK, StoragePriority.Priority.ONE);
