...
/**
 * User: Jeffrey M Lutz Date: 3/6/11 X 9- High vol parts in low capacity partial
 * StorageRow X 9- Med vol parts in low capacity partial StorageRow
 */
public class StoreCarrierIntoPartialLaneWithSamePartsForZonePriorityThreeRuleTest {
	...
	public void successfullyStoreEmptyCarrier() {
		...
		StoreInRule storeInRule = new StoreCarrierIntoRowOfZonePriorityAndRowCondition(OM.storageState(lanes, null),
				null, LaneCondition.PARTIAL, StoragePriority.Priority.THREE);
