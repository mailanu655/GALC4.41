 ...
 */
public class RetrieveCarrierFromFullLanesForZonePriorityTwoRuleTest {
	...
	public void successfullyRetrieveCarriersWithHighVolumeParts() {
		...
		StoreOutRule storeOutRule = new RetrieveCarrierFromRowOfZonePriorityAndRowCondition(context, null,
				LaneCondition.FULL, StoragePriority.Priority.TWO);
	...
	public void successfullyRetrieveEmptyCarriers() {
		...
		assertEquals(sRow.getCapacity(), OM.C_LOW_CAPACITY);
	}
	...
	private List<StorageRow> getLanes() {
		 ...
		 * production run + 1 new med vol in the end lane4: high volume, full lane, old
		 * production run
		 * 
