...
/**
 * User: Jeffrey M Lutz Date: 3/6/11
 */
public class StoreCarrierIntoPartialLaneWithSamePartsForZonePriorityOneRuleTest {
	...
	public void successfullyStoreEmptyCarrier() {
		...
		StoreInRule storeInRule = new StoreCarrierIntoRowOfZonePriorityAndRowCondition(OM.storageState(lanes, null),
				null, LaneCondition.PARTIAL, StoragePriority.Priority.ONE);
