 ...
 */
public class StoreCarrierIntoPartialLaneWithSamePartsForZonePriorityFiveRuleTest {
	...
	public void successfullyStoreEmptyCarrier() {
		...
		ignored4LaneImpl.store(carrier1); // first in StorageRow
		ignored4LaneImpl.store(OM.carrier_Empty()); // last in StorageRow
		...
		StoreInRule storeInRule = new StoreCarrierIntoRowOfZonePriorityAndRowCondition(OM.storageState(lanes, null),
				null, LaneCondition.PARTIAL, StoragePriority.Priority.FIVE);
