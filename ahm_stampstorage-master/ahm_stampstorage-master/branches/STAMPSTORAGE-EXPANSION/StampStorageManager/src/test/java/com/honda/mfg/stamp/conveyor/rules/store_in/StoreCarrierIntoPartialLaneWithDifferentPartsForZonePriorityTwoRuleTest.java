...
public class StoreCarrierIntoPartialLaneWithDifferentPartsForZonePriorityTwoRuleTest {
	...
	public void successfullyStoreEmptyCarrier() {
		...
		StoreInRule storeInRule = new StoreCarrierIntoRowOfZonePriorityAndRowCondition(OM.storageState(lanes, null),
				null, LaneCondition.PARTIAL_DIFFERENT_DIE, StoragePriority.Priority.TWO);
