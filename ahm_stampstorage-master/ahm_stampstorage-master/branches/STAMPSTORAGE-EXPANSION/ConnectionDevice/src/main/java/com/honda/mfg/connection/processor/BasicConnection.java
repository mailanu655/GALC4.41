...
public class BasicConnection implements ConnectionDevice {
	...
	public BasicConnection(ConnectionProcessorPair connectionProcessorPair, ConnectionInitializeState initializeState,
	...
	public void sendMessage(ConnectionMessage message) throws CommunicationsException, NetworkCommunicationException {
		if (!isInitialized()) {
			...
			throw new CommunicationsException(
					"Unable to send mes request since the device is not initialized right now.");
		}
