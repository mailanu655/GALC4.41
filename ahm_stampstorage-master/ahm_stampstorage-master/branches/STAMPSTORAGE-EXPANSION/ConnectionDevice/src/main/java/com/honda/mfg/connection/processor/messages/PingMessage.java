...
public class PingMessage extends ConnectionMessageBase {
	...
	public PingMessage(String lastStoreAndForwardEventTime, boolean lastStoreAndForwardState) {
		// EXAMPLE: {"GeneralMessage":{"lastStoreAndForwardEventTime":"2011-06-18
		// 11:52:37.","lastStoreAndForwardState":"101","messageType":"PING"}}
		super("{\"messageType\":\"PING\",\"lastStoreAndForwardEventTime\":\"" + lastStoreAndForwardEventTime
	...
	public boolean isHealthy() {
		return this.lastStoreAndForwardState != null && this.lastStoreAndForwardState.contains(HEALTHY_STATE_CODE);
	}
}
