...
public class StreamConnectionProcessorPairTest {
	...
	public void successfullyStartResponseProcessorOnNewThread() {
		...
		StreamConnectionProcessorPair pair = new StreamConnectionProcessorPair(streamPair);
	...
	public void successfullyRunResponseProcessor() {
		...
		StreamConnectionProcessorPair pair = new StreamConnectionProcessorPair(streamPair, RUN_ONCE);
