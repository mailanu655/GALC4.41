...
public class SocketFactoryTest {
	...
	public void successfullyConnectSocketToServer() throws IOException {
		...
		// Perform test
		assertEquals("For some reason the server has accepted the client socket early.", false,
				server.hasAcceptedClientConnection());
	...
	@Test
	public void noExceptionWhenServerDropsSocketConnectionSinceSocketCannotDetermineHealthOfItself()
			throws IOException {
		server = new TestableSocketServer(GOOD_PORT);
