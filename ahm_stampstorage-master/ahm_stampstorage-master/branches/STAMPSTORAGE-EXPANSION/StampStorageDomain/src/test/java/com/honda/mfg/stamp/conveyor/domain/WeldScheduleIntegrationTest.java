...
public class WeldScheduleIntegrationTest {
	...
	public void testCountWeldSchedules() {
		org.junit.Assert.assertNotNull("Data on demand for 'WeldSchedule' failed to initialize correctly",
				dod.getRandomWeldSchedule());
	...
	public void testFindWeldSchedule() {
		...
		org.junit.Assert.assertNotNull("Find method for 'WeldSchedule' illegally returned null for id '" + id + "'",
				obj);
		org.junit.Assert.assertEquals("Find method for 'WeldSchedule' returned the incorrect identifier", id,
				obj.getId());
	}
	...
	public void testFindAllWeldSchedules() {
		org.junit.Assert.assertNotNull("Data on demand for 'WeldSchedule' failed to initialize correctly",
				dod.getRandomWeldSchedule());
		long count = com.honda.mfg.stamp.conveyor.domain.WeldSchedule.countWeldSchedules();
		org.junit.Assert.assertTrue("Too expensive to perform a find all test for 'WeldSchedule', as there are " + count
				+ " entries; set the findAllMaximum to exceed this value or set findAll=false on the integration test annotation to disable the test",
				count < 250);
		java.util.List<com.honda.mfg.stamp.conveyor.domain.WeldSchedule> result = com.honda.mfg.stamp.conveyor.domain.WeldSchedule
				.findAllWeldSchedules();
	...
	public void testFindWeldScheduleEntries() {
		...
		if (count > 20)
			count = 20;
		java.util.List<com.honda.mfg.stamp.conveyor.domain.WeldSchedule> result = com.honda.mfg.stamp.conveyor.domain.WeldSchedule
				.findWeldScheduleEntries(0, (int) count);
		org.junit.Assert.assertNotNull("Find entries method for 'WeldSchedule' illegally returned null", result);
		org.junit.Assert.assertEquals("Find entries method for 'WeldSchedule' returned an incorrect number of entries",
				count, result.size());
	}
	...
	public void testFlush() {
		...
		obj.flush();
		org.junit.Assert.assertTrue("Version for 'WeldSchedule' failed to increment on flush directive",
	...
	public void testMerge() {
		...
		boolean modified = dod.modifyWeldSchedule(obj);
		java.lang.Integer currentVersion = obj.getVersion();
		com.honda.mfg.stamp.conveyor.domain.WeldSchedule merged = (com.honda.mfg.stamp.conveyor.domain.WeldSchedule) obj
				.merge();
		obj.flush();
		org.junit.Assert.assertEquals("Identifier of merged object not the same as identifier of original object",
				merged.getId(), id);
		org.junit.Assert.assertTrue("Version for 'WeldSchedule' failed to increment on merge and flush directive",
				(currentVersion != null && obj.getVersion() > currentVersion) || !modified);
	}
	...
	public void testPersist() {
		...
		org.junit.Assert.assertNotNull("Data on demand for 'WeldSchedule' failed to provide a new transient entity",
				obj);
	...
	public void testRemove() {
		...
		obj.remove();
		obj.flush();
		org.junit.Assert.assertNull("Failed to remove 'WeldSchedule' with identifier '" + id + "'",
				com.honda.mfg.stamp.conveyor.domain.WeldSchedule.findWeldSchedule(id));
	}
}
