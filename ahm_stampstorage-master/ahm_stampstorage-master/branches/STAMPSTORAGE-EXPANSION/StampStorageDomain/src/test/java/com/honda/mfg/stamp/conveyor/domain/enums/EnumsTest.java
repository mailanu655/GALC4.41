...
/**
 * Created by IntelliJ IDEA. User: Ambica Gawarla Date: 3/5/12 Time: 3:59 PM To
...
//        assertEquals(3, CarrierStatus.MAINTENANCE_REQUIRED.type());
	...
	public void successfullyTestLaneCapacity() {
		...
		assertEquals(LaneVolumeStorage.ROW_35_HIGH_VOLUME_STORAGE,
				LaneVolumeStorage.valueOf("ROW_35_HIGH_VOLUME_STORAGE"));
	...
	public void successfullyTestStoragePriority() {
		assertEquals(StoragePriority.getStorageAreaByPriorityForVolume(PartProductionVolume.EMPTY,
				StoragePriority.Priority.ONE), StorageArea.A_AREA);
		assertEquals(StoragePriority.getStoragePriorityByArea(PartProductionVolume.EMPTY, StorageArea.A_AREA),
				StoragePriority.Priority.ONE);

		assertEquals(StoragePriority.getStorageAreaByPriorityForVolume(PartProductionVolume.EMPTY,
				StoragePriority.Priority.TWO), StorageArea.C_LOW);
		assertEquals(StoragePriority.getStoragePriorityByArea(PartProductionVolume.EMPTY, StorageArea.C_LOW),
				StoragePriority.Priority.TWO);

		assertEquals(StoragePriority.getStorageAreaByPriorityForVolume(PartProductionVolume.EMPTY,
				StoragePriority.Priority.THREE), StorageArea.B_AREA);
		assertEquals(StoragePriority.getStoragePriorityByArea(PartProductionVolume.EMPTY, StorageArea.B_AREA),
				StoragePriority.Priority.THREE);

		assertEquals(StoragePriority.getStorageAreaByPriorityForVolume(PartProductionVolume.EMPTY,
				StoragePriority.Priority.FOUR), StorageArea.C_HIGH);
		assertEquals(StoragePriority.getStoragePriorityByArea(PartProductionVolume.EMPTY, StorageArea.C_HIGH),
				StoragePriority.Priority.FOUR);

		assertEquals(StoragePriority.getStorageAreaByPriorityForVolume(PartProductionVolume.HIGH_VOLUME,
				StoragePriority.Priority.ONE), StorageArea.S_AREA);
		assertEquals(StoragePriority.getStoragePriorityByArea(PartProductionVolume.HIGH_VOLUME, StorageArea.S_AREA),
				StoragePriority.Priority.ONE);

		assertEquals(StoragePriority.getStorageAreaByPriorityForVolume(PartProductionVolume.HIGH_VOLUME,
				StoragePriority.Priority.TWO), StorageArea.B_AREA);
		assertEquals(StoragePriority.getStoragePriorityByArea(PartProductionVolume.HIGH_VOLUME, StorageArea.B_AREA),
				StoragePriority.Priority.TWO);

		assertEquals(StoragePriority.getStorageAreaByPriorityForVolume(PartProductionVolume.HIGH_VOLUME,
				StoragePriority.Priority.THREE), StorageArea.C_LOW);
		assertEquals(StoragePriority.getStoragePriorityByArea(PartProductionVolume.HIGH_VOLUME, StorageArea.C_LOW),
				StoragePriority.Priority.THREE);

		assertEquals(StoragePriority.getStorageAreaByPriorityForVolume(PartProductionVolume.HIGH_VOLUME,
				StoragePriority.Priority.FOUR), StorageArea.C_HIGH);
		assertEquals(StoragePriority.getStoragePriorityByArea(PartProductionVolume.HIGH_VOLUME, StorageArea.C_HIGH),
				StoragePriority.Priority.FOUR);

		assertEquals(StoragePriority.getStorageAreaByPriorityForVolume(PartProductionVolume.HIGH_VOLUME,
				StoragePriority.Priority.FIVE), StorageArea.A_AREA);
		assertEquals(StoragePriority.getStoragePriorityByArea(PartProductionVolume.HIGH_VOLUME, StorageArea.A_AREA),
				StoragePriority.Priority.FIVE);

		assertEquals(StoragePriority.getStorageAreaByPriorityForVolume(PartProductionVolume.MEDIUM_VOLUME,
				StoragePriority.Priority.ONE), StorageArea.C_LOW);
		assertEquals(StoragePriority.getStoragePriorityByArea(PartProductionVolume.MEDIUM_VOLUME, StorageArea.C_LOW),
				StoragePriority.Priority.ONE);

		assertEquals(StoragePriority.getStorageAreaByPriorityForVolume(PartProductionVolume.MEDIUM_VOLUME,
				StoragePriority.Priority.TWO), StorageArea.B_AREA);
		assertEquals(StoragePriority.getStoragePriorityByArea(PartProductionVolume.MEDIUM_VOLUME, StorageArea.B_AREA),
				StoragePriority.Priority.TWO);

		assertEquals(StoragePriority.getStorageAreaByPriorityForVolume(PartProductionVolume.MEDIUM_VOLUME,
				StoragePriority.Priority.THREE), StorageArea.C_HIGH);
		assertEquals(StoragePriority.getStoragePriorityByArea(PartProductionVolume.MEDIUM_VOLUME, StorageArea.C_HIGH),
				StoragePriority.Priority.THREE);

		assertEquals(StoragePriority.getStorageAreaByPriorityForVolume(PartProductionVolume.MEDIUM_VOLUME,
				StoragePriority.Priority.FOUR), StorageArea.A_AREA);
		assertEquals(StoragePriority.getStoragePriorityByArea(PartProductionVolume.MEDIUM_VOLUME, StorageArea.A_AREA),
				StoragePriority.Priority.FOUR);

		assertEquals(StoragePriority.getStorageAreaByPriorityForVolume(PartProductionVolume.MEDIUM_VOLUME,
				StoragePriority.Priority.FIVE), StorageArea.S_AREA);
		assertEquals(StoragePriority.getStoragePriorityByArea(PartProductionVolume.MEDIUM_VOLUME, StorageArea.S_AREA),
				StoragePriority.Priority.FIVE);

		assertEquals(StoragePriority.getStorageAreaByPriorityForVolume(PartProductionVolume.LOW_VOLUME,
				StoragePriority.Priority.ONE), StorageArea.C_HIGH);
		assertEquals(StoragePriority.getStoragePriorityByArea(PartProductionVolume.LOW_VOLUME, StorageArea.C_HIGH),
				StoragePriority.Priority.ONE);

		assertEquals(StoragePriority.getStorageAreaByPriorityForVolume(PartProductionVolume.LOW_VOLUME,
				StoragePriority.Priority.TWO), StorageArea.C_LOW);
		assertEquals(StoragePriority.getStoragePriorityByArea(PartProductionVolume.LOW_VOLUME, StorageArea.C_LOW),
				StoragePriority.Priority.TWO);

		assertEquals(StoragePriority.getStorageAreaByPriorityForVolume(PartProductionVolume.LOW_VOLUME,
				StoragePriority.Priority.THREE), StorageArea.B_AREA);
		assertEquals(StoragePriority.getStoragePriorityByArea(PartProductionVolume.LOW_VOLUME, StorageArea.B_AREA),
				StoragePriority.Priority.THREE);

		assertEquals(StoragePriority.getStorageAreaByPriorityForVolume(PartProductionVolume.LOW_VOLUME,
				StoragePriority.Priority.FOUR), StorageArea.A_AREA);
		assertEquals(StoragePriority.getStoragePriorityByArea(PartProductionVolume.LOW_VOLUME, StorageArea.A_AREA),
				StoragePriority.Priority.FOUR);

		assertEquals(StoragePriority.getStorageAreaByPriorityForVolume(PartProductionVolume.LOW_VOLUME,
				StoragePriority.Priority.FIVE), StorageArea.S_AREA);
		assertEquals(StoragePriority.getStoragePriorityByArea(PartProductionVolume.LOW_VOLUME, StorageArea.S_AREA),
				StoragePriority.Priority.FIVE);
