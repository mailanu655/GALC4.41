...
public class WeldOrderIntegrationTest {
	...
	public void testCountWeldOrders() {
		org.junit.Assert.assertNotNull("Data on demand for 'WeldOrder' failed to initialize correctly",
				dod.getRandomWeldOrder());
	...
	public void testFindAllWeldOrders() {
		org.junit.Assert.assertNotNull("Data on demand for 'WeldOrder' failed to initialize correctly",
				dod.getRandomWeldOrder());
		long count = WeldOrder.countWeldOrders();
		org.junit.Assert.assertTrue("Too expensive to perform a find all test for 'WeldOrder', as there are " + count
	...
	public void testFindWeldOrderEntries() {
		...
		org.junit.Assert.assertEquals("Find entries method for 'WeldOrder' returned an incorrect number of entries",
				count, result.size());
	}
	...
	public void testFlush() {
		...
		obj.flush();
		org.junit.Assert.assertTrue("Version for 'WeldOrder' failed to increment on flush directive",
	...
	public void testMerge() {
		...
		org.junit.Assert.assertEquals("Identifier of merged object not the same as identifier of original object",
				merged.getId(), id);
		org.junit.Assert.assertTrue("Version for 'WeldOrder' failed to increment on merge and flush directive",
				(currentVersion != null && obj.getVersion() > currentVersion) || !modified);
	}
	...
	public void testRemove() {
		...
		obj.remove();
		obj.flush();
		org.junit.Assert.assertNull("Failed to remove 'WeldOrder' with identifier '" + id + "'",
				WeldOrder.findWeldOrder(id));
	}
}
