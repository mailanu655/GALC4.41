...
public class AlarmContactDataOnDemand {
	...
	public void setContactType(AlarmContact obj, int index) {
		com.honda.mfg.stamp.conveyor.domain.enums.ContactType contactType = com.honda.mfg.stamp.conveyor.domain.enums.ContactType.class
				.getEnumConstants()[0];
	...
	public void init() {
		...
		if (data == null)
			throw new IllegalStateException("Find entries implementation for 'AlarmContact' illegally returned null");
		if (!data.isEmpty()) {
			return;
		}
