...
public class OrderMgrIntegrationTest {
	...
	public void testCountOrderMgrs() {
		org.junit.Assert.assertNotNull("Data on demand for 'OrderMgr' failed to initialize correctly",
				dod.getRandomOrderMgr());
	...
	public void testFindAllOrderMgrs() {
		org.junit.Assert.assertNotNull("Data on demand for 'OrderMgr' failed to initialize correctly",
				dod.getRandomOrderMgr());
		long count = OrderMgr.countOrderMgrs();
		org.junit.Assert.assertTrue("Too expensive to perform a find all test for 'OrderMgr', as there are " + count
	...
	public void testFindOrderMgrEntries() {
		...
		org.junit.Assert.assertEquals("Find entries method for 'OrderMgr' returned an incorrect number of entries",
				count, result.size());
	}
	...
	public void testFlush() {
		...
		obj.flush();
		org.junit.Assert.assertTrue("Version for 'OrderMgr' failed to increment on flush directive",
	...
	public void testMerge() {
		...
		org.junit.Assert.assertEquals("Identifier of merged object not the same as identifier of original object",
				merged.getId(), id);
		org.junit.Assert.assertTrue("Version for 'OrderMgr' failed to increment on merge and flush directive",
				(currentVersion != null && obj.getVersion() > currentVersion) || !modified);
	}
	...
	public void testRemove() {
		...
		obj.remove();
		obj.flush();
		org.junit.Assert.assertNull("Failed to remove 'OrderMgr' with identifier '" + id + "'",
				OrderMgr.findOrderMgr(id));
	}
}
