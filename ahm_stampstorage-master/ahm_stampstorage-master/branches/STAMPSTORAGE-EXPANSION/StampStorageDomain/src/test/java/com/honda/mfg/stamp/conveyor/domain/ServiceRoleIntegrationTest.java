...
public class ServiceRoleIntegrationTest {
	...
	public void testCountServiceRoles() {
		org.junit.Assert.assertNotNull("Data on demand for 'ServiceRole' failed to initialize correctly",
				dod.getRandomServiceRole());
	...
	public void testFindServiceRole() {
		...
		org.junit.Assert.assertNotNull("Find method for 'ServiceRole' illegally returned null for id '" + id + "'",
				obj);
		org.junit.Assert.assertEquals("Find method for 'ServiceRole' returned the incorrect identifier", id,
				obj.getId());
	}
	...
	public void testFindAllServiceRoles() {
		org.junit.Assert.assertNotNull("Data on demand for 'ServiceRole' failed to initialize correctly",
				dod.getRandomServiceRole());
		long count = com.honda.mfg.stamp.conveyor.domain.ServiceRole.countServiceRoles();
		org.junit.Assert.assertTrue("Too expensive to perform a find all test for 'ServiceRole', as there are " + count
				+ " entries; set the findAllMaximum to exceed this value or set findAll=false on the integration test annotation to disable the test",
				count < 250);
		java.util.List<com.honda.mfg.stamp.conveyor.domain.ServiceRole> result = com.honda.mfg.stamp.conveyor.domain.ServiceRole
				.findAllServiceRoles();
	...
	public void testFindServiceRoleEntries() {
		...
		if (count > 20)
			count = 20;
		java.util.List<com.honda.mfg.stamp.conveyor.domain.ServiceRole> result = com.honda.mfg.stamp.conveyor.domain.ServiceRole
				.findServiceRoleEntries(0, (int) count);
		org.junit.Assert.assertNotNull("Find entries method for 'ServiceRole' illegally returned null", result);
		org.junit.Assert.assertEquals("Find entries method for 'ServiceRole' returned an incorrect number of entries",
				count, result.size());
	}
	...
	public void testFlush() {
		...
		obj.flush();
		org.junit.Assert.assertTrue("Version for 'ServiceRole' failed to increment on flush directive",
	...
	public void testMerge() {
		...
		boolean modified = dod.modifyServiceRole(obj);
		java.lang.Integer currentVersion = obj.getVersion();
		com.honda.mfg.stamp.conveyor.domain.ServiceRole merged = (com.honda.mfg.stamp.conveyor.domain.ServiceRole) obj
				.merge();
		obj.flush();
		org.junit.Assert.assertEquals("Identifier of merged object not the same as identifier of original object",
				merged.getId(), id);
		org.junit.Assert.assertTrue("Version for 'ServiceRole' failed to increment on merge and flush directive",
				(currentVersion != null && obj.getVersion() > currentVersion) || !modified);
	}
	...
	public void testPersist() {
		...
		org.junit.Assert.assertNotNull("Data on demand for 'ServiceRole' failed to provide a new transient entity",
				obj);
	...
	public void testRemove() {
		...
		obj.remove();
		obj.flush();
		org.junit.Assert.assertNull("Failed to remove 'ServiceRole' with identifier '" + id + "'",
				com.honda.mfg.stamp.conveyor.domain.ServiceRole.findServiceRole(id));
	}
}
