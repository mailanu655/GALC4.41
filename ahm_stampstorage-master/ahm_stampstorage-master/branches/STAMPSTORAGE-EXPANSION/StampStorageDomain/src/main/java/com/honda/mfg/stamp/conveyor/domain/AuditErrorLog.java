...
public class AuditErrorLog {
	...
	public static List<AuditErrorLog> findAuditErrorLogByCriteria(AuditErrorLogFinderCriteria finderCriteria,
	...
	public static List<AuditErrorLog> findAuditErrorLogEntries(int firstResult, int maxResults) {
		return entityManager().createQuery("SELECT o FROM AuditErrorLog o", AuditErrorLog.class)
