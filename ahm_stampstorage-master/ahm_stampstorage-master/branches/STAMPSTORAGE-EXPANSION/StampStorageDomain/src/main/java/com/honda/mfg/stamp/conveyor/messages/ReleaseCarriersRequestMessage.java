...
public class ReleaseCarriersRequestMessage implements ServiceRequestMessage {
	 ...
	 * @param targetOp
	 */
	public ReleaseCarriersRequestMessage(Long laneStopId, Integer releaseCount, Long destinationStopId,
	 ...
	 * 
	 * @see
	 * com.honda.mfg.stamp.conveyor.messages.ServiceRequestMessage#getTargetOp()
	 */
	...
	public Stop getLaneStop() {
		Stop thisStop = null;
		if (laneStopId != null) {
			thisStop = Stop.findStop(Long.valueOf(laneStopId));
		}
		return thisStop;
	}
	...
	public Stop getDestination() {
		...
		if (destinationStopId != null) {
			thisStop = Stop.findStop(Long.valueOf(destinationStopId));
		}
		return thisStop;
	}
