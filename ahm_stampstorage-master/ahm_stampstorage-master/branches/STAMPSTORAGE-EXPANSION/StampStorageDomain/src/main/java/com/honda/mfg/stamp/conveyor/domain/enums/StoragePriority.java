...
/**
 * Defines priority based on Production Volume Created by IntelliJ IDEA. User:
 * Ambica Gawarla Date: 2/28/13 Time: 11:32 AM
 */
public class StoragePriority {
	...
	public static StorageArea getStorageAreaByPriorityForVolume(PartProductionVolume partProductionVolume,
			Priority priority) {
