...
public class Carrier {
	...
	public Carrier(long id, Timestamp stampingProductionRunTimestamp, Integer productionRunNo, Stop currentLocation,
			Stop destination, CarrierStatus carrierStatus, Integer carrierNumber, Die die) {
	...
	// LOG.trace(tempCarrier.getQuantity() + "-" + getQuantity() + "," +
	// tempCarrier.getDie() + "-" + getDie());
	// if (tempCarrier.getDie() == null && getDie() == null) {
	// return true;
	// }
	//
	// boolean flag1 = tempCarrier.getQuantity().equals(quantity) &&
	// tempCarrier.getDie().equals(getDie());
	// boolean flag2 = tempCarrier.getCarrierStatus().equals(getCarrierStatus()) &&
	// tempCarrier.getProductionRunNo().equals(getProductionRunNo()) &&
	// tempCarrier.getStampingProductionRunTimestamp().equals(getStampingProductionRunTimestamp());
	// boolean flag3 = tempCarrier.getId() == getId() &&
	// tempCarrier.getCarrierNumber().equals(carrierNumber);
	// boolean flag4 = tempCarrier.getCurrentLocation().equals(getCurrentLocation(),
	// storageStateCompare) && tempCarrier.getDestination().equals(getDestination(),
	// storageStateCompare);
	...
	// if (em == null)
	// throw new IllegalStateException("Entity manager has not been injected (is the
	// Spring Aspects JAR configured as an AJC/AJDT aspects library?)");
	// return em;
	// }
	//
	// public static long countCarriers() {
	// return entityManager().createQuery("SELECT COUNT(o) FROM Carrier o",
	// Long.class).getSingleResult();
	// }
	//
	// public static List<Carrier> findAllCarriers() {
	// return entityManager().createQuery("SELECT o FROM Carrier o",
	...
	// }
	//
	// public static List<Carrier> findCarrierEntries(int firstResult, int
	// maxResults) {
	// return entityManager().createQuery("SELECT o FROM Carrier o",
	// Carrier.class).setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
	// }
	//
	// public static TypedQuery<Carrier>
	// findCarriersByCarrierNumberAndDieAndCurrentLocationAndCarrierStatusAndPressAndProductionRunNo(Integer
	// carrierNumber, Die die, Stop currentLocation, CarrierStatus carrierStatus,
	// Press press, Integer productionRunNo) {
	// if (carrierNumber == null) throw new IllegalArgumentException("The
	// carrierNumber argument is required");
	// if (die == null) throw new IllegalArgumentException("The die argument is
	// required");
	// if (currentLocation == null) throw new IllegalArgumentException("The
	// currentLocation argument is required");
	// if (carrierStatus == null) throw new IllegalArgumentException("The
	// carrierStatus argument is required");
	// if (press == null) throw new IllegalArgumentException("The press argument is
	// required");
	// if (productionRunNo == null) throw new IllegalArgumentException("The
	// productionRunNo argument is required");
	// EntityManager em = Carrier.entityManager();
	// TypedQuery<Carrier> q = em.createQuery("SELECT o FROM Carrier AS o WHERE
	// o.carrierNumber = :carrierNumber AND o.die = :die AND o.currentLocation =
	// :currentLocation AND o.carrierStatus = :carrierStatus AND o.press = :press
	// AND o.productionRunNo = :productionRunNo", Carrier.class);
