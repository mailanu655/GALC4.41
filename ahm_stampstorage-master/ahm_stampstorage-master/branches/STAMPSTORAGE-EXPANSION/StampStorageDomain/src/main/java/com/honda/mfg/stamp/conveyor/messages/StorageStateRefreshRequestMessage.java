 ...
 */
public class StorageStateRefreshRequestMessage implements ServiceRequestMessage {

	private CarrierUpdateOperations targetOp;

	public StorageStateRefreshRequestMessage(CarrierUpdateOperations targetOp) {
		super();
