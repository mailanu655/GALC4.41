...
public class CommandProcessorTest {
	...
	public void testProcessCommandCarrierUpdateRequest() {
		...
		try {
			...
			when(mockRequest.getTargetOp()).thenReturn(CarrierUpdateOperations.SAVE,
					CarrierUpdateOperations.STORE_REWORK, CarrierUpdateOperations.RECALC_DEST);
	...
	public void testProcessLaneUpdateRequest() {
		...
		try {
			...
			when(mockLaneReq.getTargetOp()).thenReturn(CarrierUpdateOperations.REMOVE_FROM_ROW,
					CarrierUpdateOperations.ADD_TO_ROW, CarrierUpdateOperations.REORDER_CARRIERS_IN_ROW);
	...
	public void testProcessCommandReleaseCarrierRequest() {
		...
		try {
			...
			when(mockReleaseCarrierReq.getTargetOp()).thenReturn(CarrierUpdateOperations.RELEASE_CARRIERS);
			mSink.put(this, mockMessage);
	...
	public void testProcessCommandEmptyReleaseRequest() {
		...
		try {
			...
			when(mockReleaseEmptyReq.getTargetOp()).thenReturn(CarrierUpdateOperations.RELEASE_EMPTIES_FROM_ROW);
			mSink.put(this, mockMessage);
	...
	public void testProcessCommandRowResequence() {
		...
		try {
			...
			when(mockReq.getTargetOp()).thenReturn(CarrierUpdateOperations.ROW_RESEQUENCE);
	...
	public void testProcessCommandGroupHold() {
		...
		try {
			...
			when(mockMessage.getContent()).thenReturn(mockReq);
			when(mockReq.getTargetOp()).thenReturn(CarrierUpdateOperations.GROUP_HOLD);
			when(mockReq.getCarrierNumberList()).thenReturn(carrierNumbers);
			mSink.put(this, mockMessage);
