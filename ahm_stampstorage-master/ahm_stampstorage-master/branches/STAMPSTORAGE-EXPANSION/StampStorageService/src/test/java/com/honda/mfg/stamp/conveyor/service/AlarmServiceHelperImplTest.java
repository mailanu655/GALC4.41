...
/**
 * Created by IntelliJ IDEA. User: Ambica Gawarla Date: 4/3/12 Time: 9:24 AM To
...
public class AlarmServiceHelperImplTest {
	...
	public void successfullyArchiveAlarm() {
		...
		AlertingServices alertingService = mock(AlertingServices.class);
	...
	public void successfullyGetUnClearedAlarmsByType() {
		...
		AlertingServices alertingService = mock(AlertingServices.class);
		AlarmServiceHelper alarmServiceHelper = new AlarmServiceHelperImpl(alertingService);
		List<AlarmEvent> expiredAlarms = alarmServiceHelper
				.getUnclearedAlarmsByType(AlarmTypes.MES_CONNECTION_UNHEALTHY.type());
