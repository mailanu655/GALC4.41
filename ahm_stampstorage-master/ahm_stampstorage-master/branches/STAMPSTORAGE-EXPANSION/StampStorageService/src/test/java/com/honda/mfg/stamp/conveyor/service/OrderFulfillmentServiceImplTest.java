...
import com.honda.mfg.stamp.conveyor.newfulfillment.DeliveryManager;
...
public class OrderFulfillmentServiceImplTest {
	...
	public void successfullyRunOrderFulfillmentService() {
		...
		Fulfillment fulfillment = new OrderFulfillmentManager(orderMgr, storage, helper, releaseManager,
		...
		Fulfillment delivery = new DeliveryManager(orderMgr, helper, releaseManager, "deliveryCycleSize",
