...
/**
 * Created by IntelliJ IDEA. User: vcc30690 Date: 11/22/11 Time: 9:26 AM To
...
public class RetrieveCycleManagerTest extends AbstractTestBase {
	...
	public void successfullyRetrieveCarriers() {
		...
		when(helper.getNewCarriersToRelease(Matchers.<WeldOrder>any(), Matchers.<Integer>any()))
		...
		RetrieveCycleManager retrieveCycleManager = new RetrieveCycleManager(storage, "fulfillmentCarrierReleaseCount",
				"recirculationCarrierReleaseCount");
	...
	public void successfullyRetrieveCarriers2() {
		...
		ReleaseManagerHelper releaseManagerHelper = new ReleaseManagerHelperImpl();
		ReleaseManager releaseManager = new ReleaseManagerImpl(releaseManagerHelper);
		RetrieveCycleManager retrieveCycleManager = new RetrieveCycleManager(getStorage(),
	...
	public void successfullyRecirculateCarriers() {
		...
		ReleaseManager releaseManager = mock(ReleaseManager.class);
		RetrieveCycleManager retrieveCycleManager = new RetrieveCycleManager(getStorageWithBlockedRows(),
				"fulfillmentCarrierReleaseCount", "recirculationCarrierReleaseCount");
		retrieveCycleManager.process(weldOrder, helper, releaseManager);
		verify(releaseManager, times(2)).releaseCarrier(Matchers.<Integer>any(), Matchers.<Stop>any(), anyString(),
				anyBoolean());
	}
	...
	public Storage getStorageWithBlockedRows() {
		...
		Carrier carrier2 = new Carrier(1, oneDayOld, new Integer(103), stop6, stop6, CarrierStatus.SHIPPABLE,
				new Integer(200), someDie);

		Carrier carrier3 = new Carrier(2, oneDayOld, new Integer(103), stop6, stop6, CarrierStatus.SHIPPABLE,
				new Integer(202), emptyDie);

		Carrier carrier1 = new Carrier(3, oneDayOld, new Integer(90), stop7, stop7, CarrierStatus.SHIPPABLE,
				new Integer(696), leftDie);
		Carrier carrier11 = new Carrier(4, twoDaysOld, new Integer(99), stop8, stop8, CarrierStatus.SHIPPABLE,
				new Integer(130), rightDie);
		Carrier carrier12 = new Carrier(5, oneDayOld, new Integer(90), stop9, stop9, CarrierStatus.SHIPPABLE,
				new Integer(720), leftDie);
	...
	StorageRow getBlockedLane() {
		...
		Carrier carrier1 = new Carrier(8, oneDayOld, new Integer(103), stop6, stop6, CarrierStatus.SHIPPABLE,
				new Integer(201), someDie);
		Carrier carrier2 = new Carrier(1, oneDayOld, new Integer(103), stop6, stop6, CarrierStatus.SHIPPABLE,
				new Integer(200), someDie);
		Carrier carrier3 = new Carrier(2, oneDayOld, new Integer(103), stop6, stop6, CarrierStatus.SHIPPABLE,
				new Integer(202), someDie);
