...
/**
 * Created by IntelliJ IDEA. User: Ambica Gawarla Date: 7/1/13 Time: 9:59 AM To
...
public class BackOrderProcessorTest extends AbstractTestBase {
	...
	public void successfullyReceiveCarrierStatusMessageForStoreIn() {
		...
		BackOrderProcessor storageMessageProcessor = new BackOrderProcessor(storage, helper,
		...
		Carrier carrier = new Carrier(1, new Timestamp(System.currentTimeMillis()), 114, stop, stop2,
				CarrierStatus.SHIPPABLE, 1234, new Die(101l, PartProductionVolume.MEDIUM_VOLUME));
...
//        }
	...
	public void successfullyReceiveCarrierStatusMessageForStoreIn2() {
		...
		Carrier carrier1 = new Carrier(2, new Timestamp(System.currentTimeMillis()), 114, stop, stop2,
				CarrierStatus.SHIPPABLE, 1235, new Die(102l, PartProductionVolume.MEDIUM_VOLUME));
...
//        }
	...
	public void successfullyReceiveCarrierStatusMessageForStoreIn3() {
		...
		Carrier carrier2 = new Carrier(2, new Timestamp(System.currentTimeMillis()), 114, stop, stop2,
				CarrierStatus.ON_HOLD, 1236, new Die(104l, PartProductionVolume.MEDIUM_VOLUME));
...
//        assertEquals(1, updateMessage);
	...
	public void successfullyReceiveCarrierStatusMessageForClearingBackOrder() {
		...
		Carrier carrier2 = new Carrier(2, new Timestamp(System.currentTimeMillis()), 114, stop, stop2,
				CarrierStatus.SHIPPABLE, 1236, new Die(101l, PartProductionVolume.MEDIUM_VOLUME));
		when(storageState.isCarrierPartsOnBackOrder(carrier2.getDie())).thenReturn(true);
		carrierMessage.setCurrentLocation(stop.getId().toString());
		carrierMessage.setDestination(stop2.getId().toString());
		carrierMessage.setDieNumber("101");
	...
	public void successfullyReceiveCarrierStatusMessageForClearingBackOrderWhenTwoWeldLinesOnBackOrderForSameProduct() {
		...
		Carrier carrier3 = new Carrier(3, new Timestamp(System.currentTimeMillis()), 115, stop, stop2,
				CarrierStatus.SHIPPABLE, 1237, new Die(101l, PartProductionVolume.MEDIUM_VOLUME));
	...
	private void loadTestData2() {
		...
		CarrierMes carrier2 = getCarrierMes(oneDayOld, new Integer(103), stop24, stop24, CarrierStatus.SHIPPABLE,
				new Integer(200), someDie);
		CarrierMes carrier3 = getCarrierMes(oneDayOld, new Integer(103), stop24, stop24, CarrierStatus.SHIPPABLE,
				new Integer(202), leftDie);
		CarrierMes carrier1 = getCarrierMes(twoDaysOld, new Integer(90), stop24, stop24, CarrierStatus.SHIPPABLE,
				new Integer(696), leftDie);
		CarrierMes carrier11 = getCarrierMes(twoDaysOld, new Integer(99), stop25, stop25, CarrierStatus.SHIPPABLE,
				new Integer(130), rightDie);
		CarrierMes carrier12 = getCarrierMes(twoDaysOld, new Integer(90), stop24, stop24, CarrierStatus.SHIPPABLE,
				new Integer(720), leftDie);
		CarrierMes carrier4 = getCarrierMes(oneDayOld, new Integer(100), stop24, stop24, CarrierStatus.SHIPPABLE,
				new Integer(109), leftDie);
		CarrierMes carrier41 = getCarrierMes(oneDayOld, new Integer(100), stop24, stop24, CarrierStatus.SHIPPABLE,
				new Integer(596), leftDie);
		CarrierMes carrier44 = getCarrierMes(oneDayOld, new Integer(100), stop24, stop24, CarrierStatus.SHIPPABLE,
				new Integer(505), leftDie);
		CarrierMes carrier42 = getCarrierMes(twoDaysOld, new Integer(90), stop24, stop24, CarrierStatus.SHIPPABLE,
				new Integer(35), leftDie);
		CarrierMes carrier43 = getCarrierMes(twoDaysOld, new Integer(90), stop24, stop24, CarrierStatus.SHIPPABLE,
				new Integer(425), leftDie);
		CarrierMes carrier5 = getCarrierMes(oneDayOld, new Integer(101), stop25, stop25, CarrierStatus.SHIPPABLE,
				new Integer(131), rightDie);
		CarrierMes carrier51 = getCarrierMes(oneDayOld, new Integer(101), stop25, stop25, CarrierStatus.SHIPPABLE,
				new Integer(203), rightDie);
		CarrierMes carrier52 = getCarrierMes(twoDaysOld, new Integer(99), stop25, stop25, CarrierStatus.SHIPPABLE,
				new Integer(126), rightDie);
		CarrierMes carrier53 = getCarrierMes(twoDaysOld, new Integer(99), stop25, stop25, CarrierStatus.SHIPPABLE,
				new Integer(465), rightDie);
		CarrierMes carrier54 = getCarrierMes(twoDaysOld, new Integer(99), stop25, stop25, CarrierStatus.SHIPPABLE,
