...
/**
 * Created by IntelliJ IDEA. User: Ambica Gawarla Date: 4/11/12 Time: 9:54 AM To
...
public class AlertingServiceImplTest {
	...
	public void successfullySendEmail() {
		...
		AlertingServices alertingService = new AlertingServiceImpl(sender, mailMessage, "test");
