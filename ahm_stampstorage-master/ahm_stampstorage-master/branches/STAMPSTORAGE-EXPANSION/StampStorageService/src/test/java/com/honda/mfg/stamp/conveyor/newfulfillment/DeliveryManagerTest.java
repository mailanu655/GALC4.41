...
/**
 * Created by IntelliJ IDEA. User: Ambica Gawarla Date: 6/14/13 Time: 3:22 PM To
...
public class DeliveryManagerTest extends AbstractTestBase {
	...
	public void successfullyRunDeliveryManager() {
		...
		DeliveryManager manager = new DeliveryManager(orderMgr, helper, releaseManager, "deliveryCarrierReleaseCount",
				"fulfillmentCarrierInspectionStop");

		manager.run();

		assertEquals(OrderStatus.DeliveringCarriers, (WeldOrder.findWeldOrder(weldOrder.getId())).getDeliveryStatus());

		List<OrderFulfillment> fulfillments = OrderFulfillment
				.findAllOrderFulfillmentsByOrderWithCarrierFulfillmentStatus(weldOrder,
		...
		assertEquals(OrderStatus.DeliveringCarriers, (WeldOrder.findWeldOrder(weldOrder.getId())).getDeliveryStatus());
		List<OrderFulfillment> fulfillments1 = OrderFulfillment
				.findAllOrderFulfillmentsByOrderWithCarrierFulfillmentStatus(weldOrder,
						CarrierFulfillmentStatus.READY_TO_DELIVER);
		assertEquals(0, fulfillments1.size());
		List<OrderFulfillment> fulfillments2 = OrderFulfillment
				.findAllOrderFulfillmentsByOrderWithCarrierFulfillmentStatus(weldOrder,
						CarrierFulfillmentStatus.SELECTED_TO_DELIVER);
		...
		assertEquals(OrderStatus.DeliveringCarriers, (WeldOrder.findWeldOrder(weldOrder.getId())).getDeliveryStatus());
		List<OrderFulfillment> fulfillments3 = OrderFulfillment
				.findAllOrderFulfillmentsByOrderWithCarrierFulfillmentStatus(weldOrder,
						CarrierFulfillmentStatus.READY_TO_DELIVER);
		assertEquals(0, fulfillments3.size());
		List<OrderFulfillment> fulfillments4 = OrderFulfillment
				.findAllOrderFulfillmentsByOrderWithCarrierFulfillmentStatus(weldOrder,
						CarrierFulfillmentStatus.SELECTED_TO_DELIVER);
		...
		fulfillments = OrderFulfillment.findAllOrderFulfillmentsByOrderWithCarrierFulfillmentStatus(weldOrder,
				CarrierFulfillmentStatus.SELECTED_TO_DELIVER);
		...
		assertEquals(OrderStatus.DeliveringCarriers, (WeldOrder.findWeldOrder(weldOrder.getId())).getDeliveryStatus());
		fulfillments1 = OrderFulfillment.findAllOrderFulfillmentsByOrderWithCarrierFulfillmentStatus(weldOrder,
				CarrierFulfillmentStatus.READY_TO_DELIVER);
		assertEquals(0, fulfillments1.size());
		fulfillments2 = OrderFulfillment.findAllOrderFulfillmentsByOrderWithCarrierFulfillmentStatus(weldOrder,
				CarrierFulfillmentStatus.SELECTED_TO_DELIVER);
		...
		assertEquals(OrderStatus.DeliveringCarriers, (WeldOrder.findWeldOrder(weldOrder.getId())).getDeliveryStatus());
		fulfillments3 = OrderFulfillment.findAllOrderFulfillmentsByOrderWithCarrierFulfillmentStatus(weldOrder,
				CarrierFulfillmentStatus.READY_TO_DELIVER);
		assertEquals(0, fulfillments3.size());
		fulfillments4 = OrderFulfillment.findAllOrderFulfillmentsByOrderWithCarrierFulfillmentStatus(weldOrder,
				CarrierFulfillmentStatus.SELECTED_TO_DELIVER);
		assertEquals(0, fulfillments4.size());
	...
	public void loadTestData() {
		...
		CarrierMes carrier2 = getCarrierMes(oneDayOld, new Integer(103), stop3, stop3, CarrierStatus.SHIPPABLE,
				new Integer(200), someDie, 0);
		CarrierMes carrier3 = getCarrierMes(oneDayOld, new Integer(103), stop3, stop3, CarrierStatus.SHIPPABLE,
				new Integer(202), someDie, 0);
		CarrierMes carrier1 = getCarrierMes(twoDaysOld, new Integer(90), stop2, stop2, CarrierStatus.SHIPPABLE,
				new Integer(696), leftDie, 1);
		CarrierMes carrier11 = getCarrierMes(oneDayOld, new Integer(99), stop1, stop1, CarrierStatus.SHIPPABLE,
				new Integer(130), rightDie, 1);
		CarrierMes carrier12 = getCarrierMes(oneDayOld, new Integer(90), stop2, stop2, CarrierStatus.SHIPPABLE,
				new Integer(720), leftDie, 1);
		CarrierMes carrier4 = getCarrierMes(oneDayOld, new Integer(100), stop2, stop2, CarrierStatus.SHIPPABLE,
				new Integer(109), leftDie, 1);
		CarrierMes carrier41 = getCarrierMes(oneDayOld, new Integer(100), stop2, stop2, CarrierStatus.SHIPPABLE,
				new Integer(596), leftDie, 1);
		CarrierMes carrier5 = getCarrierMes(oneDayOld, new Integer(101), stop1, stop1, CarrierStatus.SHIPPABLE,
				new Integer(131), rightDie, 1);
		CarrierMes carrier51 = getCarrierMes(oneDayOld, new Integer(101), stop1, stop1, CarrierStatus.SHIPPABLE,
				new Integer(203), rightDie, 1);
		CarrierMes carrier52 = getCarrierMes(oneDayOld, new Integer(99), stop1, stop1, CarrierStatus.SHIPPABLE,
				new Integer(126), rightDie, 1);
		CarrierMes carrier53 = getCarrierMes(oneDayOld, new Integer(99), stop1, stop1, CarrierStatus.SHIPPABLE,
				new Integer(120), rightDie, 1);
		CarrierMes carrier54 = getCarrierMes(oneDayOld, new Integer(99), stop2, stop2, CarrierStatus.SHIPPABLE,
				new Integer(121), leftDie, 1);
	...
	private CarrierMes getCarrierMes(Timestamp oneDayOld, Integer productionRunNumber, Stop stop3, Stop stop31,
			CarrierStatus status, Integer carrierNumber, Die die, Integer buffer) {
	...
	void loadOrderFulfillmentTable() {
		...
		List<WeldOrder> weldOrders = WeldOrder.findWeldOrdersByDeliveryStatusAndOrderStatus(
				OrderStatus.ManuallyCompleted, OrderStatus.ManuallyCompleted);
	...
	public void loadTestDataForNoSpaceAvailable() {
		...
		CarrierMes carrier2 = getCarrierMes(oneDayOld, new Integer(103), stop11, stop11, CarrierStatus.SHIPPABLE,
				new Integer(200), someDie, 0);
		CarrierMes carrier3 = getCarrierMes(oneDayOld, new Integer(103), stop11, stop11, CarrierStatus.SHIPPABLE,
				new Integer(202), someDie, 0);
		CarrierMes carrier1 = getCarrierMes(twoDaysOld, new Integer(90), stop2, stop2, CarrierStatus.SHIPPABLE,
				new Integer(696), leftDie, 1);
		CarrierMes carrier11 = getCarrierMes(oneDayOld, new Integer(99), stop1, stop1, CarrierStatus.SHIPPABLE,
	...
	public void loadTestDataNotCorrectDieAtHead() {
		...
		CarrierMes carrier2 = getCarrierMes(oneDayOld, new Integer(103), stop1, stop1, CarrierStatus.SHIPPABLE,
				new Integer(200), someDie, 1);
		CarrierMes carrier3 = getCarrierMes(oneDayOld, new Integer(103), stop2, stop2, CarrierStatus.SHIPPABLE,
				new Integer(202), someDie, 1);
		CarrierMes carrier1 = getCarrierMes(twoDaysOld, new Integer(90), stop2, stop2, CarrierStatus.SHIPPABLE,
				new Integer(696), leftDie, 0);
		CarrierMes carrier11 = getCarrierMes(oneDayOld, new Integer(99), stop1, stop1, CarrierStatus.SHIPPABLE,
				new Integer(130), rightDie, 0);
		CarrierMes carrier12 = getCarrierMes(oneDayOld, new Integer(90), stop2, stop2, CarrierStatus.SHIPPABLE,
				new Integer(720), leftDie, 0);
		CarrierMes carrier4 = getCarrierMes(oneDayOld, new Integer(100), stop2, stop2, CarrierStatus.SHIPPABLE,
				new Integer(109), leftDie, 0);
		CarrierMes carrier41 = getCarrierMes(oneDayOld, new Integer(100), stop2, stop2, CarrierStatus.SHIPPABLE,
				new Integer(596), leftDie, 0);
		CarrierMes carrier5 = getCarrierMes(oneDayOld, new Integer(101), stop1, stop1, CarrierStatus.SHIPPABLE,
				new Integer(131), rightDie, 0);
		CarrierMes carrier51 = getCarrierMes(oneDayOld, new Integer(101), stop1, stop1, CarrierStatus.SHIPPABLE,
				new Integer(203), rightDie, 0);
		CarrierMes carrier52 = getCarrierMes(oneDayOld, new Integer(99), stop1, stop1, CarrierStatus.SHIPPABLE,
				new Integer(126), rightDie, 0);
	...
	public void loadTestDataWithIncorrectDieInMiddle() {
		...
		// CarrierMes carrier2 = getCarrierMes(oneDayOld, new Integer(103), stop1,
		// stop1, CarrierStatus.SHIPPABLE, new Integer(200), someDie, 0);
		CarrierMes carrier3 = getCarrierMes(oneDayOld, new Integer(103), stop2, stop2, CarrierStatus.SHIPPABLE,
				new Integer(202), someDie, 0);
		CarrierMes carrier1 = getCarrierMes(twoDaysOld, new Integer(90), stop2, stop2, CarrierStatus.SHIPPABLE,
				new Integer(696), leftDie, 1);
		// CarrierMes carrier11 = getCarrierMes(oneDayOld, new Integer(99), stop1,
		// stop1, CarrierStatus.SHIPPABLE, new Integer(130), rightDie, 0);
		CarrierMes carrier12 = getCarrierMes(oneDayOld, new Integer(90), stop2, stop2, CarrierStatus.SHIPPABLE,
				new Integer(720), leftDie, 0);
		CarrierMes carrier4 = getCarrierMes(oneDayOld, new Integer(100), stop2, stop2, CarrierStatus.SHIPPABLE,
				new Integer(109), leftDie, 0);

		// CarrierMes carrier5 = getCarrierMes(oneDayOld, new Integer(101), stop1,
		// stop1, CarrierStatus.SHIPPABLE, new Integer(131), rightDie, 0);
		// CarrierMes carrier51 = getCarrierMes(oneDayOld, new Integer(101), stop1,
		// stop1, CarrierStatus.SHIPPABLE, new Integer(203), rightDie, 0);
	...
	public void loadTestDataWhenNotEnoughRightCarriersToDeliver() {
		...
		CarrierMes carrier12 = getCarrierMes(oneDayOld, new Integer(90), stop2, stop2, CarrierStatus.SHIPPABLE,
				new Integer(720), leftDie, 1);
		CarrierMes carrier13 = getCarrierMes(oneDayOld, new Integer(90), stop2, stop2, CarrierStatus.SHIPPABLE,
				new Integer(820), leftDie, 1);
		CarrierMes carrier14 = getCarrierMes(oneDayOld, new Integer(90), stop2, stop2, CarrierStatus.SHIPPABLE,
				new Integer(920), leftDie, 1);
	...
	public void loadTestDataWhenNotEnoughLeftCarriersToDeliver() {
		...
		CarrierMes carrier11 = getCarrierMes(oneDayOld, new Integer(99), stop1, stop1, CarrierStatus.SHIPPABLE,
				new Integer(130), rightDie, 1);
		CarrierMes carrier12 = getCarrierMes(oneDayOld, new Integer(90), stop1, stop1, CarrierStatus.SHIPPABLE,
				new Integer(720), rightDie, 1);
		CarrierMes carrier13 = getCarrierMes(oneDayOld, new Integer(90), stop1, stop1, CarrierStatus.SHIPPABLE,
				new Integer(820), rightDie, 1);
		CarrierMes carrier14 = getCarrierMes(oneDayOld, new Integer(90), stop1, stop1, CarrierStatus.SHIPPABLE,
				new Integer(920), rightDie, 1);
	...
	public void loadTestDataWhenLessThanDeliverySizeOfCarriersRequiredByOrderToComplete() {
		...
		CarrierMes carrier12 = getCarrierMes(oneDayOld, new Integer(90), stop2, stop2, CarrierStatus.SHIPPABLE,
				new Integer(720), leftDie, 1);
		CarrierMes carrier22 = getCarrierMes(oneDayOld, new Integer(90), stop2, stop2, CarrierStatus.SHIPPABLE,
				new Integer(820), someDie, 0);
		CarrierMes carrier32 = getCarrierMes(oneDayOld, new Integer(90), stop2, stop2, CarrierStatus.SHIPPABLE,
				new Integer(920), someDie, 0);
		CarrierMes carrier42 = getCarrierMes(oneDayOld, new Integer(90), stop1, stop1, CarrierStatus.SHIPPABLE,
				new Integer(620), someDie, 0);
		CarrierMes carrier52 = getCarrierMes(oneDayOld, new Integer(90), stop1, stop1, CarrierStatus.SHIPPABLE,
				new Integer(520), someDie, 0);
		CarrierMes carrier62 = getCarrierMes(oneDayOld, new Integer(90), stop1, stop1, CarrierStatus.SHIPPABLE,
				new Integer(420), someDie, 0);
