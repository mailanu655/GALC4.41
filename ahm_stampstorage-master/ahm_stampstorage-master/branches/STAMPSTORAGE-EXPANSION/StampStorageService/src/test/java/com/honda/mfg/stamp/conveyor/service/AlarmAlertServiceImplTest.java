...
public class AlarmAlertServiceImplTest {
	...
	public void successfullySendAlerts() {
		...
		when(helper.getAlarmsToNotify()).thenReturn(alarmEvents).thenReturn(new ArrayList<AlarmEvent>())
				.thenThrow(new RuntimeException());
		when(helper.getAlarmsToNotifyPlc()).thenReturn(alarmEvents).thenReturn(new ArrayList<AlarmEvent>())
				.thenThrow(new RuntimeException());
