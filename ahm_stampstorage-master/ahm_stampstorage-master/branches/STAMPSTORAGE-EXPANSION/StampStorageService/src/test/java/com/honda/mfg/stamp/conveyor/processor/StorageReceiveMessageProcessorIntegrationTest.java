...
/**
 * Created by IntelliJ IDEA. User: Ambica Gawarla Date: 2/27/12 Time: 4:38 PM To
...
public class StorageReceiveMessageProcessorIntegrationTest extends AbstractTestBase {
	...
	public void successfullyReceiveCarrierStatusMessageAndDeleteDefects() {
		...
		Carrier carrier4 = new Carrier(3, new Timestamp(System.currentTimeMillis()), Integer.valueOf(111), stop4, stop4,
				CarrierStatus.ON_HOLD, Integer.valueOf(101), new Die());
