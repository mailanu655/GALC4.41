 ...
 */
public class OrderEmptyCarriersToBAreaEmptyStorageServiceImpl extends OrderEmptyCarrierAbstractServiceImpl
		implements Runnable {
	...
	public OrderEmptyCarriersToBAreaEmptyStorageServiceImpl(EmptyCarriersServiceHelper orderEmptyCarriersServiceHelper,
			Storage storage, ReleaseManager releaseManager, String bAreaEmptyUnderFilledQuantity, String carrierCount) {

		super(orderEmptyCarriersServiceHelper, storage, releaseManager,
				orderEmptyCarriersServiceHelper.getBAreaEmptyCarrierDeliveryStop(), bAreaEmptyUnderFilledQuantity,
				carrierCount);
	...
	public void run() {
		...
		try {
			...
			if (deliveryStop == null) {
				...
				if (isAreaUnderFilled(carrierAtBAreaDestCount) && !orderEmptyCarriersServiceHelper.anyOrderInProcess()
