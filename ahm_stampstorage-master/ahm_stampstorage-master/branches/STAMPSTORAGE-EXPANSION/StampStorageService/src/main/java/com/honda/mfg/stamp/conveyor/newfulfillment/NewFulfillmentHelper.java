...
/**
 * Created by IntelliJ IDEA. User: vcc30690 Date: 11/21/11 Time: 2:50 PM To
...
public interface NewFulfillmentHelper extends Helper {
	...
	void deleteAllOrderFulfillmentsByOrderWithCarrierFulfillmentStatus(WeldOrder order,
	...
	List<OrderFulfillment> getAllOrderFulfillmentsByOrderAndCarrierFulfillmentStatus(WeldOrder order,
			CarrierFulfillmentStatus carrierFulfillmentStatus);

	List<OrderFulfillment> getAllOrderFulfillmentsByCarrierFulfillmentStatusAndDie(WeldOrder order,
	...
	void updateOrderFulfillmentStatus(OrderFulfillment orderFulfillment,
