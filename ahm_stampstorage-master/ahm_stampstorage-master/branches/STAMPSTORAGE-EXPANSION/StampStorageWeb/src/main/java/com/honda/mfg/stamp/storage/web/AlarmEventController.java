...
public class AlarmEventController {
	...
	public String create(@Valid AlarmEvent alarmEvent, BindingResult bindingResult, Model uiModel,
	...
	public String list(@RequestParam(value = "page", required = false) Integer page,
		...
		if (page != null && size != null) {
			...
			List<AlarmEvent> current_Alarms = AlarmEvent
					.findCurrent_AlarmEntries(page == null ? 0 : (page.intValue() - 1) * sizeNo, sizeNo);
	...
	public String update(AlarmEvent alarmEvent, BindingResult bindingResult, Model uiModel,
