...
public class OrderFulfillmentController {
	...
	public String create(@Valid OrderFulfillment orderFulfillment, BindingResult bindingResult, Model uiModel,
		...
		return "redirect:/orderfulfillments/" + encodeUrlPathSegment(
				conversionService.convert(orderFulfillment.getId(), String.class), httpServletRequest);
	}
	...
	public String list(@RequestParam(value = "page", required = false) Integer page,
		...
		if (page != null || size != null) {
			...
			uiModel.addAttribute("orderfulfillments", OrderFulfillment
					.findOrderFulfillmentEntries(page == null ? 0 : (page.intValue() - 1) * sizeNo, sizeNo));
	...
	public String update(@Valid OrderFulfillment orderFulfillment, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) throws UnsupportedEncodingException {
		if (bindingResult.hasErrors()) {
			uiModel.addAttribute("orderFulfillment", orderFulfillment);
	...
	public String delete(@PathVariable("id") OrderFulfillmentPk id,
