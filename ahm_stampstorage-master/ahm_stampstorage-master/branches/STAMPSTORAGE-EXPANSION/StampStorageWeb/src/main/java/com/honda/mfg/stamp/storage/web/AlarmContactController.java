...
public class AlarmContactController {
	...
	public String create(@Valid AlarmContact alarmContact, BindingResult bindingResult, Model uiModel,
...
//        }
	...
	public String list(@RequestParam(value = "page", required = false) Integer page,
		...
		if (page != null || size != null) {
			...
			uiModel.addAttribute("alarmcontacts",
					AlarmContact.findAlarmContactEntries(page == null ? 0 : (page.intValue() - 1) * sizeNo, sizeNo));
	...
	public String update(@Valid AlarmContact alarmContact, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) throws UnsupportedEncodingException {
		if (bindingResult.hasErrors()) {
			uiModel.addAttribute("alarmContact", alarmContact);
