...
/**
 * User: Jeffrey M Lutz Date: 7/8/11
 */
public class StorageStateController {
	 ...
	 * //2013-02-01:VB:StorageStateController is not being used, stale data was
	 * published directly in Lane Controller //return
	 * carrierManagementService.getStorageState(); }
	 * 
	 * public static void refreshStorageState() {
	 * //2013-02-01:VB:StorageStateController is not being used, stale data was
	 * published directly in Lane Controller //EventBus.publish(new
	 * StaleDataMessage(false)); }
	 */
}
