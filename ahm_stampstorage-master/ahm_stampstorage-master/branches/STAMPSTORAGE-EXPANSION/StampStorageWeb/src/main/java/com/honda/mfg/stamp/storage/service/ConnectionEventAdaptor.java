 ...
 * <p/>
 * The ConnectionEventAdaptor purpose is to detect MES device initialize and
 * uninitialize events and publishes the ConnectionEventMessage. The
 * ConnectionEventMessage is used by the CarrierMes_Roo_Entity.aj (aspect) to
 * detect when CarrierMes data in DB2 is to be considered stale or fresh. To
 * properly use this adaptor, simply construct (default constructor) a single
 * instance
 */
