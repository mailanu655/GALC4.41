...
public class CarrierReleaseController {
	...
	public String create(@Valid CarrierRelease carrierRelease, BindingResult bindingResult, Model uiModel,
		...
		return "redirect:/carrierreleases/"
				+ encodeUrlPathSegment(carrierRelease.getId().toString(), httpServletRequest);
	}
	...
	public String list(@RequestParam(value = "page", required = false) Integer page,
		...
		if (page != null || size != null) {
			...
			uiModel.addAttribute("carrierreleases", CarrierRelease
					.findCarrierReleaseEntries(page == null ? 0 : (page.intValue() - 1) * sizeNo, sizeNo));
	...
	public String update(@Valid CarrierRelease carrierRelease, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) throws UnsupportedEncodingException {
		if (bindingResult.hasErrors()) {
			uiModel.addAttribute("carrierRelease", carrierRelease);
