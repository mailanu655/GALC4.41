...
public class ModelController {
	...
	public String create(@Valid Model model, BindingResult bindingResult, org.springframework.ui.Model uiModel,
	...
	public String list(@RequestParam(value = "page", required = false) Integer page,
		...
		if (page != null || size != null) {
			...
			uiModel.addAttribute("models",
					Model.findModelEntries(page == null ? 0 : (page.intValue() - 1) * sizeNo, sizeNo));
	...
	public String update(@Valid Model model, BindingResult bindingResult, org.springframework.ui.Model uiModel,
			HttpServletRequest httpServletRequest) throws UnsupportedEncodingException {
		if (bindingResult.hasErrors()) {
			uiModel.addAttribute("model", model);
