...
public class DieController {
	...
	public String create(@Valid Die die, BindingResult bindingResult, Model uiModel,
	...
	public String update(@Valid Die die, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) throws UnsupportedEncodingException {
		if (bindingResult.hasErrors()) {
			uiModel.addAttribute("die", die);
			return "dies/update";
