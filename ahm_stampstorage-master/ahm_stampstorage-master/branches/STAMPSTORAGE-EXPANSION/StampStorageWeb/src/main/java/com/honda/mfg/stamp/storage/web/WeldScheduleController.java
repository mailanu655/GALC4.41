...
public class WeldScheduleController {
	...
	public String create(@Valid WeldSchedule weldSchedule, BindingResult bindingResult, Model uiModel,
	...
	public String list(@RequestParam(value = "page", required = false) Integer page,
		...
		if (page != null || size != null) {
			...
			uiModel.addAttribute("weldschedules",
					WeldSchedule.findWeldScheduleEntries(page == null ? 0 : (page.intValue() - 1) * sizeNo, sizeNo));
	...
	public String update(@Valid WeldSchedule weldSchedule, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) throws UnsupportedEncodingException {
		if (bindingResult.hasErrors()) {
			uiModel.addAttribute("weldSchedule", weldSchedule);
