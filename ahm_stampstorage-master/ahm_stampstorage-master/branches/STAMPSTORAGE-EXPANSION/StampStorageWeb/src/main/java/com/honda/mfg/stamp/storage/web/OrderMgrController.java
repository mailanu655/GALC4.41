...
public class OrderMgrController {
	...
	public String create(@Valid OrderMgr orderMgr, BindingResult bindingResult, Model uiModel,
	...
	public String list(@RequestParam(value = "page", required = false) Integer page,
		...
		if (page != null || size != null) {
			...
			uiModel.addAttribute("ordermgrs",
					OrderMgr.findOrderMgrEntries(page == null ? 0 : (page.intValue() - 1) * sizeNo, sizeNo));
	...
	public String update(@Valid OrderMgr orderMgr, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) throws UnsupportedEncodingException {
		if (bindingResult.hasErrors()) {
			uiModel.addAttribute("orderMgr", orderMgr);
