...
public class ParmSettingController {
	...
	public String create(ParmSetting parmSetting, BindingResult bindingResult, Model uiModel,
		...
		parmSetting.setUpdatedby(principal);
	...
	public String list(@RequestParam(value = "page", required = false) Integer page,
		...
		if (page != null || size != null) {
			...
			uiModel.addAttribute("parmsettings",
					ParmSetting.findParmSettingEntries(page == null ? 0 : (page.intValue() - 1) * sizeNo, sizeNo));
	...
	public String update(ParmSetting parmSetting, BindingResult bindingResult, Model uiModel,
			HttpServletRequest httpServletRequest) throws UnsupportedEncodingException {
