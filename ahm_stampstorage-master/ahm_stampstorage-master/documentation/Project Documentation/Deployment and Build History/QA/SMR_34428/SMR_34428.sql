...
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE "STAMPSTOR"."WELD_ORDER_ARCHIVE_TBX" TO GROUP "OHCVA_DA";
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE "STAMPSTOR"."ORDER_FULFILLMENT_ARCHIVE_TBX" TO GROUP "OHCVA_DA";
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE "STAMPSTOR"."PRESS_ACTIVITY_TBX" TO GROUP "OHCVA_DA";

GRANT SELECT ON TABLE "STAMPSTOR"."WELD_ORDER_ARCHIVE_TBX" TO GROUP "OHCVA_DS";
GRANT SELECT ON TABLE "STAMPSTOR"."ORDER_FULFILLMENT_ARCHIVE_TBX" TO GROUP "OHCVA_DS";
GRANT SELECT ON TABLE "STAMPSTOR"."PRESS_ACTIVITY_TBX" TO GROUP "OHCVA_DS";
