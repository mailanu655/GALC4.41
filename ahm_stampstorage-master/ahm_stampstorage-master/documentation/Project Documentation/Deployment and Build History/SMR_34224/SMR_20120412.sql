...
GRANT CONTROL ON TABLE "STAMPSTOR"."ALARM_CONTACT_TBX" TO USER "OHCVADEV";
...
GRANT SELECT, INSERT, UPDATE, ALTER, DELETE,
    INDEX, REFERENCES ON TABLE "STAMPSTOR"."ALARM_CONTACT_TBX" TO USER "OHCVADEV" WITH GRANT OPTION;
