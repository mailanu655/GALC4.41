...
GRANT CONTROL ON TABLE "STAMPSTOR"."ALARM_EVENT_ARCHIVE_TBX" TO USER "OHCVAPRD";
...
GRANT SELECT, INSERT, UPDATE, ALTER, DELETE,
    INDEX, REFERENCES ON TABLE "STAMPSTOR"."ALARM_EVENT_ARCHIVE_TBX" TO USER "OHCVAPRD" WITH GRANT OPTION;
...
UPDATE "STAMPSTOR"."ALARMS_DEFINITION_TBX" SET VERSION = 0, ACTIVE = 0, AUTO_ARCHIVE_TIME = 2880.0, NOTIFICATION_REQUIRED = 0;
UPDATE "STAMPSTOR"."ALARM_EVENT_TBX" SET VERSTION = 0;