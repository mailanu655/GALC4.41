...
public class Utils {
	...
	public static final String LOG_FILES_DIR = "c:/logs" + File.separator;
	public static final String METRICS_FILES_DIR = "c:/logs" + File.separator + "metrics" + File.separator;
