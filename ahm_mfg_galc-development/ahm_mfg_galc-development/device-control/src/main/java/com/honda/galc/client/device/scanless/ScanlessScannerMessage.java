...
public class ScanlessScannerMessage extends InputData implements Serializable {
	...
	public String toString() {
		return "ScanlessScannerMessage [clientId=" + clientId + ", processPointId=" + processPointId + ", toolProductId="
				+ toolProductId + ", toolEventType=" + toolEventType + ", toolId=" + toolId + "]";
	}
	
	public ScanlessScannerMessage clone()  {
		ScanlessScannerMessage clone = new ScanlessScannerMessage();
