...
<LINK href="../admin/theme/Master.css" rel="stylesheet"
	type="text/css">
...
function createGroup() {
   newurl = "<%=request.getContextPath() %>/securityGroupSettings.do?existingGroup=false";
...
<h1 class="settingsheader" style="<%=showWarningColor%>">Security Groups Settings</h1>
<table width="100%" height="100%">
<tbody>
<tr id="trouter">
<td>
<html:form target="findResults" action="/securityGroupsSearch" scope="request" 
	name="securityGroupSearchForm" style="height: 500;"
	type="com.honda.galc.system.config.web.forms.SecurityGroupSearchForm">
