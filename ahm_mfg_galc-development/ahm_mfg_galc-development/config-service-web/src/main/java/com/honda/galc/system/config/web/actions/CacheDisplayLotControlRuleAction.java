 ...
 *
 */
public class CacheDisplayLotControlRuleAction extends ConfigurationAction
...

{
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            String processPoint = request.getParameter("ITEM");
            
            Map<String,List<LotControlRule>> rules = ServerInfoUtil.getLotControlFromActiveServerCache(processPoint);
        	
            request.setAttribute("LOT_CONTROL_RULE", rules);
