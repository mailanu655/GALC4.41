...
public class AvailableProcessPointListForm extends ActionForm {
    
	private static final long serialVersionUID = 6017006862820109158L;

	private List<ProcessPoint> processPointList = null;
