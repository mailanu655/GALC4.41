...
import com.honda.galc.system.config.web.forms.AvailableProcessPointListForm;

/**
 * <h3>Class description</h3>
 * Action for available process point list
 * <h4>Description</h4>
 * <p>
 * </p>
 * <h4>Special Notes</h4>
...
public class AvailableProcessPointListAction extends ConfigurationAction {

    private static final String ERRORS_GROUP = "processPointListErrors";
    
    public AvailableProcessPointListAction() {
        super();
    }
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        AvailableProcessPointListForm ppForm = (AvailableProcessPointListForm) form;
        ...
        try {
            ...
            if(regionalGroup == null) {
        		ppForm.setProcessPointList(getDao(ProcessPointDao.class).findAll());
        	} else {
           		ppForm.setProcessPointList(getDao(ProcessPointDao.class).findAllByMatchingTextAndNotInGroup(searchText, regionalGroup));
        	}
