 ...
 *
 */
public class StringItem extends TextItem implements Verifiable {
	 ...
	 */
	public StringItem(String name, String title, String hint) {
	 ...
	 * @param title the title, displayed on the form.
	 */
	public StringItem(String name, String title) {
		super(name, title);
		init();
	}
