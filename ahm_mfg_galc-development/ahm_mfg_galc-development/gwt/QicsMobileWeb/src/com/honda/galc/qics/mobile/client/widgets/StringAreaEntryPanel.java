...
public class StringAreaEntryPanel extends Panel {
	
	MessageList messageList;
	MessageListPanel messageListPanel;
	StringAreaItem stringItem;
	DoneCallback<String> callback;
	
	FormItem[] formItemArray;
	private Button submitButton;
	
	public StringAreaEntryPanel( String title, MessageList messageList, StringAreaItem stringItem, DoneCallback<String> callback ) {
		this( title, messageList, stringItem, callback, null );
	}

	public StringAreaEntryPanel( String title, MessageList messageList, StringAreaItem stringItem, DoneCallback<String> callback, Keyboard keyboard ) {
		super( title );
		Log.info("inside");
