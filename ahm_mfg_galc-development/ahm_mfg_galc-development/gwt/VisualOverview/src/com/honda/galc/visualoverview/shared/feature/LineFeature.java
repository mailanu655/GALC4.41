...
public class LineFeature extends Feature {
	...
	public void draw(
		...
		LineString lineString = new LineString(points);//we need a LineString object because this has the rotate method
        vectorFeature = new VectorFeature(lineString,style);
        Attributes attributes = new Attributes();
        attributes.setAttribute("FEATURE_TYPE", "LINE");
