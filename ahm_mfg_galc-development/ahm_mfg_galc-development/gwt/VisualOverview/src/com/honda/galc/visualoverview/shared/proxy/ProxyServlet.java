package com.honda.galc.visualoverview.shared.proxy;
...
public class ProxyServlet extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8387113675123110810L;
	private static final String targetServer = "http://10.203.33.248:9080/RestWeb/";
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		uri.append(req.getRequestURI().substring(7));
