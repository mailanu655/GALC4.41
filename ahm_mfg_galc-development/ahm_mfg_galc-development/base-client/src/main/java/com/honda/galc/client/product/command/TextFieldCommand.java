...
public class TextFieldCommand {
	...
	public void execute() {
		if (getTextField() == null || getCommands() == null || getCommands().isEmpty()) {
			return;
		}
	...
	public static TextFieldCommand create(ProcessControllerAdapter<?> controller, JTextField textField, List<Command> commands, String propertyName) {
	...
	// === get/set === //
	public ProcessControllerAdapter<?> getController() {
		return controller;
	}

	public void setController(ProcessControllerAdapter<?> controller) {
