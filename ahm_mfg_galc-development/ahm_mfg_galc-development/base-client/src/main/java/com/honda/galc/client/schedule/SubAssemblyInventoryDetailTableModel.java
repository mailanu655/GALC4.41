 ...
 * @date Nov 22, 2013
 */
public class SubAssemblyInventoryDetailTableModel extends SortableTableModel<MbpnProduct> {

	private static final long serialVersionUID = 1L;
	public String message = null;
	public MbpnProduct _item = null;
	final static String[] columnNames = {"Cell/Zone", "Product", "Product Spec Code", "SN"};
	
	
	public SubAssemblyInventoryDetailTableModel(List<MbpnProduct> items, JTable table) {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch(columnIndex) {
            ...
            case 2: return item.getCurrentProductSpecCode();
            case 3: return item.getSn();
