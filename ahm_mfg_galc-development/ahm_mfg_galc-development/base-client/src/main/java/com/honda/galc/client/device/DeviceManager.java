...
public class DeviceManager {
	 ...
	 * @return
	 */
	public synchronized Integer requestExclusiveAccess(String deviceId, IDeviceUser app, boolean modalClient) throws DeviceInUseException
	{
		if (getExclusiveLocks().containsKey(deviceId))
		{	
			...
			// check if locked by this application
			// for modal client, request access to the same device as original client
			if (modalClient || holder.getKey() == app.getDeviceAccessKey(deviceId).intValue())
	...
	private void createPlcDevices(String terminalName,
			List<ComponentProperty> plcProperties) {
	...
	public IDevice createDevice(String terminalName,
	...
	public DevicePropertyBean getDevicePropertyBean(String terminalName,
