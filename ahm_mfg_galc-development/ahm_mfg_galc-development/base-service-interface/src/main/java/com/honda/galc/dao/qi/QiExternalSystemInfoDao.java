...
/**
 * 
 * <h3>QiExternalSystemInfoDao Class description</h3>
 * <p> QiExternalSystemInfoDao used to fire queries to load, reprocess or delete data </p>
 * 
 ...
 * 2019-10-23
 */
public interface QiExternalSystemInfoDao extends IDaoService<QiExternalSystemInfo, Short> {
	
	public QiExternalSystemInfo findByExternalSystemName(String extSysName);

	QiExternalSystemInfo findByExternalSystemId(Short extSysId);
