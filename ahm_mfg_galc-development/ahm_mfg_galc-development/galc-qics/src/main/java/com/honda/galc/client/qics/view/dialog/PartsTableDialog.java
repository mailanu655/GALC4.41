 ...
 * <h4> Description </h4>
 * <p>
 * Dialog with the table of parts names.
 * </p>
...
public class PartsTableDialog extends JDialog {
...
//			tablePane.getTable().setColumnSize(new int[] { firstColumnWidth, getWidth() - firstColumnWidth });
