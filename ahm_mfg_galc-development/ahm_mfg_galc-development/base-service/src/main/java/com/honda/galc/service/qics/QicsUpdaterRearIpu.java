 ...
 * <p>
 * <code>QicsUpdaterRearIpu</code> is ... .
 * </p>
...
public class QicsUpdaterRearIpu extends QicsUpdaterDiecast<RearIpuCase>{

	@Autowired
	RearIpuCaseDao dao;
	
	@Override
	protected RearIpuCase findProductById(String productId) {
