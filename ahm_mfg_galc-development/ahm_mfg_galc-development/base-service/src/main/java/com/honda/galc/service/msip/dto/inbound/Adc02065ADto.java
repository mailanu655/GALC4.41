 ...
 * @date May, 2017
 */
public class Adc02065ADto implements IAdcDto {
	...
	public String getParkControlNo() {
		return parkControlNo;
	}

	public void setParkControlNo(String parkControlNo) {
		this.parkControlNo = parkControlNo;
	}

	public ParkChange deriveParkChange(){
		ParkChange parkChange = new ParkChange();
		parkChange.setDate(messageDate);
		parkChange.setParkControlNumber(parkControlNo);
		parkChange.setParkingLocation(parkLocation);
		parkChange.setSendLocation(sendLocation);
		parkChange.setTime(messageTime);
		parkChange.setTransactiontype(tranType);
		parkChange.setVin(vin);
		return parkChange;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((parkLocation == null) ? 0 : parkLocation.hashCode());
		result = prime * result + ((parkControlNo == null) ? 0 : parkControlNo.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Adc02065ADto other = (Adc02065ADto) obj;
		if (messageDate == null) {
		...
		if (parkLocation == null) {
			if (other.parkLocation != null)
				return false;
		} else if (!parkLocation.equals(other.parkLocation))
			return false;
		if (parkControlNo == null) {
			if (other.parkControlNo != null)
				return false;
		} else if (!parkControlNo.equals(other.parkControlNo))
			return false;
		return true;
	}
