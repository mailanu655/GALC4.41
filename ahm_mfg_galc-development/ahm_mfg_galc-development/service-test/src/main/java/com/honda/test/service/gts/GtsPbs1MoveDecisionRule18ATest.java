...
public class GtsPbs1MoveDecisionRule18ATest extends GtsPbs1MoveDecisionRuleBastTest{
	...
	public void test01AddCarriers() {
		...
		issueIndicatorChange("CP-tX", 1);
		
		issueIndicatorChange("CB-B5P9A", 1);
		issueIndicatorChange("CS-I1", 1);
		issueIndicatorChange("CS-R3", 0);
	}
	
	@Test
	public void test02Move_tX_tF() {
		
		// The default move is from tX to tF (short track). Only if this move
        // is not possible will a carrier be moved to wQ (long track)
        
		// Lane-tX ---- ---- ---- ---- ---- ---- ---- 1002 +> EXIT-tX on
		// Lane-tF ----                                    <+ ENTRY-tF on
		// Lane-wQ ---- ---- ---- ---- ---- ---- ---- ---- <+ ENTRY-wQ on
		...
		addLaneCarrier("tX","1002",1);
		
		toggleGate(true,"EXIT-tX","ENTRY-tF","ENTRY-wQ"); // on
		
		issueIndicatorChange("CS-R3", 1);

		TestUtils.sleep(200);
		
		assertMove("tX", "tF", GtsMoveStatus.CREATED);
		resetMoveRequest("tX", "tF");
	...
	@Test
	public void test03Move_tX_wQ() {
		
		// The default move is from tX to tF (short track). Only if this move
        // is not possible will a carrier be moved to wQ (long track)
        
		// Lane-tX ---- ---- ---- ---- ---- ---- ---- 1002 +> EXIT-tX on
		// Lane-tF ----                                    <- ENTRY-tF off
		// Lane-wQ ---- ---- ---- ---- ---- ---- ---- ---- <+ ENTRY-wQ on
		...
		toggleGate(false,"ENTRY-tF"); //off
		
		issueIndicatorChange("CS-R3", 1);

		TestUtils.sleep(200);
		
		assertMove("tX", "wQ", GtsMoveStatus.CREATED);
		resetMoveRequest("tX", "wQ");
