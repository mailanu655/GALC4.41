function lineoverview(){
  ...
  $stats && $stats({moduleName:'lineoverview', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'begin'});
  ...
  function maybeStartModule(){
    if (scriptsDone && loadDone) {
      var iframe = $doc_0.getElementById('lineoverview');
      ...
      lineoverview = null;
      frameWnd.gwtOnLoad(onLoadErrorFunc, 'lineoverview', base, softPermutationId);
      $stats && $stats({moduleName:'lineoverview', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'moduleStartup', millis:(new Date).getTime(), type:'end'});
    }
  }
  ...
  function computeScriptBase(){
    ...
    function tryNocacheJsTag(){
      ...
      for (var i = 0; i < scriptTags.length; ++i) {
        if (scriptTags[i].src.indexOf('lineoverview.nocache.js') != -1) {
    ...
    function tryMarkerScript(){
      ...
      if (typeof isBodyLoaded == 'undefined' || !isBodyLoaded()) {
        var markerId = '__gwt_marker_lineoverview';
        var markerScript;
  ...
  function processMetas(){
    ...
    for (var i = 0, n = metas.length; i < n; ++i) {
      ...
      if (name_0) {
        name_0 = name_0.replace('lineoverview::', '');
        if (name_0.indexOf('::') >= 0) {
          continue;
        }
  ...
  function maybeInjectFrame(){
    if (!frameInjected) {
      ...
      iframe.id = 'lineoverview';
      iframe.style.cssText = 'position:absolute;width:0;height:0;border:none';
      iframe.tabIndex = -1;
      $doc_0.body.appendChild(iframe);
      $stats && $stats({moduleName:'lineoverview', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'moduleStartup', millis:(new Date).getTime(), type:'moduleRequested'});
  ...
  lineoverview.onScriptLoad = function(){
    if (frameInjected) {
      loadDone = true;
      maybeStartModule();
    }
  ...
  ;
  lineoverview.onInjectionDone = function(){
    scriptsDone = true;
    $stats && $stats({moduleName:'lineoverview', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'loadExternalRefs', millis:(new Date).getTime(), type:'end'});
    maybeStartModule();
  }
  ;
  processMetas();
  ...
  var initialHtml;
  if (isHostedMode()) {
    if ($wnd_0.external && ($wnd_0.external.initModule && $wnd_0.external.initModule('lineoverview'))) {
      $wnd_0.location.reload();
      return;
    }
    initialHtml = 'hosted.html?lineoverview';
    strongName = '';
  }
  $stats && $stats({moduleName:'lineoverview', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'selectingPermutation'});
  if (!isHostedMode()) {
    try {
      unflattenKeylistIntoAnswers(['ie8'], '2ECE511B76F9C557EBEAB2406C101AF3');
      unflattenKeylistIntoAnswers(['ie9'], '59954134EE4D49CC76E95C87D462C37D');
      unflattenKeylistIntoAnswers(['ie6'], '6F65EBEB24C0B10E0E233F80A856AE04');
      unflattenKeylistIntoAnswers(['safari'], '8378A2D72DA67AF44FDDFA62B523E740');
      unflattenKeylistIntoAnswers(['opera'], 'D9A44DBF1FC5EFBB677639243644FBF6');
      unflattenKeylistIntoAnswers(['gecko1_8'], 'E685C8C6FC7B50FBC2B3681C75A518E6');
  ...
  , 50);
  $stats && $stats({moduleName:'lineoverview', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'end'});
  $stats && $stats({moduleName:'lineoverview', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'loadExternalRefs', millis:(new Date).getTime(), type:'begin'});
  ...
  $doc_0.write('<script defer="defer">lineoverview.onInjectionDone(\'lineoverview\')<\/script>');
}
