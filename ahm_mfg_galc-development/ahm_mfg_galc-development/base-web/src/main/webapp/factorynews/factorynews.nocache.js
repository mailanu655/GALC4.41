function factorynews(){
  var $wnd_0 = window, $doc_0 = document, $stats = $wnd_0.__gwtStatsEvent?function(a){
    return $wnd_0.__gwtStatsEvent(a);
  }
  :null, $sessionId_0 = $wnd_0.__gwtStatsSessionId?$wnd_0.__gwtStatsSessionId:null, scriptsDone, loadDone, bodyDone, base = '', metaProps = {}, values = [], providers = [], answers = [], softPermutationId = 0, onLoadErrorFunc, propertyErrorFunc;
  $stats && $stats({moduleName:'factorynews', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'begin'});
  ...
  function maybeStartModule(){
    if (scriptsDone && loadDone) {
      var iframe = $doc_0.getElementById('factorynews');
      ...
      factorynews = null;
      frameWnd.gwtOnLoad(onLoadErrorFunc, 'factorynews', base, softPermutationId);
      $stats && $stats({moduleName:'factorynews', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'moduleStartup', millis:(new Date).getTime(), type:'end'});
    }
  }
  ...
  function computeScriptBase(){
    ...
    function tryNocacheJsTag(){
      ...
      for (var i = 0; i < scriptTags.length; ++i) {
        if (scriptTags[i].src.indexOf('factorynews.nocache.js') != -1) {
    ...
    function tryMarkerScript(){
      ...
      if (typeof isBodyLoaded == 'undefined' || !isBodyLoaded()) {
        var markerId = '__gwt_marker_factorynews';
        var markerScript;
  ...
  function processMetas(){
    ...
    for (var i = 0, n = metas.length; i < n; ++i) {
      ...
      if (name_0) {
        name_0 = name_0.replace('factorynews::', '');
        if (name_0.indexOf('::') >= 0) {
          continue;
        }
  ...
  function maybeInjectFrame(){
    if (!frameInjected) {
      ...
      iframe.id = 'factorynews';
      iframe.style.cssText = 'position:absolute;width:0;height:0;border:none';
      iframe.tabIndex = -1;
      $doc_0.body.appendChild(iframe);
      $stats && $stats({moduleName:'factorynews', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'moduleStartup', millis:(new Date).getTime(), type:'moduleRequested'});
  ...
  factorynews.onScriptLoad = function(){
    if (frameInjected) {
      loadDone = true;
      maybeStartModule();
    }
  ...
  ;
  factorynews.onInjectionDone = function(){
    scriptsDone = true;
    $stats && $stats({moduleName:'factorynews', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'loadExternalRefs', millis:(new Date).getTime(), type:'end'});
    maybeStartModule();
  }
  ;
  processMetas();
  ...
  var initialHtml;
  if (isHostedMode()) {
    if ($wnd_0.external && ($wnd_0.external.initModule && $wnd_0.external.initModule('factorynews'))) {
      $wnd_0.location.reload();
      return;
    }
    initialHtml = 'hosted.html?factorynews';
    strongName = '';
  }
  $stats && $stats({moduleName:'factorynews', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'selectingPermutation'});
  if (!isHostedMode()) {
    try {
      unflattenKeylistIntoAnswers(['ie8'], '02775D885D9B59CC262AE9DF11FBC0CC');
      unflattenKeylistIntoAnswers(['ie6'], '3647E9BC1445D0D98B49880AF8F66496');
      unflattenKeylistIntoAnswers(['ie9'], 'A49AA562F15D903DA9B14A495815CB56');
      unflattenKeylistIntoAnswers(['safari'], 'B9594F5BD3D90EACF930BC66CD3D0E4B');
      unflattenKeylistIntoAnswers(['gecko1_8'], 'E08522CDAB409C7DCD52649265F4E740');
      unflattenKeylistIntoAnswers(['opera'], 'FE88D445171A3A3151B7F9A846FF6517');
  ...
  , 50);
  $stats && $stats({moduleName:'factorynews', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'bootstrap', millis:(new Date).getTime(), type:'end'});
  $stats && $stats({moduleName:'factorynews', sessionId:$sessionId_0, subSystem:'startup', evtGroup:'loadExternalRefs', millis:(new Date).getTime(), type:'begin'});
  ...
  $doc_0.write('<script defer="defer">factorynews.onInjectionDone(\'factorynews\')<\/script>');
}
