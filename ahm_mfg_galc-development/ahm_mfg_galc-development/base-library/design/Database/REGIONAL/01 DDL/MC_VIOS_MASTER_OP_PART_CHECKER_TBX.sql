...
CREATE TABLE GALADM.MC_VIOS_MASTER_OP_PART_CHECKER_TBX (
   ...
   CONSTRAINT MC_VIOS_MASTER_OP_PART_CHECKER_PK PRIMARY KEY (VIOS_PLATFORM_ID, UNIT_NO, PART_NO, CHECK_POINT, CHECK_SEQ)
)
  IN GALTBSREF12
  INDEX IN GALTBSIDX4;
...
SET UPDATE_TIMESTAMP=CURRENT_TIMESTAMP;
 ...
 ALTER TABLE GALADM.MC_VIOS_MASTER_OP_PART_CHECKER_TBX ADD USER_ID CHAR(11) NOT NULL;
