...
CREATE TABLE "GALADM  "."QI_DEPT_TBX"  (
		  ...
		  "DEPT_NAME" VARCHAR(32 OCTETS) , 
		  "DEPT_DESCRIPTION" VARCHAR(128 OCTETS) , 
		  "PDDA_DEPT" CHAR(2 OCTETS) , 
		  "ACTIVE" SMALLINT , 
...
-- DDL Statements for Indexes on Table "GALADM  "."QI_DEPT_TBX"

SET SYSIBM.NLS_STRING_UNITS = 'SYSTEM';

CREATE UNIQUE INDEX "GALADM  "."QI_DEPT_I1" ON "GALADM  "."QI_DEPT_TBX" 
		("SITE" ASC,
		 "PLANT" ASC,
		 "DEPT" ASC)
...
-- DDL Statements for Primary Key on Table "GALADM  "."QI_DEPT_TBX"

ALTER TABLE "GALADM  "."QI_DEPT_TBX" 
	ADD CONSTRAINT "QI_DEPT_PK" PRIMARY KEY
		("SITE",
		 "PLANT",
		 "DEPT");
...
-- DDL Statements for Check Constraints on Table "GALADM  "."QI_DEPT_TBX"
