...
-- DDL Statements for Indexes on Table "GALADM  "."QI_STATION_ENTRY_DEPT_TBX"

SET SYSIBM.NLS_STRING_UNITS = 'SYSTEM';

CREATE UNIQUE INDEX "GALADM  "."QI_STATION_ENTRY_DEPT_I1" ON "GALADM  "."QI_STATION_ENTRY_DEPT_TBX" 
		("PROCESS_POINT_ID" ASC,
		 "DIVISION_ID" ASC)
		
		COMPRESS NO 
		INCLUDE NULL KEYS ALLOW REVERSE SCANS;
-- DDL Statements for Primary Key on Table "GALADM  "."QI_STATION_ENTRY_DEPT_TBX"

ALTER TABLE "GALADM  "."QI_STATION_ENTRY_DEPT_TBX" 
	ADD CONSTRAINT "QI_STATION_ENTRY_DEPT_PK" PRIMARY KEY
		("PROCESS_POINT_ID",
		 "DIVISION_ID");
...
-- DDL Statements for Check Constraints on Table "GALADM  "."QI_STATION_ENTRY_DEPT_TBX"
