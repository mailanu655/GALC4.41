...
CREATE TABLE "GALADM  "."QI_SITE_TBX"  (
		  ...
		  "SITE_DESCRIPTION" VARCHAR(64 OCTETS) , 
		  "COMPANY" VARCHAR(32 OCTETS) , 
		  "ACTIVE" SMALLINT , 
...
-- DDL Statements for Indexes on Table "GALADM  "."QI_SITE_TBX"

SET SYSIBM.NLS_STRING_UNITS = 'SYSTEM';

CREATE UNIQUE INDEX "GALADM  "."QI_SITE_I1" ON "GALADM  "."QI_SITE_TBX" 
		("SITE" ASC)
		
		COMPRESS NO 
		INCLUDE NULL KEYS ALLOW REVERSE SCANS;
-- DDL Statements for Primary Key on Table "GALADM  "."QI_SITE_TBX"

ALTER TABLE "GALADM  "."QI_SITE_TBX" 
	ADD CONSTRAINT "QI_SITE_PK" PRIMARY KEY
		("SITE");




-- DDL Statements for Check Constraints on Table "GALADM  "."QI_SITE_TBX"
