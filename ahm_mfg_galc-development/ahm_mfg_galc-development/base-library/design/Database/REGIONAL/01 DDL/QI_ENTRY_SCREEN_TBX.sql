...
CREATE TABLE "GALADM  "."QI_ENTRY_SCREEN_TBX"  (
		  ...
		  "ENTRY_SCREEN_DESCRIPTION" VARCHAR(80 OCTETS) , 
		  "IS_IMAGE" SMALLINT , 
...
ALTER TABLE "GALADM  "."QI_ENTRY_SCREEN_TBX" PCTFREE 0;

COMMENT ON TABLE "GALADM  "."QI_ENTRY_SCREEN_TBX" IS 'NAQ Entry Screen';


-- DDL Statements for Indexes on Table "GALADM  "."QI_ENTRY_SCREEN_TBX"

SET SYSIBM.NLS_STRING_UNITS = 'SYSTEM';

CREATE UNIQUE INDEX "GALADM  "."QI_ENTRY_SCREEN_I1" ON "GALADM  "."QI_ENTRY_SCREEN_TBX" 
		("ENTRY_SCREEN" ASC,
		 "ENTRY_MODEL" ASC,
		 "IS_USED" ASC)
...
-- DDL Statements for Primary Key on Table "GALADM  "."QI_ENTRY_SCREEN_TBX"

ALTER TABLE "GALADM  "."QI_ENTRY_SCREEN_TBX" 
	ADD CONSTRAINT "QI_ENTRY_SCREEN_PK" PRIMARY KEY
		("ENTRY_SCREEN",
		 "ENTRY_MODEL",
		 "IS_USED");
...
-- DDL Statements for Check Constraints on Table "GALADM  "."QI_ENTRY_SCREEN_TBX"
