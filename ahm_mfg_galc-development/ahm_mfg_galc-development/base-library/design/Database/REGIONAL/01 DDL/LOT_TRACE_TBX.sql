...
CREATE TABLE "GALADM  "."LOT_TRACE_TBX"  (
		  "LSN" VARCHAR(20 OCTETS) NOT NULL , 
		  "KD_LOT" VARCHAR(20 OCTETS) NOT NULL , 
		  "SUPPLIER_LOT" VARCHAR(20 OCTETS) , 
		  "PART_NUM" VARCHAR(20 OCTETS) , 
		  "PART_COLOR" VARCHAR(15 OCTETS) , 
		  "PART_QTY" DOUBLE , 
...
DROP TRIGGER "GALADM  "."LOT_TRACE_TR1";

CREATE TRIGGER GALADM.LOT_TRACE_TR1 NO CASCADE BEFORE INSERT ON GALADM.LOT_TRACE_TBX
...
DROP TRIGGER "GALADM  "."LOT_TRACE_TR2";

CREATE TRIGGER GALADM.LOT_TRACE_TR2 NO CASCADE BEFORE UPDATE ON GALADM.LOT_TRACE_TBX
