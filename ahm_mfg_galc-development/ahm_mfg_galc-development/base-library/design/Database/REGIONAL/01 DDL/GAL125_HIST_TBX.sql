...
------------------------------------------------
-- DDL Statements for Table "GALADM  "."GAL125_HIST_TBX"
------------------------------------------------
 
DROP TABLE "GALADM  "."GAL125_HIST_TBX";
...
CREATE TABLE "GALADM  "."GAL125_HIST_TBX"  (
		  ...
		  "CHANGE_ASSOCIATE" CHAR(11 OCTETS) , 
		  "CHANGE_NUMBER" VARCHAR(255 OCTETS) , 
		  "CHANGE_DESCRIPTION" VARCHAR(2048 OCTETS) , 
		  "CHANGE_TIMESTAMP" TIMESTAMP NOT NULL WITH DEFAULT CURRENT TIMESTAMP )   
		 IN "GALTBSDAT4" INDEX IN "GALTBSIDX2"  
		 ORGANIZE BY ROW; 

ALTER TABLE "GALADM  "."GAL125_HIST_TBX" DATA CAPTURE CHANGES INCLUDE LONGVAR COLUMNS;

COMMENT ON TABLE "GALADM  "."GAL125_HIST_TBX" IS 'RMT DefectResult History for QICS recording defects to product';


-- DDL Statements for Primary Key on Table "GALADM  "."GAL125_HIST_TBX"

ALTER TABLE "GALADM  "."GAL125_HIST_TBX" 
	ADD CONSTRAINT "GAL125_HIST_PK" PRIMARY KEY
...
-- DDL Statements for Indexes on Table "GALADM  "."GAL125_HIST_TBX"

SET SYSIBM.NLS_STRING_UNITS = 'SYSTEM';

CREATE INDEX "GALADM  "."GAL125_HIST_I1" ON "GALADM  "."GAL125_HIST_TBX" 
		("PRODUCT_ID" ASC)
...
CREATE INDEX "GALADM  "."GAL125_HIST_I2" ON "GALADM  "."GAL125_HIST_TBX" 
		("PRODUCT_ID" ASC,
		 "ENTRY_DEPT" ASC,
		 "DEFECT_STATUS" ASC)
...
CREATE INDEX "GALADM  "."GAL125_HIST_I3" ON "GALADM  "."GAL125_HIST_TBX" 
		("DATE" ASC,
		 "ENTRY_DEPT" ASC,
		 "DEFECT_STATUS" ASC,
		 "SHIFT" ASC,
...
CREATE INDEX "GALADM  "."GAL125_HIST_I4" ON "GALADM  "."GAL125_HIST_TBX" 
		("DEFECTRESULTID" ASC,
		 "PRODUCT_ID" ASC,
...
CREATE INDEX "GALADM  "."GAL125_HIST_I5" ON "GALADM  "."GAL125_HIST_TBX" 
		("APPLICATION_ID" ASC,
		 "PRODUCT_ID" ASC,
		 "SHIFT" ASC,
		 "DATE" ASC)
...
CREATE INDEX "GALADM  "."GAL125_HIST_I6" ON "GALADM  "."GAL125_HIST_TBX" 
		("DATE" ASC,
		 "OUTSTANDING_FLAG" ASC,
		 "APPLICATION_ID" ASC,
		 "SHIFT" ASC,
...
DROP TRIGGER "GALADM  "."GAL125_HIST_TR1";

CREATE TRIGGER GALADM.GAL125_HIST_TR1 NO CASCADE BEFORE INSERT ON GALADM.GAL125_HIST_TBX
...
DROP TRIGGER "GALADM  "."GAL125_HIST_TR2";

CREATE TRIGGER GALADM.GAL125_HIST_TR2 NO CASCADE BEFORE UPDATE ON GALADM.GAL125_HIST_TBX
