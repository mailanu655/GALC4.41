...
------------------------------------------------
-- DDL Statements for Table "GALADM  "."SCHEDULE_REP_TBX"
------------------------------------------------
...
COMMENT ON TABLE SCHEDULE_REP_TBX
IS
    'Schedule Replication: source/destination process locations, Spec Code (MBPNs), Lot Control Rules Applied.';
