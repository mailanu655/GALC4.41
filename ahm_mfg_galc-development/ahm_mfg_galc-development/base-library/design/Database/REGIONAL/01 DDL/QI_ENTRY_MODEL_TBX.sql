...
CREATE TABLE "GALADM  "."QI_ENTRY_MODEL_TBX"  (
		  ...
		  "ENTRY_MODEL_DESCRIPTION" VARCHAR(32 OCTETS) , 
...
ALTER TABLE "GALADM  "."QI_ENTRY_MODEL_TBX" PCTFREE 0;

COMMENT ON TABLE "GALADM  "."QI_ENTRY_MODEL_TBX" IS 'NAQ Entry Model';


-- DDL Statements for Indexes on Table "GALADM  "."QI_ENTRY_MODEL_TBX"

SET SYSIBM.NLS_STRING_UNITS = 'SYSTEM';

CREATE UNIQUE INDEX "GALADM  "."QI_ENTRY_MODEL_I1" ON "GALADM  "."QI_ENTRY_MODEL_TBX" 
		("ENTRY_MODEL" ASC,
		 "IS_USED" ASC)
		
		COMPRESS NO 
		INCLUDE NULL KEYS ALLOW REVERSE SCANS;
-- DDL Statements for Primary Key on Table "GALADM  "."QI_ENTRY_MODEL_TBX"

ALTER TABLE "GALADM  "."QI_ENTRY_MODEL_TBX" 
	ADD CONSTRAINT "QI_ENTRY_MODEL_PK" PRIMARY KEY
		("ENTRY_MODEL",
		 "IS_USED");
...
-- DDL Statements for Check Constraints on Table "GALADM  "."QI_ENTRY_MODEL_TBX"
