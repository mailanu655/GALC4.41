...
------------------------------------------------
-- DDL Statements for Table "GALADM  "."MC_APP_CHECKER_TBX"
------------------------------------------------
...
-- DDL Statements for Primary Key on Table "GALADM  "."MC_APP_CHECKER_TBX"

ALTER TABLE "GALADM  "."MC_APP_CHECKER_TBX" 
	ADD CONSTRAINT "MC_APP_CHECKER_PK" PRIMARY KEY
		("APPLICATION_ID",
		 "CHECK_POINT",
		 "CHECK_SEQ");
...
CREATE TRIGGER GALADM.MC_APP_CHECKER_TR1 NO CASCADE BEFORE INSERT ON GALADM.MC_APP_CHECKER_TBX
...
CREATE TRIGGER GALADM.MC_APP_CHECKER_TR2 NO CASCADE BEFORE UPDATE ON GALADM.MC_APP_CHECKER_TBX
