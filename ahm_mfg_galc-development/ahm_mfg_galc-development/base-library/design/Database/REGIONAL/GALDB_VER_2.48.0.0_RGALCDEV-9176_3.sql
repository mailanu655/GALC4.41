...
CREATE TRIGGER GALADM. MODEL_TYPE_HOLD_TR1 NO CASCADE BEFORE INSERT ON GALADM. MODEL_TYPE_HOLD _TBX
...
CREATE TRIGGER GALADM. MODEL_TYPE_HOLD _TR2 NO CASCADE BEFORE UPDATE ON GALADM. MODEL_TYPE_HOLD _TBX
