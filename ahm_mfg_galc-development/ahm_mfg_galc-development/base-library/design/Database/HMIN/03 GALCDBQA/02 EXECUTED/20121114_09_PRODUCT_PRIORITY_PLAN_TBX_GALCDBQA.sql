...
GRANT DELETE, INSERT, SELECT, UPDATE ON TABLE "GALADM"."PRODUCT_PRIORITY_PLAN_TBX" TO GROUP "GALCQA_A";

GRANT SELECT ON TABLE "GALADM"."PRODUCT_PRIORITY_PLAN_TBX" TO GROUP "GALCQA_S";
