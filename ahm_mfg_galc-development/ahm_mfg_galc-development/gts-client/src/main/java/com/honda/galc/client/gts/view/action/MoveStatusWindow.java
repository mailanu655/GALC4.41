...
public class MoveStatusWindow extends JDialog implements  ActionListener{
    ...
    public MoveStatusWindow(GtsDrawing drawing,List<GtsMove> moves){
  ...
  //      mainPanel.setPreferredSize(new Dimension(500,100));
    ...
    private void setIndicatorPanel(){
        ...
        MoveTableModel model = new MoveTableModel(this.moves,moveTable);
    ...
    private class MoveTableModel extends SortableTableModel<GtsMove>{
        
        private static final long serialVersionUID = 1L;
        
        
        public MoveTableModel(List<GtsMove> indicators, JTable table){
            super(indicators,new String[] {"Source Lane","Destination Lane","Status"},table);
        }
