...
public class JFontChooser extends JDialog implements ActionListener, ListSelectionListener
{
    ...
    public JFontChooser(Font aFont)
    {
        ...
        TitledBorder panelBorder = new TitledBorder("Preview");
        if(aFont == null){
        ...
        jtfFonts.setBounds(8, 5, 150, 20);
        jspFont.setBounds(8, 35, 150, 200);

        jtfStyle.setBounds(165, 5, 100, 20);
        jspStyle.setBounds(165, 35, 100, 200);
        
        jtfSize.setBounds(274, 5, 41, 20);
        jspSize.setBounds(274, 35, 41, 200);
        
        jbtOK.setBounds(330, 18, 89, 25);
        jbtCancel.setBounds(330, 55, 89, 25);
        
        panel.setBounds(6, 240, 310, 120);
    //    jtfTest.setBounds(8, 250, 320, 50);
        jtfTest.setPreferredSize(new Dimension(300,80));
