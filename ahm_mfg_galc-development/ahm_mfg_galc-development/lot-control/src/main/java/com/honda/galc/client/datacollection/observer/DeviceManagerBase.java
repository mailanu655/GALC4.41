 ...
 * @since Apr 27, 2011
 */
public abstract class DeviceManagerBase extends DataCollectionObserverBase{
	...
	protected void sendDeviceData(IDeviceData deviceData) {
		try {
			Logger.getLogger().info("start sendDeviceData: " + deviceData.getClass().getSimpleName());
			...
			Logger.getLogger().info("sendDeviceData " + deviceData + " succeeded.");
		} catch (Throwable e) {
