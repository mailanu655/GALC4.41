...
public class PolygonButton extends JButton {
    ...
    public void paint(Graphics g) {
        ...
        GradientPaint gradient = new GradientPaint(20, 0, color1, 20, (float)getSize().getHeight()/2, color2, true);
    ...
    private Polygon createPolygon(){
        ...
        poly.addPoint((int)dx, (int)(getSize().height /(double)2));
        poly.addPoint((int)(dx + getSize().height /(double)2) , 0);
        ...
        poly.addPoint((int)(dx + getSize().height /(double)2), getSize().height);
