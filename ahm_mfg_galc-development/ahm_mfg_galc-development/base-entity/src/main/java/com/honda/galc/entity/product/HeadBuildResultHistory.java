...
*/
@Entity
@Table(name="HEAD_BUILD_RESULTS_HIST_TBX")
public class HeadBuildResultHistory extends AuditEntry {
	@EmbeddedId
	private HeadBuildResultHistoryId id;
	...
	public HeadBuildResultHistory() {
		super();
	}
	
	public HeadBuildResultHistory(String headId,String partName, Date actualTimestamp) {
		id = new HeadBuildResultHistoryId(headId, partName, actualTimestamp);
		id.setActualTimestamp(new Timestamp(System.currentTimeMillis()));
		setCreateTimestamp(new Timestamp(System.currentTimeMillis()));
	}
	
	public HeadBuildResultHistory Initialize(HeadBuildResult result) {
		HeadBuildResultHistory history = new HeadBuildResultHistory(result.getProductId(), result.getPartName(), result.getActualTimestamp());
	...
	public HeadBuildResultHistory(HeadBuildResultHistoryId id) {
		this();
		this.id = id;
	}

	public HeadBuildResultHistoryId getId() {
		return id;
	}

	public void setId(HeadBuildResultHistoryId id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		HeadBuildResultHistory other = (HeadBuildResultHistory) obj;
		if (associateNo == null) {
	...
	public String toString() {
		return "HeadBuildResultHistory ["+ id.toString() + ", resultValue=" + resultValue + ", installedPartStatus="
