 ...
 * {@link com.honda.galc.entity.product.LetDiagName}
 * </p>
 * 
 ...
 */
@Embeddable
public class LetDiagNameId implements Serializable {
	...
	@Column(name = "DIAG_PARAM_ID")
	private int diagParamId;

	public LetDiagNameId() {

	}

	public LetDiagNameId(Timestamp endTimestamp, String letTerminalId, int diagTestId, int diagParamId) {
		this.endTimestamp = endTimestamp;
		this.letTerminalId = letTerminalId;
		this.diagTestId = diagTestId;
		this.diagParamId = diagParamId;
	}
	...
	public int getDiagParamId() {
		return diagParamId;
	}

	public void setDiagParamId(int diagParamId) {
		this.diagParamId = diagParamId;
	}
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + diagParamId;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LetDiagNameId other = (LetDiagNameId) obj;
		if (diagParamId != other.diagParamId)
			return false;
