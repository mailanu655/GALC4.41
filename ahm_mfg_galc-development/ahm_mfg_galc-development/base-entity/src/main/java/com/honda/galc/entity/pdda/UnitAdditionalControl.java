 ...
 */
@Entity
@Table(name="PVMAL1", schema="VIOS")
public class UnitAdditionalControl extends AuditEntry implements Serializable {
	
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private UnitAdditionalControlId id;
    ...
    public UnitAdditionalControl() {}

	public UnitAdditionalControlId getId() {
		return this.id;
	}

	public void setId(UnitAdditionalControlId id) {
		this.id = id;
	}
	...
	public String getFrequency() {
		return StringUtils.trim(this.frequency);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UnitAdditionalControl other = (UnitAdditionalControl) obj;
		if (deptCode == null) {
	...
	public String toString() {
		return toString(getId().getMaintenanceId(), getId().getControlMethod(), 
				getDeptCode(), getFrequency(), getPlantLocCode());
	}
}