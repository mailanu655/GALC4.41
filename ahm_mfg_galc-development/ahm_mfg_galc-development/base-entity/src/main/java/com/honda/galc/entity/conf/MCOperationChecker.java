...
@Entity
@Table(name="MC_OP_CHECKER_TBX")
public class MCOperationChecker extends AuditEntry implements Serializable {

	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private MCOperationCheckerId id;
	...
	public MCOperationCheckerId getId() {
		return id;
	}

	public void setId(MCOperationCheckerId id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MCOperationChecker other = (MCOperationChecker) obj;
		if (checkName == null) {
	...
	public String toString(){
		return toString(getId().getOperationName(), getId().getOperationRevision(),	getId().getCheckPoint(), getId().getCheckSeq(), 
