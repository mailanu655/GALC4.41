 ...
 */
@Entity
@Table(name="PVUMM1", schema="VIOS")
public class UnitMost extends AuditEntry implements Serializable {
	
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private UnitMostId id;
	...
	public UnitMostId getId() {
		return this.id;
	}

	public void setId(UnitMostId id) {
		this.id = id;
	}
	...
	public String toString() {
		return toString(getId().getMaintenanceId(), getId().getMostSeqNo(), getId().getWorkingPointDtl(), 
				getId().getShowOnPrint(), getDeptCode(), getPlantLocCode());
	}
}