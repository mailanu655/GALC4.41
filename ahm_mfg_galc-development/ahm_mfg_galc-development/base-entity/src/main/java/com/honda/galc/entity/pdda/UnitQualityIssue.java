 ...
 */
@Entity
@Table(name="PVUMQ1", schema="VIOS")
public class UnitQualityIssue extends AuditEntry implements Serializable {
	
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private UnitQualityIssueId id;
    ...
    public UnitQualityIssue() {}

	public UnitQualityIssueId getId() {
		return this.id;
	}

	public void setId(UnitQualityIssueId id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UnitQualityIssue other = (UnitQualityIssue) obj;
		if (deptCode == null) {
	...
	public String toString() {
		return toString(getId().getMaintenanceId(), getId().getQualityIssDesc(), 
