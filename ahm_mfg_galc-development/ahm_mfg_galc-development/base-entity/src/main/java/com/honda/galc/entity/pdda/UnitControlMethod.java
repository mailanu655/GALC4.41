 ...
 */
@Entity
@Table(name="PVUMC1", schema="VIOS")
public class UnitControlMethod extends AuditEntry implements Serializable {
	
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private UnitControlMethodId id;
    ...
    public UnitControlMethod() {}

	public UnitControlMethodId getId() {
		return this.id;
	}

	public void setId(UnitControlMethodId id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UnitControlMethod other = (UnitControlMethod) obj;
		if (deptCode == null) {
	...
	public String toString() {
		return toString(getId().getMaintenanceId(), getId().getControlMethodDescription(), getDeptCode(), getPlantLocCode());
	}
}