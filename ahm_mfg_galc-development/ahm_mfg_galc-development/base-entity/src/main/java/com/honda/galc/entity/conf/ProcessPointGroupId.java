...
@Embeddable
public class ProcessPointGroupId implements Serializable {

	private static final long serialVersionUID = 435531865243044780L;
	...
	public ProcessPointGroupId() {
		super();
	}

	public ProcessPointGroupId(short categoryCode, String site, String groupName, String processPointId) {
		super();
		this.categoryCode = categoryCode;
		this.site = site;
		this.processPointGroupName = groupName;
	...
	public boolean equals(Object obj) {
		...
		ProcessPointGroupId other = (ProcessPointGroupId) obj;
		...
		return getCategoryCode() == other.getCategoryCode()
				...
				&& StringUtils.equals(getProcessPointId(), other.getProcessPointId());
	}
	    
	@Override
	public String toString() {		
	  return StringUtil.toString(getClass().getSimpleName(), getCategoryCode(), getSite(), getProcessPointGroupName(), getProcessPointId());
	}
