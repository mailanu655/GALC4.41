...
/**
 * The primary key class for the MANPOWER_ASSIGNMENT database table.
 * 
 */
@Embeddable
public class ManpowerAssignmentId implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ManpowerAssignmentId other = (ManpowerAssignmentId) obj;
