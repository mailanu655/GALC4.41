...
/**
 * 
 * <h3>FifCodeGroupsId.java</h3>
 * <h3> Class description</h3>
 * <h4> Description </h4>
 * <p> FifCodeGroupsId.java description </p>
 * 
...
@Embeddable
public class FifCodeGroupsId implements Serializable {
	...
	public FifCodeGroupsId() {
		super();
	}

	public FifCodeGroupsId(String plantCd, String modelYear, String modelCd,
			String baseType, String fifType, String devSeqCd, String groupCd,
			Date efctBegDt) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FifCodeGroupsId other = (FifCodeGroupsId) obj;
		if (plantCd == null) {
