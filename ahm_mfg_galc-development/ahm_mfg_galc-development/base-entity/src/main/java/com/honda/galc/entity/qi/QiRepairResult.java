...
/**
 * 
 * <h3>QiRepairResult Class description</h3>
 * 
 ...
 */
@Entity
@Table(name = "QI_REPAIR_RESULT_TBX")
public class QiRepairResult extends CreateUserAuditEntry {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		QiRepairResult other = (QiRepairResult) obj;
	...
	/**
	 * Copy constructor-will be used to populate QiRepairResult object from main
	 * defect QiDefectResult object.
	 */
	public QiRepairResult(QiDefectResult mainDefect) {
		...
		this.productionDate = mainDefect.getProductionDate();
		this.defectResultId = mainDefect.getDefectResultId();
		this.defectTypeName = mainDefect.getDefectTypeName();
		if (mainDefect.getDefectTypeName2() != null && mainDefect.getDefectTypeName2().trim().length() > 0) {
		...
		this.actualTimestamp = mainDefect.getActualTimestamp();
		...
		this.defectTransactionGroupId = mainDefect.getDefectTransactionGroupId();
	}

	@Override
	public String toString() {
		StringBuilder builder = new StringBuilder();
		builder.append("QiRepairResult [repairId=");
