 ...
 */
@Entity
@Table(name="PVMRP1", schema="VIOS")
public class UnitReactionPlan extends AuditEntry implements Serializable {
	
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private UnitReactionPlanId id;
    ...
    public UnitReactionPlan() {}

	public UnitReactionPlanId getId() {
		return this.id;
	}

	public void setId(UnitReactionPlanId id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UnitReactionPlan other = (UnitReactionPlan) obj;
		if (deptCode == null) {
	...
	public String toString() {
		return toString(getId().getMaintenanceId(), getId().getReaction(), 
