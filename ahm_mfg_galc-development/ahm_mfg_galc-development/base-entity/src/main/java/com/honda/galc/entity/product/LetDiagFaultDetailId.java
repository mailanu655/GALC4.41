...
/**
 * <h3>LetDiagFaultDetailId</h3>
 * <h3>Class description</h3>
 * <p>
 * Class act as embedded id for entity
 * {@link com.honda.galc.entity.product.LetDiagFaultDetail}
 * </p>
 * 
 ...
 */
@Embeddable
public class LetDiagFaultDetailId implements Serializable {
	...
	public LetDiagFaultDetailId() {
	}

	public LetDiagFaultDetailId(Timestamp endTimestamp, String letTerminalId, int diagTestId, int faultCodeId) {
	...
	public int hashCode() {
		...
		result = prime * result + faultCodeId;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LetDiagFaultDetailId other = (LetDiagFaultDetailId) obj;
		...
		if (endTimestamp == null) {
			...
			return false;
		if (faultCodeId != other.faultCodeId)
			return false;
