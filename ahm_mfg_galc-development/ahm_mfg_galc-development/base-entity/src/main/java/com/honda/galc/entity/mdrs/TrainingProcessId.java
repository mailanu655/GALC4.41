...
/**
 * The primary key class for the TRAINING_PROCESS database table.
 * 
 */
@Embeddable
public class TrainingProcessId implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TrainingProcessId other = (TrainingProcessId) obj;
	...
	public String toString() {
		return StringUtil.toString(this.getClass().getSimpleName(), getPlantLocCode(), getDeptCode()
				, getProcessId(), getLastUpdatedDate(), getExtractDate());
	}
}