...
*/
@Entity
@Table(name="CRANKSHAFT_BUILD_RESULTS_HIST_TBX")
public class CrankshaftBuildResultHistory extends AuditEntry {
	@EmbeddedId
	private CrankshaftBuildResultHistoryId id;
	...
	public CrankshaftBuildResultHistory() {
		super();
	}
	
	public CrankshaftBuildResultHistory(String crankshaftId,String partName, Date actualTimestamp) {
		id = new CrankshaftBuildResultHistoryId(crankshaftId, partName, actualTimestamp);
		id.setActualTimestamp(new Timestamp(System.currentTimeMillis()));
		setCreateTimestamp(new Timestamp(System.currentTimeMillis()));
	}
	
	public CrankshaftBuildResultHistory Initialize(CrankshaftBuildResult result) {
		CrankshaftBuildResultHistory history = new CrankshaftBuildResultHistory(result.getProductId(), result.getPartName(), result.getActualTimestamp());
	...
	public CrankshaftBuildResultHistory(CrankshaftBuildResultHistoryId id) {
		this();
		this.id = id;
	}

	public CrankshaftBuildResultHistoryId getId() {
		return id;
	}

	public void setId(CrankshaftBuildResultHistoryId id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CrankshaftBuildResultHistory other = (CrankshaftBuildResultHistory) obj;
		if (associateNo == null) {
	...
	public String toString() {
		return "CrankshaftBuildResultHistory [" + id.toString() + ", resultValue=" + resultValue + ", installedPartStatus="
