...
/**
 * The primary key class for the GAL268TBX database table.
 * 
 */
@Embeddable
public class FrameMTOCPriceMasterSpecId implements Serializable {
	...
	public FrameMTOCPriceMasterSpecId() {
	}
	...
	public String getEffectiveDate() {
		return StringUtils.trim(this.effectiveDate);
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FrameMTOCPriceMasterSpecId)) {
			return false;
		}
		FrameMTOCPriceMasterSpecId castOther = (FrameMTOCPriceMasterSpecId)other;
		return 
