 ...
 */
@Entity
@Table(name="PVMSC1", schema="VIOS")
public class UnitSpecialControl extends AuditEntry implements Serializable {
	
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private UnitSpecialControlId id;
	...
	@Column(name="PRINT", nullable=false, length=1)
    ...
    public UnitSpecialControl() {}

	public UnitSpecialControlId getId() {
		return this.id;
	}

	public void setId(UnitSpecialControlId id) {
		this.id = id;
	}
	...
	public String getPrint() {
		return StringUtils.trim(this.print);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UnitSpecialControl other = (UnitSpecialControl) obj;
		if (deptCode == null) {
	...
	public String toString() {
		return toString(getId().getMaintenanceId(), getId().getControlApplied(), 
				getDeptCode(), getPlantLocCode(), getPrint());
	}
}