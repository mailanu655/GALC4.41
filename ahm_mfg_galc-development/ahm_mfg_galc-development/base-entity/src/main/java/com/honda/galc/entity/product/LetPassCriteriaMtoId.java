 ...
 */
@Embeddable
public class LetPassCriteriaMtoId implements Serializable {
	...
	public LetPassCriteriaMtoId() {
		super();
	}
	
	
	
	public LetPassCriteriaMtoId(String modelYearCode, String modelCode,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LetPassCriteriaMtoId other = (LetPassCriteriaMtoId) obj;
