 ...
 */
@Entity
@Table(name="PVUML1", schema="VIOS")
public class UnitFmea extends AuditEntry implements Serializable {
	
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private UnitFmeaId id;
	...
	public UnitFmeaId getId() {
		return this.id;
	}

	public void setId(UnitFmeaId id) {
		this.id = id;
	}
	...
	public String toString() {
		return toString(getId().getMaintenanceId(), getId().getQualityPoints(), getId().getWorkingPoints(), 
