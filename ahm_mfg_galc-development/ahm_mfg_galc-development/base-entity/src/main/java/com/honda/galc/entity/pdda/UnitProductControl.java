 ...
 */
@Entity
@Table(name="PVMPR1", schema="VIOS")
public class UnitProductControl extends AuditEntry implements Serializable {
	
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private UnitProductControlId id;
    ...
    public UnitProductControl() {}

	public UnitProductControlId getId() {
		return this.id;
	}

	public void setId(UnitProductControlId id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UnitProductControl other = (UnitProductControl) obj;
		if (deptCode == null) {
	...
	public String toString() {
		return toString(getId().getMaintenanceId(), getId().getControlStandard(), getDeptCode(), getPlantLocCode());
	}
}