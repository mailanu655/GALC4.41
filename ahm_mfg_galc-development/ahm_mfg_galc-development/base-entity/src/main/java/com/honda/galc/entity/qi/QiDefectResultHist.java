...
/**
 * 
 * <h3>QiDefectResultHist Class description</h3>
 * <p>
 * QiDefectResultHist
 * </p>
 * 
 ...
 */
@Entity
@Table(name = "QI_DEFECT_RESULT_HIST_TBX")
public class QiDefectResultHist extends CreateUserAuditEntry{

	private static final long serialVersionUID = 1L;
	
	@Id
	private QiDefectResultHistId id;
	...
	public String getOriginalStatus() {
		if(DefectStatus.getType(originalDefectStatus)!=null){
			return StringUtils.trimToEmpty(DefectStatus.getType(originalDefectStatus).getName().toUpperCase());
		}
	...
	public String getCurrentStatus() {
		if(DefectStatus.getType(currentDefectStatus)!=null){
			return StringUtils.trimToEmpty(DefectStatus.getType(currentDefectStatus).getName().toUpperCase());
		}
		return StringUtils.EMPTY;
	}
	...
	public boolean isDefectNotRepaired() {
		return this.originalDefectStatus == DefectStatus.NOT_REPAIRED.getId();
	}
	...
	public boolean isDefectNotRepairable() {
		return this.originalDefectStatus == DefectStatus.NON_REPAIRABLE.getId();
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		QiDefectResultHist other = (QiDefectResultHist) obj;
	...
	/**
	 * Copy constructor-will be used to populate QiDefectResultHist object from main
	 * defect QiDefectResult object.
	 */
	public QiDefectResultHist(QiDefectResult mainDefect) {
		this.id = new QiDefectResultHistId(mainDefect.getDefectResultId());
