...
public class ModelPartLotDto implements IDto {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ModelPartLotDto other = (ModelPartLotDto) obj;
	...
	public String toString() {
	    return StringUtil.toString(getClass().getSimpleName(), 
				...
				getPlanCode(), getStartingProductionLot(), getApproveStatus());
	}
}
