...
/**
 * The primary key class for the TRAINING_STATUS database table.
 * 
 */
@Embeddable
public class TrainingStatusId implements Serializable {
	//default serial version id, required for serializable classes.
	private static final long serialVersionUID = 1L;

	@Column(name="TRAINING_STATUS_ID", unique=true, nullable=false)
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TrainingStatusId other = (TrainingStatusId) obj;
	...
	public String toString() {
		return StringUtil.toString(this.getClass().getSimpleName(), getTrainingStatusId()
