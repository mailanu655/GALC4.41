...
<title>OIF - Manual Start</title>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/date-picker.js"></script>
<script type="text/javascript">
	...
	function confirmOifLaunch() {
	    oifName = document.getElementById("taskName");
...
<body class="tundra" style="font-size:medium;" onload="initOifItems();"
	background="${pageContext.request.contextPath}/pics/background.jpg">
<div align="center">
<h2>OIF Manual Start</h2>
<html:form styleId="startFrom" action="start"
	...
	<table>
		...
		<tr>
			...
			<td id="startTimeStampInputRow"><html:text
				...
				src="${pageContext.request.contextPath}/pics/calendar.gif" width="24" height="22" align="top"
				border="0"></a></td>
		</tr>
		<tr>
			<td>
