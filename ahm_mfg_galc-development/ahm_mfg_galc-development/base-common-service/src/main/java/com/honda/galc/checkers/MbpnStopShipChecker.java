...
public class MbpnStopShipChecker extends AbstractBaseChecker<PartSerialScanData> {
	...
	public List<CheckResult> executeCheck(PartSerialScanData partSerialScanData) {
		...
		if(mbpnProduct!=null) {
			CheckResult checkResult = MbpnWeldUtility.stopShipCheck(mbpnProduct, null, getReactionType());
			if(checkResult!=null) {
