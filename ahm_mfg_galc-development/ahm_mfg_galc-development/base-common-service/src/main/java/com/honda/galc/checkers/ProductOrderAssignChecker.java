...
public class ProductOrderAssignChecker extends AbstractBaseChecker<MbpnData> {
	...
	public List<CheckResult> executeCheck(MbpnData inputData) {
		...
		String msg = MbpnWeldUtility.validateSpecCodeAssignment(inputData.getProductId(), inputData.getProductSpecCode());
