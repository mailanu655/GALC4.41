...
public class MbpnSpecCodeMatchChecker extends AbstractBaseChecker<PartSerialScanData> {
	...
	public List<CheckResult> executeCheck(PartSerialScanData partSerialScanData) {
		...
		if(mbpnProduct!=null) {
			...
			CheckResult checkResult = MbpnWeldUtility.mbpnPartMaskVerification(mbpnProduct
