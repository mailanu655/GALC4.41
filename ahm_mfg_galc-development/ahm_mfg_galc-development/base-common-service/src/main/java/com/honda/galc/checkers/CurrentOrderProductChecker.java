...
public class CurrentOrderProductChecker extends AbstractBaseChecker<MbpnData> {
	...
	public List<CheckResult> executeCheck(MbpnData inputData) {
		...
		String msg= MbpnWeldUtility.assignedToOrder(inputData.getProductId(), inputData.getOrderNo());
