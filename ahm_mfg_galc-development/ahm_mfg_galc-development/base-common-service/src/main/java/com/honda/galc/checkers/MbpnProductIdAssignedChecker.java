...
public class MbpnProductIdAssignedChecker extends AbstractBaseChecker<MbpnData> {
	...
	public List<CheckResult> executeCheck(MbpnData inputData) {
		...
		if (MbpnWeldUtility.getMbpnProduct(inputData.getProductId()) == null) {
			// Product Id does not exist in mbpn_product_tbx
			CheckResult checkResult = new CheckResult();
			checkResult.setCheckMessage("MBPN Product ("+inputData.getProductId()+") does not exist");
