 ...
 *
 */
public class ServerSideLoggerConfig extends AbstractPropertyConfig{
    ...
    public static void configLog4j() {
        ServerSideLoggerConfig config = new ServerSideLoggerConfig();
        String filePath = config.getLog4jPropertyFilePath();
        System.out.println("log4j2 configuration file path : " + filePath);
        Properties log4jProperties = RuntimeLogConfigurator.loadServerProperties(filePath);
