...
/**
 * 
 * <h3>ManualLotControlRepairMbpnController Class description</h3>
 * <p> ManualLotControlRepairMbpnController description </p>
 * 
...
public class ManualLotControlRepairMbpnController extends 
	...
	protected void loadLotControlRules() {
		...
		rulesAndProcessPoints = lotControlRuleDao.findAllRulesAndProcessPointsForMbpn(ruleId, getProductType().name());
