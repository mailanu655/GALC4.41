...
public class NullTableViewSelectionModel extends TableView.TableViewSelectionModel {
	...
	@Override
	public ObservableList<TablePosition> getSelectedCells() { return FXCollections.emptyObservableList(); }
	@Override
	...
	@Override
	public boolean isSelected(int i, TableColumn tableColumn) { return false; }
	@Override
