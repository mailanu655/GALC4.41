...
public class MfgDataLoaderMeasurementPanel extends AbstractTabbedView<MfgDataLoaderMeasurementModel, MfgDataLoaderMeasurementController>{
	...
	public MfgDataLoaderMeasurementPanel(TabbedMainWindow mainWindow) {
	...
	public void initView() {
		...
		partMaskBox.getChildren().addAll(createTitiledPane("Mfg Maintainance Control Data Load", createDetailsPanel(), scrollPaneWidth, scrollPaneHeight-100, 12, false),
	...
	private VBox createDetailsPanel() {
		...
		Label loadPartMaskLbl =  UiFactory.createLabel("loadPartMaskLbl", "Please Select Spreadsheet To Load Measurement",Fonts.SS_DIALOG_BOLD(16),TextAlignment.CENTER);;
	...
	private VBox createButton() {
		...
		selectBox.getChildren().addAll(selectFileLbl, fileChooserButton, filePath);
