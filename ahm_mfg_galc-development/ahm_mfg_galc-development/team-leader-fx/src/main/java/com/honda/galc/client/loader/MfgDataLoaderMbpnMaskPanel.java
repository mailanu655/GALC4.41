...
public class MfgDataLoaderMbpnMaskPanel extends AbstractTabbedView<MfgDataLoaderMbpnMaskModel, MfgDataLoaderMbpnMaskController>{
	...
	public MfgDataLoaderMbpnMaskPanel(TabbedMainWindow mainWindow) {
	...
	private VBox createDetailsPanel() {
		...
		Label loadPartMaskLbl =  UiFactory.createLabel("loadPartMaskLbl", "Please Select Spreadsheet To Load "+ProductType.MBPN.name()+" Masks",Fonts.SS_DIALOG_BOLD(16),TextAlignment.CENTER);;
