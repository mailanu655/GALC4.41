...
public abstract class ApplicationContext {
	...
	private ScreenAccessLevel highestAccessLevel = ScreenAccessLevel.NO_ACCESS; 
	
	private DailyDepartmentScheduleUtil dailyDepartmentScheduleUtil; 
	
	private String entryDept;
	private String entryDept2;
	...
	public ScreenAccessLevel getHighestAccessLevel() {
		return highestAccessLevel;
	}

	public void setHighestAccessLevel(ScreenAccessLevel highestAccessLevel) {
	...
	public void setDailyDepartmentScheduleUtil(DailyDepartmentScheduleUtil dailyDepartmentScheduleUtil) { 
	...
	public String getEntryDept2() {
		return entryDept2;
	}

	public void setEntryDept2(String entryDept2) {
		this.entryDept2 = entryDept2;
	} 
}
