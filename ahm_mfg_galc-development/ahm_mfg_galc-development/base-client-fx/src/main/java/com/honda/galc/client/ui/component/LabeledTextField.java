 ...
 * 
 */
public class LabeledTextField extends LabeledControl<LoggedTextField> {

	public LabeledTextField(String labelName) {
		this(labelName, true,false);
	}
	
	public LabeledTextField(String labelName, LoggedTextField control,boolean isMandetory) {
		super(labelName, control);
		applyComponentStyle(isMandetory);
	}
	
	public LabeledTextField(String labelName, boolean isHorizontal,boolean isMandatory) {
		super(labelName, new LoggedTextField(), isHorizontal);
		applyComponentStyle(isMandatory);
	}
	
	public LabeledTextField(String labelName, boolean isHorizontal,TextFieldState state, String cssLabelStyle,String cssTextStyle,Insets insets,int prefLabelWidth, Pos position,boolean isMandatory) {
	...
	public LabeledTextField(String labelName, boolean isHorizontal, Insets insets, boolean isLabelBold, boolean isMandatory) {
		super(labelName, new LoggedTextField(), isHorizontal,false,insets,isLabelBold,isMandatory);
	}
	
	//Labeled Text Field with optional upper case
	public LabeledTextField(String labelName, boolean isHorizontal, Insets insets, boolean isLabelBold, boolean isMandatory, boolean isUpperCase) {
		super(labelName, 
				isUpperCase ? new UpperCaseFieldBean(labelName) : new LoggedTextField(), 
				isHorizontal,false,insets,isLabelBold,isMandatory);
	}
	
	public LabeledTextField(String labelName, boolean isHorizontal,TextFieldState state,Insets insets,int prefLabelWidth, Pos position,boolean isMandatory) {
		super(labelName, new LoggedTextField(), isHorizontal);
		if (state != null) {
			state.setState(getControl());
		}
