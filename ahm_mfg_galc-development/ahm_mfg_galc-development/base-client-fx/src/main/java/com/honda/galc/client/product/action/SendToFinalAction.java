...
public class SendToFinalAction extends AbstractProductAction{

	public SendToFinalAction(ProductController productController) {
	...
	public void handle(ActionEvent arg0) {
		...
		EventBusUtil.publishAndWait(new ProductEvent(view.getViewLabel(), ProductEventType.PRODUCT_SEND_TO_FINAL));
	}
}
