 ...
 * @since Apr 18, 2012
 */
public class speakAsync {
	public static String usage() {
		return "usage: speakAsync(String text | InputStream inputStream )";
	}

	/**
	 * Implement speakAsync command.
	 * @param env
	 * @param callstack
	 */
	...
	{
		try {
			TtsSpeaker.speakAsync(inputstream);
		} catch (Exception e) {
