...
public interface ReplicateScheduleProperty2 extends InHouseSchedulePropertyBean, IProperty {
	...
	@PropertyBeanAttribute(defaultValue="")
	public Map<String, String> getDestPlanCode();
	
	// specifies the Target Process Locations
	@PropertyBeanAttribute(defaultValue="")
	public Map<String, String> getDestProcessLocation();
