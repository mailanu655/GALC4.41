...
public class StringKeyEventConvertor {

    protected Robot robot;

    public static void main(String args[]) throws Exception {
        StringKeyEventConvertor keyboard = new StringKeyEventConvertor();
        keyboard.type("Hello there, how are you?");
    }

    public StringKeyEventConvertor() throws AWTException {
        this.robot = new Robot();
    }

    public StringKeyEventConvertor(Robot robot) {
        this.robot = robot;
    }
    ...
    public void type(CharSequence characters) {
        ...
        Logger.getLogger().info("Finished Typing the text: "+characters.toString());
    }

    public void type(boolean appendEnter, boolean altPressed, boolean ctrlPressed, CharSequence characters) {
