 ...
 * @author Rick Evans
 * 
 * Suriya Sena - modified code to allow annotations to run on Java 1.8
 */
public abstract class JdkVersion {
	...
	/*
	 * This will intentionally cause a compiler warning so that we don't forget to remove the class when 
	 * we upgrade to a newer version of Spring.
	 * @deprecated
	 */
	@Deprecated
	public void Remember_to_delete_org_springframework_core_JdkVersion_java_when_spring_is_updated() {
	}
