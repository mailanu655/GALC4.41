...
@Entity
@Immutable
@Subselect(value = "select " + "a.PRODUCT_ID as id" + ", a.AF_ON_SEQUENCE_NUMBER as af_on_sequence_number " + ", a.MISSION_SERIAL_NO as mission_serial_no "
		+ ", b.SALES_MODEL_TYPE_CODE as destination " + ", d.DIVISION_ID as division_id " + ", case "
		+ "  when d.DIVISION_NAME IS NULL then '" + Constants.PLANNED + "' " + "  else d.DIVISION_NAME "
		+ "  end as division_name " + ", b.ENGINE_MTO as engine_mto " + ", a.ENGINE_SERIAL_NO as engine_serial_no "
		...
		+ ", pp.PROCESS_POINT_ID as last_process_point_id " + ", c.LINE_ID as line_id " + ", c.LINE_NAME as line_name "
		+ ", c.LINE_SEQUENCE_NUMBER as line_sequence_number " + ", b.MODEL_CODE as model_code "
		...
		+ ", case " + "  when c.LINE_NAME IS NULL then '" + Constants.PLANNED + "' " + "  else c.LINE_NAME "
		+ "  end as tracking_status " + ", c.ENTRY_PROCESS_POINT_ID AS entry_process_point_id " + "from "
		+ "GAL143TBX a " + "join GAL144TBX b on a.PRODUCT_SPEC_CODE = b.PRODUCT_SPEC_CODE "
		+ "left join GAL195TBX c on a.TRACKING_STATUS = c.LINE_ID "
		+ "left join GAL128TBX d on c.DIVISION_ID = d.DIVISION_ID "
		+ "left join GAL211TBX p on d.PLANT_NAME = p.PLANT_NAME "
		+ "left join GAL214TBX pp on a.LAST_PASSING_PROCESS_POINT_ID = pp.PROCESS_POINT_ID "
		+ "left join GAL163TBX pr on a.PRODUCT_ID = pr.VIN")
public class ProductDetails extends VdbEntity<String> implements IProductDetails {
	...
	public String toString() {
		...
		str = str + ", lastProcessPointId: " + getLastProcessPointId();
